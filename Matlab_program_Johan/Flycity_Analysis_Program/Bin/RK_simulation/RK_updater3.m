function [ state_new, FM_old ] = RK_updater3( state, body_model, wing_model, wing_kin )
    ...
    kine.dt             = dt;
    kine.id             = i*2;
    kine.vb             = state.vb+0.25*dt*k1(1:3);
    kine.wb             = state.wb+0.25*dt*k1(4:6);
    kine.ab             = k1(1:3);
    kine.w_dot_b        = k1(4:6);
    ...
    kine.dt             = dt;
    kine.id             = i*2;
    kine.vb             = state.vb+(1/3)*dt*k2(1:3);
    kine.wb             = state.wb+(1/3)*dt*k2(4:6);
    kine.ab             = k2(1:3);
    kine.w_dot_b        = k2(4:6);
    kine.RL             = wing_kin.RL(:,:,(i*2));
    kine.RR             = wing_kin.RR(:,:,(i*2));
    ...
    kine.dt             = dt;
    kine.id             = i*2+1;
    kine.vb             = state.vb+0.5*dt*k3(1:3);
    kine.wb             = state.wb+0.5*dt*k3(4:6);
    kine.ab             = k3(1:3);
    kine.w_dot_b        = k3(4:6);
    kine.RL             = wing_kin.RL(:,:,(i*2+1));
    kine.RR             = wing_kin.RR(:,:,(i*2+1));
    ...
    state_new.id            = i+1;
    state_new.dt            = dt;
    state_new.vb            = state.vb+dt*k4(1:3);
    state_new.wb            = state.wb+dt*k4(4:6);
    state_new.ab            = k4(1:3);
