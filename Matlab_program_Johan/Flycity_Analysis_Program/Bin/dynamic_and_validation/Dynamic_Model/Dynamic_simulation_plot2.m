function Dynamic_simulation_plot2( settings, pathDB, maneuver_type, wb_name, sym_on )
    ...
    fg_fact = norm(sim_data.FA_b_mean)/norm(sim_data.Fg_b_mean)
...
%     body_IC.M_0     = sim_data.M_0;
    ...
    figure(n)
    Fly_plot_3D_wingtip( body_IC.xyz_0, Rb_start, kine_man.RL, kine_man.RR, down_up, body_model, wing_model, n )
...
%     
    ...
    for i = 1:sim_length
        ...
        FA_inert_sim(:,i)        = Rb_sim(:,:,i)'*FA_b_sim(:,i);
        MA_inert_sim(:,i)        = Rb_sim(:,:,i)'*MA_b_sim(:,i);
...
%     plot(T_sim,MI_acc_inert_sim)
    ...
    MI_vel_inert_sim_mean
    MA_inert_sim_mean
    MI_acc_inert_sim_mean
