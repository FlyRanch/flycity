function Conservation_test_polynomial( settings, pathDB )
...
%     end
    ...
    ylabel('v_{bz} [ mm/s ]')
    hold off
    [~,h1] = suplabel('Body velocity v_b', 't');
    set(h1,'FontSize',10)
    ...
    ylabel('\omega_{bx} [ rad/s ]')
    subplot(3,1,2); plot(T,X(:,5))
    ylabel('\omega_{by} [ rad/s ]')
    subplot(3,1,3); plot(T,X(:,6))
    xlabel('t [s]')
    ylabel('\omega_{bz} [ rad/s ]')
    hold off
    [~,h1] = suplabel('Body angular velocity \omega_b', 't');
    set(h1,'FontSize',10)
    ...
    ylabel('a_{bz} [ mm/s^2 ]')
    hold off
    [~,h1] = suplabel('Body acceleration a_b', 't');
    set(h1,'FontSize',10)
    ...
    ylabel('\omega_{b_x} [ rad/s^2 ]')
    subplot(3,1,2); plot(T,X_dot(5,:))
    ylabel('\omega_{b_y} [ rad/s^2 ]')
    subplot(3,1,3); plot(T,X_dot(6,:))
    xlabel('t [s]')
    ylabel('\omega_{b_z} [ rad/s^2 ]')
    hold off
    [~,h1] = suplabel('Body angular acceleration \dot{\omega}_b', 't');
    set(h1,'FontSize',10)
    ...
    ylabel('AM_x [kg mm^2/s]')
    subplot(3,1,2); plot(t_func,FMI_b.AM(2,:))
    ylabel('AM_y [kg mm^2/s]')
    subplot(3,1,3); plot(t_func,FMI_b.AM(3,:))
    xlabel('t [s]')
    ylabel('AM_z [kg mm^2/s]')
    hold off
    [~,h1] = suplabel('Angular Momentum', 't');
    set(h1,'FontSize',10)
