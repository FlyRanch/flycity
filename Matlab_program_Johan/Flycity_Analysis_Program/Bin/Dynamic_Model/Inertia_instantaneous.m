...
%     F_vel_b = 1e-3*(-M_dot_12*wb-M_dot_13*wL_b- ...
%                     M13*w_dot_L_b-M_dot_14*wR_b-M14*w_dot_R_b);     %[N]
% 
%     M_vel_b = 1e-3*(-M_dot_21*vb-M_dot_22*wb- ...
%                     M_dot_23*wL_b-M23*w_dot_L_b-M_dot_24*wR_b-M24*w_dot_R_b); %[N*mm]
    ...
    FM_b.w_b_dL_dv_b    = 1e-3*w_b_dL_dv_b;
    FM_b.v_b_dL_dv_b    = 1e-3*v_b_dL_dv_b;
    FM_b.w_b_dL_dw_b    = 1e-3*w_b_dL_dw_b;
    
    FM_strkpln.F_I_vel  = R_strk*F_vel_b;
    FM_strkpln.M_I_vel  = R_strk*M_vel_b;
    
    FM_b.w_b_dL_dv_strk = 1e-3*R_strk*w_b_dL_dv_b;
    FM_b.v_b_dL_dv_strk = 1e-3*R_strk*v_b_dL_dv_b;
    FM_b.w_b_dL_dw_strk = 1e-3*R_strk*w_b_dL_dw_b;
