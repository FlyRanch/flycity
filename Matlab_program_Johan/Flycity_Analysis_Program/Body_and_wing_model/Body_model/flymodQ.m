...
if ~BodyOnly
    ...
    %mex C:/Users/Johan/Desktop/Flytracker/Fly_tracker/flytracker/mex/xformq_surf.c
  
   
    [x{2},y{2},z{2}] = xformq_surfMAT(x{2},y{2},z{2},LJTrans,qLwing,params.wingscale);
    [x{3},y{3},z{3}] = xformq_surfMAT(x{3},y{3},z{3},RJTrans,qRwing,params.wingscale);
...
for k = 1:length(x)
    if k == 1
        [x{k},y{k},z{k}] = xformq_surfMAT(x{k},y{k},z{k},Tbody,qbody,params.bodyscale);
    else
        %keyboard
        [x{k},y{k},z{k}] = xformq_surfMAT(x{k},y{k},z{k},Tbody,qbody,1);
    end
end
