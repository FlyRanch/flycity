function [ man ] = FM_aero_maneuver(maneuver,R_strk,wb_names,nr_wb,n_pol_theta,n_pol_eta,n_pol_phi,rot_lift_on)
    ...
    for i = 1:nr_wb
        ...
        [ kine_t ] = angular_velocities_polynomial( a_fit );
        
        kine.u_strk          = zeros(3,nr_points);
        kine.w_strk          = zeros(3,nr_points);
        kine.wL              = kine_t.wL;
        kine.wR              = kine_t.wR;
        kine.w_dot_L         = kine_t.w_dot_L;
        kine.w_dot_R         = kine_t.w_dot_R;
        kine.RL              = kine_t.RL;
        kine.RR              = kine_t.RR;
        kine.R_strk          = R_strk;
        ...
        [ FM_strkpln_man, ~, ~, ~, ~, ~, ~, ~, ~ ] = Aerodynamic_forces( kine, body_model, wing_model, rot_lift_on);
        ...
        [ FM_strkpln_avg, ~, ~, ~, ~, ~, ~, ~, ~ ] = Aerodynamic_forces( kine, body_model, wing_model, rot_lift_on);
