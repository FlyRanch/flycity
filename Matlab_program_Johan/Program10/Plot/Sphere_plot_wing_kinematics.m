function Sphere_plot_wing_kinematics(settings, pathDB, seq_nr, wingbeat_nr, phi, theta, xsi, left_on_off, right_on_off)
    ...
    hold on
    surf(x{1},y{1},z{1},'facecolor',[0.3 0.3 0.3],'edgecolor','k','facelighting','phong');
    
    
    if left_on_off == 1
    plot3(Lwingtip_rot(1,:),Lwingtip_rot(2,:),Lwingtip_rot(3,:),'r','LineWidth',1.5); 
    ...
    if right_on_off == 1
    plot3(Rwingtip_rot(1,:),Rwingtip_rot(2,:),Rwingtip_rot(3,:),'g','LineWidth',1.5);
