...
Pats_shift = ShiftMatrix(Pats,poe_hor,'l','y');
...
pattern.Pats = Pats_shift; 		% put data in structure
...
directory_name = cd;
str = [directory_name '\Pattern_binary_pointexpansion_accelCard_bottompos_shift'];  % name must begin with ?Pattern_?
