...
t_crit = 0.05 % [sec] time of teta_crit
...
pix_max = 8*panel_max; % max pattern size
...
filename = ['pointexpansion_shiftTo' num2str(poe_angle_hor) 'deg_' num2str(teta_crit) 'degAt' num2str(t_crit) 's_max' num2str(teta_max) 'deg'];
