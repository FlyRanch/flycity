function [FM_trans,FM_trans_norm,FM_transNrot,FM_transNrot_norm,...
    ...
    calc_QSforcesNmoments_TESTnModNbodyKin_LnR_TEST(MOD_val,const,wing_model,body_model,freq,...
...
[stroke_L_steady,stroke_R_steady,stroke_dot_L_steady,stroke_dot_R_steady,stroke_dot_dot_L_steady,stroke_dot_dot_R_steady,...
    dev_L_steady,dev_R_steady,dev_dot_L_steady,dev_dot_R_steady,dev_dot_dot_L_steady,dev_dot_dot_R_steady,...
    rot_L_steady,rot_R_steady,rot_dot_L_steady,rot_dot_R_steady,rot_dot_dot_L_steady,rot_dot_dot_R_steady,t,dt] = ...
    make_test_steadyWB_sins(nr_timepoints,freq);
...
down_loc(1) = 1;
loc_max = find(stroke_L == max(stroke_L));
down_loc(2) = loc_max(1);
up_loc(1) = loc_max(1)+1;
...
FM_R_trans_norm(4:6,:) = FM_R_trans(4:6,:)./freq^2./(1e-3*wing_length)^5*1e-3;
...
saveas(gca,['WBkin_quasisteadyModel_steadyWBnMOD',num2str(MOD_val),'_TEST.png'])
...
saveas(gca,['FnM_quasisteadyModel_steadyWBnMOD',num2str(MOD_val),'_TEST.png'])
