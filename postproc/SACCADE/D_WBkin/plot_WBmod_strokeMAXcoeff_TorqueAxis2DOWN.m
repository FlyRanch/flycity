...
plot(M_R_TorqueAxis2DOWN,stroke_wb_R_TorqueAxis2DOWN_bins(1,:),'.b')

% plot trend
RC = strokeMOD_wb_R_TorqueAxis2DOWN_bins_meanCIstd(1,1)/M_R_norm;
...
plot((M_R_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot((M_R_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot((M_R_TorqueAxis2DOWN),stroke_wb_L_TorqueAxis2DOWN_bins(1,:),'.b')

% plot trend
RC = strokeMOD_wb_L_TorqueAxis2DOWN_bins_meanCIstd(1,1)/M_R_norm;
var0 = stroke_wb_steady_bins_meanCIstd(1,1);
x0 = 0;
x1 = max(M_R_TorqueAxis2DOWN);
var1 = var0 + RC * (x1-x0);
...
% plot((M_R_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot((M_R_TorqueAxis2DOWN),Dstroke_wb_TorqueAxis2DOWN_bins(1,:),'.b')

% plot trend
RC = DstrokeMOD_wb_TorqueAxis2DOWN_bins_meanCIstd(1,1)/M_R_norm;
var0 = 0;
x0 = 0;
x1 = max(M_R_TorqueAxis2DOWN);
var1 = var0 + RC * (x1-x0);
...
% right
subplot(3,2,2)
plot((M_R_TorqueAxis2DOWN),strokeMOD_wb_R_TorqueAxis2DOWN_bins(1,:),'.b')
...
% Left
subplot(3,2,4)
plot((M_R_TorqueAxis2DOWN),strokeMOD_wb_L_TorqueAxis2DOWN_bins(1,:),'.b')
...
% right-Left
subplot(3,2,6)
plot((M_R_TorqueAxis2DOWN),DstrokeMOD_wb_TorqueAxis2DOWN_bins(1,:),'.b')
