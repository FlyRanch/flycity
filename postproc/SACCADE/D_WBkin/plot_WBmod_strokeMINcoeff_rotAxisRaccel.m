...
% plot trend
RC = strokeMOD_wb_R_rotAxisRaccel_bins_meanCIstd(n_loc,1)/rotRaccel_norm;
...
% plot trend
RC = strokeMOD_wb_L_rotAxisRaccel_bins_meanCIstd(n_loc,1)/rotRaccel_norm;
var0 = stroke_wb_steady_bins_meanCIstd(n_loc,1);
x0 = 0;
x1 = max(rotRaccel_rotAxisRaccel);
var1 = var0 + RC * (x1-x0);
...
subplot(3,2,5)
plot((rot_dot_dot_R_mean_wb),Dstroke_wb_bins(n_loc,:),'.k')
% plot((rot_dot_dot_R_mean_wb),stroke_wb_R_bins(n_loc,:),'.k')
plot((rotRaccel_rotAxisRaccel),Dstroke_wb_rotAxisRaccel_bins(n_loc,:),'.b')

% plot trend
RC = DstrokeMOD_wb_rotAxisRaccel_bins_meanCIstd(n_loc,1)/rotRaccel_norm;
var0 = 0;
x0 = 0;
x1 = max(rotRaccel_rotAxisRaccel);
var1 = var0 + RC * (x1-x0);
...
RC = strokeMOD_wb_R_rotAxisRaccel_bins_meanCIstd(n_loc,1);
var0 = 0;
x0 = 0; 
x1 = max(rotRaccel_rotAxisRaccel); 
var1 = RC
...
RC = strokeMOD_wb_L_rotAxisRaccel_bins_meanCIstd(n_loc,1);
var0 = 0;
x0 = 0; 
x1 = max(rotRaccel_rotAxisRaccel); 
var1 = RC
...
% right-Left
subplot(3,2,6)
plot((rotRaccel_rotAxisRaccel),DstrokeMOD_wb_rotAxisRaccel_bins(n_loc,:),'.b')

RC = DstrokeMOD_wb_rotAxisRaccel_bins_meanCIstd(n_loc,1);
var0 = 0;
x0 = 0; 
x1 = max(rotRaccel_rotAxisRaccel); 
var1 = RC
