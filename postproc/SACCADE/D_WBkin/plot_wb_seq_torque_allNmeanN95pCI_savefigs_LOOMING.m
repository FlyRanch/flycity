...
subplot(3,3,1)
hold on
plot(t_wb_seq_pre_mean_all,Mroll_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Mroll_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Mroll_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,2)
hold on
plot(t_wb_seq_pre_mean_all,Mroll_mean_wb_accel_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Mroll_mean_wb_accel_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Mroll_mean_wb_accel_seq_pre_mean_all,'c')
...
subplot(3,3,3)
hold on
plot(t_wb_seq_pre_mean_all,Mroll_mean_wb_damp_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Mroll_mean_wb_damp_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Mroll_mean_wb_damp_seq_pre_mean_all,'c')
...
subplot(3,3,4)
hold on
plot(t_wb_seq_pre_mean_all,Mpitch_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Mpitch_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Mpitch_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,5)
hold on
plot(t_wb_seq_pre_mean_all,Mpitch_mean_wb_accel_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Mpitch_mean_wb_accel_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Mpitch_mean_wb_accel_seq_pre_mean_all,'c')
...
subplot(3,3,6)
hold on
plot(t_wb_seq_pre_mean_all,Mpitch_mean_wb_damp_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Mpitch_mean_wb_damp_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Mpitch_mean_wb_damp_seq_pre_mean_all,'c')
...
subplot(3,3,7)
hold on
plot(t_wb_seq_pre_mean_all,Myaw_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Myaw_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Myaw_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,8)
hold on
plot(t_wb_seq_pre_mean_all,Myaw_mean_wb_accel_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Myaw_mean_wb_accel_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Myaw_mean_wb_accel_seq_pre_mean_all,'c')
...
subplot(3,3,9)
hold on
plot(t_wb_seq_pre_mean_all,Myaw_mean_wb_damp_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,Myaw_mean_wb_damp_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,Myaw_mean_wb_damp_seq_pre_mean_all,'c')
...
subplot(3,3,1)
hold on
plot(t_wb_seq_pre_mean_all,M_R_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,M_R_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,M_R_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,2)
hold on
plot(t_wb_seq_pre_mean_all,M_R_mean_wb_accel_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,M_R_mean_wb_accel_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,M_R_mean_wb_accel_seq_pre_mean_all,'c')
...
subplot(3,3,3)
hold on
plot(t_wb_seq_pre_mean_all,M_R_mean_wb_damp_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,M_R_mean_wb_damp_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,M_R_mean_wb_damp_seq_pre_mean_all,'c')
...
subplot(3,3,4)
hold on
plot(t_wb_seq_pre_mean_all,M_L_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,M_L_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,M_L_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,5)
hold on
plot(t_wb_seq_pre_mean_all,M_L_mean_wb_accel_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,M_L_mean_wb_accel_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,M_L_mean_wb_accel_seq_pre_mean_all,'c')
...
subplot(3,3,6)
hold on
plot(t_wb_seq_pre_mean_all,M_L_mean_wb_damp_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,M_L_mean_wb_damp_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,M_L_mean_wb_damp_seq_pre_mean_all,'c')
