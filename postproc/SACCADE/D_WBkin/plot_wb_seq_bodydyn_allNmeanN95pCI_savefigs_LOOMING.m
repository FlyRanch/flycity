...
subplot(3,3,1)
hold on
plot(t_wb_seq_pre_mean_all,roll_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,roll_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,roll_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,2)
hold on
plot(t_wb_seq_pre_mean_all,roll_dot_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,roll_dot_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,roll_dot_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,3)
hold on
plot(t_wb_seq_pre_mean_all,roll_dot_dot_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,roll_dot_dot_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,roll_dot_dot_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,4)
hold on
plot(t_wb_seq_pre_mean_all,pitch_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,pitch_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,pitch_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,5)
hold on
plot(t_wb_seq_pre_mean_all,pitch_dot_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,pitch_dot_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,pitch_dot_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,6)
hold on
plot(t_wb_seq_pre_mean_all,pitch_dot_dot_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,pitch_dot_dot_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,pitch_dot_dot_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,7)
hold on
plot(t_wb_seq_pre_mean_all,yaw_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,yaw_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,yaw_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,8)
hold on
plot(t_wb_seq_pre_mean_all,yaw_dot_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,yaw_dot_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,yaw_dot_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,9)
hold on
plot(t_wb_seq_pre_mean_all,yaw_dot_dot_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,yaw_dot_dot_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,yaw_dot_dot_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,1)
hold on
plot(t_wb_seq_pre_mean_all,drot_R_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,drot_R_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,drot_R_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,2)
hold on
plot(t_wb_seq_pre_mean_all,rot_dot_R_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,rot_dot_R_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,rot_dot_R_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,3)
hold on
plot(t_wb_seq_pre_mean_all,rot_dot_dot_R_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,rot_dot_dot_R_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,rot_dot_dot_R_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,4)
hold on
plot(t_wb_seq_pre_mean_all,drot_L_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,drot_L_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,drot_L_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,5)
hold on
plot(t_wb_seq_pre_mean_all,rot_dot_L_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,rot_dot_L_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,rot_dot_L_mean_wb_seq_pre_mean_all,'c')
...
subplot(3,3,6)
hold on
plot(t_wb_seq_pre_mean_all,rot_dot_dot_L_mean_wb_seq_pre_all,'.c')
plot(t_wb_seq_post_mean_all,rot_dot_dot_L_mean_wb_seq_post_all,'.','color',[1 .5 0])

plot(t_wb_seq_pre_mean_all,rot_dot_dot_L_mean_wb_seq_pre_mean_all,'c')
