...
subplot(3,3,1)
strokeMOD_fwd = calc_val_fourier_series_4thN8th_order(binx,strokeMOD_fwd_YawAccel_fourier_coeffs_binmean,0);
...
subplot(3,3,2)
pitchMOD_fwd = calc_val_fourier_series_4thN8th_order(binx,pitchMOD_fwd_YawAccel_fourier_coeffs_binmean,0);
...
subplot(3,3,3)
devMOD_fwd = calc_val_fourier_series_4thN8th_order(binx,devMOD_fwd_YawAccel_fourier_coeffs_binmean,0);
...
subplot(3,3,4)
strokeMOD_rwd = calc_val_fourier_series_4thN8th_order(binx,strokeMOD_rwd_YawAccel_fourier_coeffs_binmean,0);
...
subplot(3,3,5)
pitchMOD_rwd = calc_val_fourier_series_4thN8th_order(binx,pitchMOD_rwd_YawAccel_fourier_coeffs_binmean,0);
...
subplot(3,3,6)
devMOD_rwd = calc_val_fourier_series_4thN8th_order(binx,devMOD_rwd_YawAccel_fourier_coeffs_binmean,0);
