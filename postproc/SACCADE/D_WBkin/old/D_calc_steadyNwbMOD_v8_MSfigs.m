...
MSplot_WBsteady2mod2xNorm_Mroll
    saveas(gca,['MSplot_WBsteady2mod2xNorm_Mroll.fig'])
    saveas(gca,['MSplot_WBsteady2mod2xNorm_Mroll.png'])
    plot2svg(['MSplot_WBsteady2mod2xNorm_Mroll.svg'])

MSplot_WBsteady2mod2xNorm_Mpitch
    saveas(gca,['MSplot_WBsteady2mod2xNorm_Mpitch.fig'])
    saveas(gca,['MSplot_WBsteady2mod2xNorm_Mpitch.png'])
    plot2svg(['MSplot_WBsteady2mod2xNorm_Mpitch.svg'])
