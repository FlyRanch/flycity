...
plot(abs(Myaw_YawTorque),stroke_wb_fwd_YawTorque_bins(n_loc,:),'.b')
...
% plot(abs(Myaw_mean_wb),stroke_wb_L_bins(n_loc,:),'.k')
% plot(abs(Myaw_mean_wb),stroke_wb_R_bins(n_loc,:),'.k')
plot(abs(Myaw_YawTorque),stroke_wb_rwd_YawTorque_bins(n_loc,:),'.b')
...
% plot(abs(Myaw_mean_wb),stroke_wb_L_bins(n_loc,:),'.k')
% plot(abs(Myaw_mean_wb),stroke_wb_R_bins(n_loc,:),'.k')
plot(abs(Myaw_YawTorque),Dstroke_wb_YawTorque_bins(n_loc,:),'.b')
...
% for
subplot(3,2,2)
plot(abs(Myaw_YawTorque),strokeMOD_wb_fwd_YawTorque_bins(n_loc,:),'.b')
...
% rear
subplot(3,2,4)
plot(abs(Myaw_YawTorque),strokeMOD_wb_rwd_YawTorque_bins(n_loc,:),'.b')
...
% for rear
subplot(3,2,6)
plot(abs(Myaw_YawTorque),DstrokeMOD_wb_YawTorque_bins(n_loc,:),'.b')
