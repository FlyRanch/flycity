...
% plot(t_wb_seq_pre_mean_all,f_wb_seq_pre,'.','color',[0 .5 1])
% plot(t_wb_seq_post_mean_all,f_wb_seq_post,'.','color',[1 .5 0])
% 
% plot(t_wb_seq_pre_mean_all,f_wb_seq_pre_mean_all,'color',[0 .5 1])
% plot(t_wb_seq_post_mean_all,f_wb_seq_post_mean_all,'color',[1 .5 0])
...
subplot(3,1,1)
hold on
plot(t_wb_seq_bins_mean_all,stroke_wb_L_seq_bins_all,'linewidth',.25,'color',[0 .5 1])
plot(t_wb_seq_bins_mean_all,stroke_wb_R_seq_bins_all,'linewidth',.25,'color',[1 .5 0])
% 
% plot(t_wb_seq_bins_mean_all,stroke_wb_L_seq_bins_mean_all,'color',[0 .5 1],'linewidth',2)
% plot(t_wb_seq_bins_mean_all,stroke_wb_R_seq_bins_mean_all,'color',[1 .5 0],'linewidth',2)
...
subplot(3,1,2)
hold on
plot(t_wb_seq_bins_mean_all,dev_wb_L_seq_bins_all,'linewidth',.25,'color',[0 .5 1])
plot(t_wb_seq_bins_mean_all,dev_wb_R_seq_bins_all,'linewidth',.25,'color',[1 .5 0])

% plot(t_wb_seq_bins_mean_all,dev_wb_L_seq_bins_mean_all,'color',[0 .5 1],'linewidth',2)
% plot(t_wb_seq_bins_mean_all,dev_wb_R_seq_bins_mean_all,'color',[1 .5 0],'linewidth',2)
...
subplot(3,1,3)
hold on
plot(t_wb_seq_bins_mean_all,pitch_wb_L_seq_bins_all,'linewidth',.25,'color',[0 .5 1])
plot(t_wb_seq_bins_mean_all,pitch_wb_R_seq_bins_all,'linewidth',.25,'color',[1 .5 0])

% plot(t_wb_seq_bins_mean_all,pitch_wb_L_seq_bins_mean_all,'color',[0 .5 1],'linewidth',2)
% plot(t_wb_seq_bins_mean_all,pitch_wb_R_seq_bins_mean_all,'color',[1 .5 0],'linewidth',2)
...
ciplot(stroke_wb_L_seq_bins_mean_all-1.96*stroke_wb_L_seq_bins_ste_all,...
    stroke_wb_L_seq_bins_mean_all+1.96*stroke_wb_L_seq_bins_ste_all,t_wb_seq_bins_mean_all,[0 .5 1])
ciplot(stroke_wb_R_seq_bins_mean_all-1.96*stroke_wb_R_seq_bins_ste_all,...
    stroke_wb_R_seq_bins_mean_all+1.96*stroke_wb_R_seq_bins_ste_all,t_wb_seq_bins_mean_all,[1 .5 0])
