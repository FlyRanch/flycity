...
%             Fsp_pitch_us_now = Fsp_pitch(n_up_start_L_now:n_NEXTdown_mid_L_now,seq);
            ...
            seq_nr(n_now,1) = seq;
            wb_nr(n_now,1) = wb;
            frame_nr(n_now,1) = n_down_start_L_now;
            frame_nr_2resp(n_now,1) = n_down_start_L_now - n_pre_now;
...
Mroll_mean_wb_accel  = Iroll  .* roll_dot_dot_mean_wb * pi/180;
Mpitch_mean_wb_accel = Ipitch .* pitch_dot_dot_mean_wb * pi/180;
Myaw_mean_wb_accel   = Iyaw   .* yaw_dot_dot_mean_wb * pi/180;

Mroll_mean_wb_damp  = Croll  .* roll_dot_mean_wb * pi/180;
Mpitch_mean_wb_damp = Cpitch .* pitch_dot_mean_wb * pi/180;
Myaw_mean_wb_damp   = Cyaw   .* yaw_dot_mean_wb * pi/180;
...
M_L_mean_wb_accel = Mroll_mean_wb_accel*sind(rot_axis_angle) - Mpitch_mean_wb_accel*cosd(rot_axis_angle);
M_R_mean_wb_accel = Mroll_mean_wb_accel*cosd(rot_axis_angle) + Mpitch_mean_wb_accel*sind(rot_axis_angle);

M_L_mean_wb_damp = Mroll_mean_wb_damp*sind(rot_axis_angle) - Mpitch_mean_wb_damp*cosd(rot_axis_angle);
M_R_mean_wb_damp = Mroll_mean_wb_damp*cosd(rot_axis_angle) + Mpitch_mean_wb_damp*sind(rot_axis_angle);

M_L_mean_wb = M_L_mean_wb_accel + M_L_mean_wb_damp;
M_R_mean_wb = M_R_mean_wb_accel + M_R_mean_wb_damp;

M_axis1normal_mean_wb_accel = Mroll_mean_wb_accel*sind(rot1_axis_angle) - Mpitch_mean_wb_accel*cosd(rot1_axis_angle);
M_axis1_mean_wb_accel = Mroll_mean_wb_accel*cosd(rot1_axis_angle) + Mpitch_mean_wb_accel*sind(rot1_axis_angle);

M_axis1normal_mean_wb_damp = Mroll_mean_wb_damp*sind(rot1_axis_angle) - Mpitch_mean_wb_damp*cosd(rot1_axis_angle);
M_axis1_mean_wb_damp = Mroll_mean_wb_damp*cosd(rot1_axis_angle) + Mpitch_mean_wb_damp*sind(rot1_axis_angle);

M_axis1normal_mean_wb = M_axis1normal_mean_wb_accel + M_axis1normal_mean_wb_damp;
M_axis1_mean_wb = M_axis1_mean_wb_accel + M_axis1_mean_wb_damp;

M_axis2normal_mean_wb_accel = Mroll_mean_wb_accel*sind(rot2_axis_angle) - Mpitch_mean_wb_accel*cosd(rot2_axis_angle);
M_axis2_mean_wb_accel = Mroll_mean_wb_accel*cosd(rot2_axis_angle) + Mpitch_mean_wb_accel*sind(rot2_axis_angle);

M_axis2normal_mean_wb_damp = Mroll_mean_wb_damp*sind(rot2_axis_angle) - Mpitch_mean_wb_damp*cosd(rot2_axis_angle);
M_axis2_mean_wb_damp = Mroll_mean_wb_damp*cosd(rot2_axis_angle) + Mpitch_mean_wb_damp*sind(rot2_axis_angle);

M_axis2normal_mean_wb = M_axis2normal_mean_wb_accel + M_axis2normal_mean_wb_damp;
M_axis2_mean_wb = M_axis2_mean_wb_accel + M_axis2_mean_wb_damp;

% NOT normalized torques
Mroll_mean_wb_accel_NOnorm = Mroll_mean_wb_accel;
Mpitch_mean_wb_accel_NOnorm = Mpitch_mean_wb_accel;
Myaw_mean_wb_accel_NOnorm = Myaw_mean_wb_accel;
M_L_mean_wb_accel_NOnorm = M_L_mean_wb_accel;
M_R_mean_wb_accel_NOnorm = M_R_mean_wb_accel;
M_axis1_mean_wb_accel_NOnorm = M_axis1_mean_wb_accel;
M_axis1normal_mean_wb_accel_NOnorm = M_axis1normal_mean_wb_accel;
M_axis2_mean_wb_accel_NOnorm = M_axis2_mean_wb_accel;
M_axis2normal_mean_wb_accel_NOnorm = M_axis2normal_mean_wb_accel;

Mroll_mean_wb_damp_NOnorm = Mroll_mean_wb_damp;
Mpitch_mean_wb_damp_NOnorm = Mpitch_mean_wb_damp;
Myaw_mean_wb_damp_NOnorm = Myaw_mean_wb_damp;
M_L_mean_wb_damp_NOnorm = M_L_mean_wb_damp;
M_R_mean_wb_damp_NOnorm = M_R_mean_wb_damp;
M_axis1_mean_wb_damp_NOnorm = M_axis1_mean_wb_damp;
M_axis1normal_mean_wb_damp_NOnorm = M_axis1normal_mean_wb_damp;
M_axis2_mean_wb_damp_NOnorm = M_axis2_mean_wb_damp;
M_axis2normal_mean_wb_damp_NOnorm = M_axis2normal_mean_wb_damp;

Mroll_mean_wb_NOnorm = Mroll_mean_wb;
Mpitch_mean_wb_NOnorm = Mpitch_mean_wb;
Myaw_mean_wb_NOnorm = Myaw_mean_wb;
M_L_mean_wb_NOnorm = M_L_mean_wb;
M_R_mean_wb_NOnorm = M_R_mean_wb;
M_axis1_mean_wb_NOnorm = M_axis1_mean_wb;
M_axis1normal_mean_wb_NOnorm = M_axis1normal_mean_wb;
M_axis2_mean_wb_NOnorm = M_axis2_mean_wb;
M_axis2normal_mean_wb_NOnorm = M_axis2normal_mean_wb;

% normalized torques
Mroll_mean_wb_accel_norm = Mroll_mean_wb_accel ./ Mg_fly ./ Lwing;
Mpitch_mean_wb_accel_norm = Mpitch_mean_wb_accel ./ Mg_fly ./ Lwing;
Myaw_mean_wb_accel_norm = Myaw_mean_wb_accel ./ Mg_fly ./ Lwing;
M_L_mean_wb_accel_norm = M_L_mean_wb_accel ./ Mg_fly ./ Lwing;
M_R_mean_wb_accel_norm = M_R_mean_wb_accel ./ Mg_fly ./ Lwing;
M_axis1_mean_wb_accel_norm = M_axis1_mean_wb_accel ./ Mg_fly ./ Lwing;
M_axis1normal_mean_wb_accel_norm = M_axis1normal_mean_wb_accel ./ Mg_fly ./ Lwing;
M_axis2_mean_wb_accel_norm = M_axis2_mean_wb_accel ./ Mg_fly ./ Lwing;
M_axis2normal_mean_wb_accel_norm = M_axis2normal_mean_wb_accel ./ Mg_fly ./ Lwing;

Mroll_mean_wb_damp_norm = Mroll_mean_wb_damp ./ Mg_fly ./ Lwing;
Mpitch_mean_wb_damp_norm = Mpitch_mean_wb_damp ./ Mg_fly ./ Lwing;
Myaw_mean_wb_damp_norm = Myaw_mean_wb_damp ./ Mg_fly ./ Lwing;
M_L_mean_wb_damp_norm = M_L_mean_wb_damp ./ Mg_fly ./ Lwing;
M_R_mean_wb_damp_norm = M_R_mean_wb_damp ./ Mg_fly ./ Lwing;
M_axis1_mean_wb_damp_norm = M_axis1_mean_wb_damp ./ Mg_fly ./ Lwing;
M_axis1normal_mean_wb_damp_norm = M_axis1normal_mean_wb_damp ./ Mg_fly ./ Lwing;
M_axis2_mean_wb_damp_norm = M_axis2_mean_wb_damp ./ Mg_fly ./ Lwing;
M_axis2normal_mean_wb_damp_norm = M_axis2normal_mean_wb_damp ./ Mg_fly ./ Lwing;

Mroll_mean_wb_norm = Mroll_mean_wb ./ Mg_fly ./ Lwing;
Mpitch_mean_wb_norm = Mpitch_mean_wb ./ Mg_fly ./ Lwing;
Myaw_mean_wb_norm = Myaw_mean_wb ./ Mg_fly ./ Lwing;
M_L_mean_wb_norm = M_L_mean_wb ./ Mg_fly ./ Lwing;
M_R_mean_wb_norm = M_R_mean_wb ./ Mg_fly ./ Lwing;
M_axis1_mean_wb_norm = M_axis1_mean_wb ./ Mg_fly ./ Lwing;
M_axis1normal_mean_wb_norm = M_axis1normal_mean_wb ./ Mg_fly ./ Lwing;
M_axis2_mean_wb_norm = M_axis2_mean_wb ./ Mg_fly ./ Lwing;
M_axis2normal_mean_wb_norm = M_axis2normal_mean_wb ./ Mg_fly ./ Lwing;

% !!! normalized torques based on Fnorm * Mg !!!
Mroll_mean_wb_accel_Fnorm = Mroll_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
Mpitch_mean_wb_accel_Fnorm = Mpitch_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
Myaw_mean_wb_accel_Fnorm = Myaw_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_L_mean_wb_accel_Fnorm = M_L_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_R_mean_wb_accel_Fnorm = M_R_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis1_mean_wb_accel_Fnorm = M_axis1_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis1normal_mean_wb_accel_Fnorm = M_axis1normal_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis2_mean_wb_accel_Fnorm = M_axis2_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis2normal_mean_wb_accel_Fnorm = M_axis2normal_mean_wb_accel ./ F_mean_wb ./ Mg_fly ./ Lwing;

Mroll_mean_wb_damp_Fnorm = Mroll_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
Mpitch_mean_wb_damp_Fnorm = Mpitch_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
Myaw_mean_wb_damp_Fnorm = Myaw_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_L_mean_wb_damp_Fnorm = M_L_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_R_mean_wb_damp_Fnorm = M_R_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis1_mean_wb_damp_Fnorm = M_axis1_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis1normal_mean_wb_damp_Fnorm = M_axis1normal_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis2_mean_wb_damp_Fnorm = M_axis2_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis2normal_mean_wb_damp_Fnorm = M_axis2normal_mean_wb_damp ./ F_mean_wb ./ Mg_fly ./ Lwing;

Mroll_mean_wb_Fnorm = Mroll_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
Mpitch_mean_wb_Fnorm = Mpitch_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
Myaw_mean_wb_Fnorm = Myaw_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_L_mean_wb_Fnorm = M_L_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_R_mean_wb_Fnorm = M_R_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis1_mean_wb_Fnorm = M_axis1_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis1normal_mean_wb_Fnorm = M_axis1normal_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis2_mean_wb_Fnorm = M_axis2_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;
M_axis2normal_mean_wb_Fnorm = M_axis2normal_mean_wb ./ F_mean_wb ./ Mg_fly ./ Lwing;

% !!! replace NOT normalized torques with Fnorm*Mg normalized torque
Mroll_mean_wb_accel = Mroll_mean_wb_accel_Fnorm;
Mpitch_mean_wb_accel = Mpitch_mean_wb_accel_Fnorm;
Myaw_mean_wb_accel = Myaw_mean_wb_accel_Fnorm;
M_L_mean_wb_accel = M_L_mean_wb_accel_Fnorm;
M_R_mean_wb_accel = M_R_mean_wb_accel_Fnorm;
M_axis1_mean_wb_accel = M_axis1_mean_wb_accel_Fnorm;
M_axis1normal_mean_wb_accel = M_axis1normal_mean_wb_accel_Fnorm;
M_axis2_mean_wb_accel = M_axis2_mean_wb_accel_Fnorm;
M_axis2normal_mean_wb_accel = M_axis2normal_mean_wb_accel_Fnorm;

Mroll_mean_wb_damp = Mroll_mean_wb_damp_Fnorm;
Mpitch_mean_wb_damp = Mpitch_mean_wb_damp_Fnorm;
Myaw_mean_wb_damp = Myaw_mean_wb_damp_Fnorm;
M_L_mean_wb_damp = M_L_mean_wb_damp_Fnorm;
M_R_mean_wb_damp = M_R_mean_wb_damp_Fnorm;
M_axis1_mean_wb_damp = M_axis1_mean_wb_damp_Fnorm;
M_axis1normal_mean_wb_damp = M_axis1normal_mean_wb_damp_Fnorm;
M_axis2_mean_wb_damp = M_axis2_mean_wb_damp_Fnorm;
M_axis2normal_mean_wb_damp = M_axis2normal_mean_wb_damp_Fnorm;

Mroll_mean_wb = Mroll_mean_wb_Fnorm;
Mpitch_mean_wb = Mpitch_mean_wb_Fnorm;
Myaw_mean_wb = Myaw_mean_wb_Fnorm;
M_L_mean_wb = M_L_mean_wb_Fnorm;
M_R_mean_wb = M_R_mean_wb_Fnorm;
M_axis1_mean_wb = M_axis1_mean_wb_Fnorm;
M_axis1normal_mean_wb = M_axis1normal_mean_wb_Fnorm;
M_axis2_mean_wb = M_axis2_mean_wb_Fnorm;
M_axis2normal_mean_wb = M_axis2normal_mean_wb_Fnorm;
...
% save wb
save(['WBdataset_all_',num2str(n_wb),'WBs_accelNtorqueNorm.mat'],...
...
't_wb_bin',...
't_ds_bin',...
't_us_bin',...
...
'M_R_mean_wb',...
'M_axis1_mean_wb',...
'M_axis1normal_mean_wb',...
'M_axis2_mean_wb',...
'M_axis2normal_mean_wb',...
...
'Mroll_mean_wb_accel',...
...
'M_L_mean_wb_accel',...
'M_R_mean_wb_accel',...
'M_axis1_mean_wb_accel',...
'M_axis1normal_mean_wb_accel',...
'M_axis2_mean_wb_accel',...
'M_axis2normal_mean_wb_accel',...
...
'Mroll_mean_wb_damp',...
'Mpitch_mean_wb_damp',...
'Myaw_mean_wb_damp',...
'M_L_mean_wb_damp',...
'M_R_mean_wb_damp',...
'M_axis1_mean_wb_damp',...
'M_axis1normal_mean_wb_damp',...
'M_axis2_mean_wb_damp',...
'M_axis2normal_mean_wb_damp',...
...
'Mroll_mean_wb_norm',...
'Mpitch_mean_wb_norm',...
'Myaw_mean_wb_norm',...
'M_L_mean_wb_norm',...
'M_R_mean_wb_norm',...
'M_axis1_mean_wb_norm',...
'M_axis1normal_mean_wb_norm',...
'M_axis2_mean_wb_norm',...
'M_axis2normal_mean_wb_norm',...
...
'Mroll_mean_wb_accel_norm',...
'Mpitch_mean_wb_accel_norm',...
'Myaw_mean_wb_accel_norm',...
'M_L_mean_wb_accel_norm',...
'M_R_mean_wb_accel_norm',...
'M_axis1_mean_wb_accel_norm',...
'M_axis1normal_mean_wb_accel_norm',...
'M_axis2_mean_wb_accel_norm',...
'M_axis2normal_mean_wb_accel_norm',...
...
'Mroll_mean_wb_damp_norm',...
'Mpitch_mean_wb_damp_norm',...
'Myaw_mean_wb_damp_norm',...
'M_L_mean_wb_damp_norm',...
'M_R_mean_wb_damp_norm',...
'M_axis1_mean_wb_damp_norm',...
'M_axis1normal_mean_wb_damp_norm',...
'M_axis2_mean_wb_damp_norm',...
'M_axis2normal_mean_wb_damp_norm',...
...
'Mroll_mean_wb_NOnorm',...
'Mpitch_mean_wb_NOnorm',...
'Myaw_mean_wb_NOnorm',...
'M_L_mean_wb_NOnorm',...
'M_R_mean_wb_NOnorm',...
'M_axis1_mean_wb_NOnorm',...
'M_axis1normal_mean_wb_NOnorm',...
'M_axis2_mean_wb_NOnorm',...
'M_axis2normal_mean_wb_NOnorm',...
...
'Mroll_mean_wb_accel_NOnorm',...
'Mpitch_mean_wb_accel_NOnorm',...
'Myaw_mean_wb_accel_NOnorm',...
'M_L_mean_wb_accel_NOnorm',...
'M_R_mean_wb_accel_NOnorm',...
'M_axis1_mean_wb_accel_NOnorm',...
'M_axis1normal_mean_wb_accel_NOnorm',...
'M_axis2_mean_wb_accel_NOnorm',...
'M_axis2normal_mean_wb_accel_NOnorm',...
...
'Mroll_mean_wb_damp_NOnorm',...
'Mpitch_mean_wb_damp_NOnorm',...
'Myaw_mean_wb_damp_NOnorm',...
'M_L_mean_wb_damp_NOnorm',...
'M_R_mean_wb_damp_NOnorm',...
'M_axis1_mean_wb_damp_NOnorm',...
'M_axis1normal_mean_wb_damp_NOnorm',...
'M_axis2_mean_wb_damp_NOnorm',...
'M_axis2normal_mean_wb_damp_NOnorm',...
...
'Mroll_mean_wb_Fnorm',...
'Mpitch_mean_wb_Fnorm',...
'Myaw_mean_wb_Fnorm',...
'M_L_mean_wb_Fnorm',...
'M_R_mean_wb_Fnorm',...
'M_axis1_mean_wb_Fnorm',...
'M_axis1normal_mean_wb_Fnorm',...
'M_axis2_mean_wb_Fnorm',...
'M_axis2normal_mean_wb_Fnorm',...
...
'Mroll_mean_wb_accel_Fnorm',...
'Mpitch_mean_wb_accel_Fnorm',...
'Myaw_mean_wb_accel_Fnorm',...
'M_L_mean_wb_accel_Fnorm',...
'M_R_mean_wb_accel_Fnorm',...
'M_axis1_mean_wb_accel_Fnorm',...
'M_axis1normal_mean_wb_accel_Fnorm',...
'M_axis2_mean_wb_accel_Fnorm',...
'M_axis2normal_mean_wb_accel_Fnorm',...
...
'Mroll_mean_wb_damp_Fnorm',...
'Mpitch_mean_wb_damp_Fnorm',...
'Myaw_mean_wb_damp_Fnorm',...
'M_L_mean_wb_damp_Fnorm',...
'M_R_mean_wb_damp_Fnorm',...
'M_axis1_mean_wb_damp_Fnorm',...
'M_axis1normal_mean_wb_damp_Fnorm',...
'M_axis2_mean_wb_damp_Fnorm',...
'M_axis2normal_mean_wb_damp_Fnorm',...
...
