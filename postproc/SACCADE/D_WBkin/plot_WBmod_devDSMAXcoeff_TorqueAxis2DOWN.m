...
plot(M_R_TorqueAxis2DOWN,dev_wb_R_TorqueAxis2DOWN_bins(n_loc,:),'.b')

% plot trend
RC = devMOD_wb_R_TorqueAxis2DOWN_bins_meanCIstd(n_loc,1)/M_R_norm;
...
plot((M_R_mean_wb),dev_wb_L_bins(n_loc,:),'.k')
% plot((M_R_mean_wb),dev_wb_R_bins(n_loc,:),'.k')
plot((M_R_TorqueAxis2DOWN),dev_wb_L_TorqueAxis2DOWN_bins(n_loc,:),'.b')

% plot trend
RC = devMOD_wb_L_TorqueAxis2DOWN_bins_meanCIstd(n_loc,1)/M_R_norm;
var0 = dev_wb_steady_bins_meanCIstd(n_loc,1);
x0 = 0;
x1 = max(M_R_TorqueAxis2DOWN);
var1 = var0 + RC * (x1-x0);
...
% plot((M_R_mean_wb),dev_wb_R_bins(n_loc,:),'.k')
plot((M_R_TorqueAxis2DOWN),Ddev_wb_TorqueAxis2DOWN_bins(n_loc,:),'.b')

% plot trend
RC = DdevMOD_wb_TorqueAxis2DOWN_bins_meanCIstd(n_loc,1)/M_R_norm;
var0 = 0;
x0 = 0;
x1 = max(M_R_TorqueAxis2DOWN);
var1 = var0 + RC * (x1-x0);
...
% right
subplot(3,2,2)
plot((M_R_TorqueAxis2DOWN),devMOD_wb_R_TorqueAxis2DOWN_bins(n_loc,:),'.b')
...
% Left
subplot(3,2,4)
plot((M_R_TorqueAxis2DOWN),devMOD_wb_L_TorqueAxis2DOWN_bins(n_loc,:),'.b')
...
% right-Left
subplot(3,2,6)
plot((M_R_TorqueAxis2DOWN),DdevMOD_wb_TorqueAxis2DOWN_bins(n_loc,:),'.b')
