...
subplot(3,2,1)
plot(Myaw_mean_wb,stroke_wb_L_bins(1,:),'.k')
plot(Myaw_YawTorque,stroke_wb_fwd_YawTorque_bins(1,:),'.b')
...
subplot(3,2,3)
plot(Myaw_mean_wb,stroke_wb_R_bins(1,:),'.k')
plot(Myaw_YawTorque,stroke_wb_rwd_YawTorque_bins(1,:),'.b')
...
subplot(3,2,5)
plot(Myaw_mean_wb,Dstroke_wb_bins(1,:),'.k')
plot(Myaw_YawTorque,Dstroke_wb_YawTorque_bins(1,:),'.b')
...
% for
subplot(3,2,2)
plot((Myaw_YawTorque),strokeMOD_wb_fwd_YawTorque_bins(1,:),'.b')
...
% rear
subplot(3,2,4)
plot((Myaw_YawTorque),strokeMOD_wb_rwd_YawTorque_bins(1,:),'.b')
...
% for rear
subplot(3,2,6)
plot((Myaw_YawTorque),DstrokeMOD_wb_YawTorque_bins(1,:),'.b')
