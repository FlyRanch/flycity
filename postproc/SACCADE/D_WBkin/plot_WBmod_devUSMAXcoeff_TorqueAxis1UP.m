...
plot(M_R_TorqueAxis1UP,dev_wb_R_TorqueAxis1UP_bins(n_loc,:),'.b')

% plot trend
RC = devMOD_wb_R_TorqueAxis1UP_bins_meanCIstd(n_loc,1)/M_R_norm;
...
plot((M_R_mean_wb),dev_wb_L_bins(n_loc,:),'.k')
% plot((M_R_mean_wb),dev_wb_R_bins(n_loc,:),'.k')
plot((M_R_TorqueAxis1UP),dev_wb_L_TorqueAxis1UP_bins(n_loc,:),'.b')

% plot trend
RC = devMOD_wb_L_TorqueAxis1UP_bins_meanCIstd(n_loc,1)/M_R_norm;
var0 = dev_wb_steady_bins_meanCIstd(n_loc,1);
x0 = 0;
x1 = max(M_R_TorqueAxis1UP);
var1 = var0 + RC * (x1-x0);
...
% plot((M_R_mean_wb),dev_wb_R_bins(n_loc,:),'.k')
plot((M_R_TorqueAxis1UP),Ddev_wb_TorqueAxis1UP_bins(n_loc,:),'.b')

% plot trend
RC = DdevMOD_wb_TorqueAxis1UP_bins_meanCIstd(n_loc,1)/M_R_norm;
var0 = 0;
x0 = 0;
x1 = max(M_R_TorqueAxis1UP);
var1 = var0 + RC * (x1-x0);
...
% right
subplot(3,2,2)
plot((M_R_TorqueAxis1UP),devMOD_wb_R_TorqueAxis1UP_bins(n_loc,:),'.b')
...
% Left
subplot(3,2,4)
plot((M_R_TorqueAxis1UP),devMOD_wb_L_TorqueAxis1UP_bins(n_loc,:),'.b')
...
% right-Left
subplot(3,2,6)
plot((M_R_TorqueAxis1UP),DdevMOD_wb_TorqueAxis1UP_bins(n_loc,:),'.b')
