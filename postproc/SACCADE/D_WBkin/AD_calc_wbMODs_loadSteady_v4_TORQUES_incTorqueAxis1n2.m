...
%% save norm_data
save('norm_data_torque.mat','Mroll_norm','Mpitch_norm','Myaw_norm','Fenhance_norm','M_R_norm','M_L_norm','M_axis1_norm','M_axis2_norm','f_wb_steady')
...
xmin = -ceil(100*max(abs(M_axis1_mean_wb)))/100;
% xmin = -1.5;
xmax = -xmin;
...
plot2svg(['hist_TorqueAxis1UP',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_heatmap_TorqueAxis1UP
    saveas(gca,['WBmod_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmodNsteady_TorqueAxis1UP
    saveas(gca,['WBmodNsteady_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmodNsteady_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmodNsteady_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmod_strokeMAXcoeff_TorqueAxis1UP
    saveas(gca,['WBmod_strokeMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_strokeMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_strokeMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_strokeMINcoeff_TorqueAxis1UP
    saveas(gca,['WBmod_strokeMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_strokeMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_strokeMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_pitchMIDDScoeff_TorqueAxis1UP
    saveas(gca,['WBmod_pitchMIDDScoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_pitchMIDDScoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_pitchMIDDScoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_pitchMIDUScoeff_TorqueAxis1UP
    saveas(gca,['WBmod_pitchMIDUScoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_pitchMIDUScoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_pitchMIDUScoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devDSMAXcoeff_TorqueAxis1UP
    saveas(gca,['WBmod_devDSMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devDSMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devDSMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devDSMINcoeff_TorqueAxis1UP
    saveas(gca,['WBmod_devDSMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devDSMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devDSMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devUSMAXcoeff_TorqueAxis1UP
    saveas(gca,['WBmod_devUSMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devUSMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devUSMAXcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmod_devUSMINcoeff_TorqueAxis1UP
    saveas(gca,['WBmod_devUSMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devUSMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devUSMINcoeff_TorqueAxis1UP_',num2str(n_TorqueAxis1UP),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    cd ..
    end
end

%% Torque around rotation axis2 DOWN
if calc_WB_TorqueAxis2_DOWN == 1

%     calc_accelbased_wbNORM_wingatt_rotAxisR
    calc_Torquebased_wbNORM_wingatt_TorqueAxis2_DOWN
...
saveas(gca,['hist_TorqueAxis2DOWN',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
plot2svg(['hist_TorqueAxis2DOWN',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_heatmap_TorqueAxis2DOWN
    saveas(gca,['WBmod_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmodNsteady_TorqueAxis2DOWN
    saveas(gca,['WBmodNsteady_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmodNsteady_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmodNsteady_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmod_strokeMAXcoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_strokeMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_strokeMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_strokeMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_strokeMINcoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_strokeMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_strokeMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_strokeMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_pitchMIDDScoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_pitchMIDDScoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_pitchMIDDScoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_pitchMIDDScoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_pitchMIDUScoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_pitchMIDUScoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_pitchMIDUScoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_pitchMIDUScoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devDSMAXcoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_devDSMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devDSMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devDSMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devDSMINcoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_devDSMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devDSMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devDSMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devUSMAXcoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_devUSMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devUSMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devUSMAXcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmod_devUSMINcoeff_TorqueAxis2DOWN
    saveas(gca,['WBmod_devUSMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devUSMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devUSMINcoeff_TorqueAxis2DOWN_',num2str(n_TorqueAxis2DOWN),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
