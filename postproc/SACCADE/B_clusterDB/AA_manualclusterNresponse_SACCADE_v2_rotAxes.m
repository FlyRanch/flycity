...
rot_axis_angle = 25.5; % [deg] !!! average torque axis angle during SACCADE, hi Inertia inc added mass sphere, -.025<tpre<-.005, .03<tpost<-.06
...
savename = ([loadname(1:end-4),'_9clusters_',num2str(At_hor_thresh),'n',num2str(At_hor_thresh_min),'n',num2str(An_hor_thresh),'_strokeplane',num2str(-strokeplane_angle),'deg_startframe',num2str(start_frame),'.mat']);
