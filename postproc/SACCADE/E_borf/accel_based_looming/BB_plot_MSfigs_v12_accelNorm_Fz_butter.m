...
%% butter all, then mean
for i = 1:size(Fz_all,3)
    AA = Fz_all(:,:,i);
    AA=AA(:);
    AA(AA==0)=[];
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Fz_mean_all(i,1) = nanmean(AA_butter);
...
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     Fz_mean_allNOfreq(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Fz_mean_freq(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Fz_mean_stroke(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Fz_mean_pitch(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Fz_mean_dev(i,1) = nanmean(AA_butter);    
end
...
%% butter all, then mean
for i = 1:size(Mx_allNOfreq,3)
%     AA = Mx_all(:,:,i);
%     AA=AA(:);
%     AA(AA==0)=[];
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     Mx_mean_all(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mx_mean_allNOfreq(i,1) = nanmean(AA_butter);
...
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     Mx_mean_freq(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mx_mean_stroke(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mx_mean_pitch(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mx_mean_dev(i,1) = nanmean(AA_butter);    
end
...
%% butter all, then mean
for i = 1:size(Mz_allNOfreq,3)
%     AA = Mz_all(:,:,i);
%     AA=AA(:);
%     AA(AA==0)=[];
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     Mz_mean_all(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mz_mean_allNOfreq(i,1) = nanmean(AA_butter);
...
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     Mz_mean_freq(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mz_mean_stroke(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mz_mean_pitch(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    Mz_mean_dev(i,1) = nanmean(AA_butter);    
end
...
%% butter all, then mean
for i = 1:size(My_allNOfreq,3)
%     AA = My_all(:,:,i);
%     AA=AA(:);
%     AA(AA==0)=[];
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     My_mean_all(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    My_mean_allNOfreq(i,1) = nanmean(AA_butter);
...
%     AA(isnan(AA))=[];
%     AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
%     My_mean_freq(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    My_mean_stroke(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    My_mean_pitch(i,1) = nanmean(AA_butter);
    ...
    AA(isnan(AA))=[];
    AA_butter = filter_borf_butter_nWB(AA,butter_cut,butter_n,n_wb);
    My_mean_dev(i,1) = nanmean(AA_butter);    
end
