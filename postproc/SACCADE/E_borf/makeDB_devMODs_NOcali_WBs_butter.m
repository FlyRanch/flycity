...
%         Mz_now = Mz_robo - Mz_cali_L_array - Mz_cali_R_array;
        ...
        Fx_dev(1:length(t_now),:,n) = Fx_fly;
        Fy_dev(1:length(t_now),:,n) = Fy_fly;
        Fz_dev(1:length(t_now),:,n) = Fz_fly;

        Mx_dev(1:length(t_now),:,n) = Mx_fly;
        My_dev(1:length(t_now),:,n) = My_fly;
        Mz_dev(1:length(t_now),:,n) = Mz_fly;
    end
end
