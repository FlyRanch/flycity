...
figure
hold on
plot(mod_value_allNOfreq,Mz_mean_allNOfreq-Mz_steady,'-k.')
% plot(mod_value_freq,Mz_mean_freq-Mz_steady,'-r.')
plot(mod_value_stroke,Mz_mean_stroke-Mz_steady,'-g.')
plot(mod_value_pitch,Mz_mean_pitch-Mz_steady,'-b.')
plot(mod_value_dev,Mz_mean_dev-Mz_steady,'-c.')
plot(mod_value_allNOfreq(1:MODmin),Mz_mean_sum-Mz_mean_sum_steady,'-ok')
