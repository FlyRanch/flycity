...
%         ft(:,6) = filter_borf_raw(ft(:,6),butter_cut,butter_n,Nwb_total);
        ...
        t_freq(1:seq_length_max,n) = nan;
        
        stroke_L_freq(1:seq_length_max,n) = nan;
        pitch_L_freq(1:seq_length_max,n) = nan;
        dev_L_freq(1:seq_length_max,n) = nan;
        
        stroke_R_freq(1:seq_length_max,n) = nan;
        pitch_R_freq(1:seq_length_max,n) = nan;
        dev_R_freq(1:seq_length_max,n) = nan;
        
        Fx_freq(1:seq_length_max,1:Nwb,n) = nan;
        Fy_freq(1:seq_length_max,1:Nwb,n) = nan;
        Fz_freq(1:seq_length_max,1:Nwb,n) = nan;
        Mx_freq(1:seq_length_max,1:Nwb,n) = nan;
        My_freq(1:seq_length_max,1:Nwb,n) = nan;
        Mz_freq(1:seq_length_max,1:Nwb,n) = nan;
