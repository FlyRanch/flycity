...
for i=1:length(list)
    ...
    cali_R.Fy_list(i,1)=mean(ft(start:end,3));
    cali_R.Fy_list(i,2)=std(ft(start:end,3));
    
    cali_R.Fz_list(i,1)=mean(-ft(start:end,2));
    cali_R.Fz_list(i,2)=std(-ft(start:end,2));
    
    cali_R.Mx_list(i,1)=mean(ft(start:end,4));
    cali_R.Mx_list(i,2)=std(ft(start:end,4));
    
    cali_R.My_list(i,1)=mean(ft(start:end,6));
    cali_R.My_list(i,2)=std(ft(start:end,6));
    
    cali_R.Mz_list(i,1)=mean(-ft(start:end,5));
    cali_R.Mz_list(i,2)=std(-ft(start:end,5));
end    
