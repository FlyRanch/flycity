...
% save('heading_FhorDir_response_time_data.mat','stim_angle_accel_mirror','t','t_shift','t_start','t_stop')
clear
clc
close all
...
t_resp_sub_gaus6std_all = nan(250,size(y_all,2));
y_resp_sub_gaus6std_all = nan(250,size(y_all,2));
dy_resp_sub_gaus6std_all = nan(250,size(y_all,2));

t_resp_norm_sub_gaus6std_all = nan(250,size(y_all,2));
dy_resp_norm_sub_gaus6std_all = nan(250,size(y_all,2));
...
saveas(gca, ['Fh_turn_',num2str(i),'.png'])
...
saveas(gca, ['Fh_turn_all_norm.png'])
...
save('Fhor_dir_response_time_results.mat')