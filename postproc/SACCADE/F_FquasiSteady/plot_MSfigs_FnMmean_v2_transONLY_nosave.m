...
% plot(Fenhance_norm*mod_value_Fenhance(subset)+1,Ftot_trans_norm_Fenhance_dev_mean(subset),'-c','linewidth',1)
% plot(Fenhance_norm*mod_value_Fenhance(subset)+1,Ftot_trans_norm_Fenhance_rot_mean(subset),'-m','linewidth',1)
...
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_trans_norm_RollAccel_dev_mean(subset)-Mx_trans_norm_RollAccel_dev_mean(mod_value_RollAccel==0)),'-c','linewidth',1)
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_trans_norm_RollAccel_rot_mean(subset)-Mx_trans_norm_RollAccel_rot_mean(mod_value_RollAccel==0)),'-m','linewidth',1)
...
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_trans_norm_YawAccel_dev_mean(subset)-Mz_trans_norm_YawAccel_dev_mean(mod_value_YawAccel==0)),'-c','linewidth',1)
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_trans_norm_YawAccel_rot_mean(subset)-Mz_trans_norm_YawAccel_rot_mean(mod_value_YawAccel==0)),'-m','linewidth',1)
...
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_trans_norm_PitchAccel_dev_mean(subset)-My_trans_norm_PitchAccel_dev_mean(mod_value_PitchAccel==0)),'-c','linewidth',1)
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_trans_norm_PitchAccel_rot_mean(subset)-My_trans_norm_PitchAccel_rot_mean(mod_value_PitchAccel==0)),'-m','linewidth',1)
