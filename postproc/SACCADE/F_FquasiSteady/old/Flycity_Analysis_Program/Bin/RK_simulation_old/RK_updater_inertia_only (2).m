function [ state_new ] = RK_updater_inertia_only( state, wing_kin, body_model, wing_model, wingbeat )
    ...
    F_I_vel = FMI_b.F_I_vel;
    M_I_vel = FMI_b.M_I_vel;
    ...
    state_new.ab         = kine.ab;
    state_new.w_dot_b    = kine.w_dot_b;
    state_new.FI_vel     = F_I_vel;
    state_new.MI_vel     = M_I_vel;
