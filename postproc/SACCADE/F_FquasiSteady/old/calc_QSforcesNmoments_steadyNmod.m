[FM_trans,FM_trans_norm,FM_transNrot,FM_trans_normNrot,...
    ...
    calc_QSforcesNmoments_steadyNmod(const,wing_model,body_model,freq,...
...
[stroke_L_steady,stroke_R_steady,stroke_dot_L_steady,stroke_dot_R_steady,stroke_dot_dot_L_steady,stroke_dot_dot_R_steady,...
    ...
    calc_WBkin_fouriercoeffs(nr_timepoints,freq,stroke_coeffs_steady,dev_coeffs_steady,rot_coeffs_steady);
