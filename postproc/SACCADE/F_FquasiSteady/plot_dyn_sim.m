...
%         n = n+1;
        ...
        plot(T,FI_vel_strk(1,:),'r')
        plot(T,FA_strk(1,:)-F_0_strk(1),'b')
        plot(T,Fg_strk(1,:),'g')
        plot(T,FI_acc_strk(1,:),'k')
        plot(T,ones(N,1)*(FA_strk_mean(1)-F_0_strk(1)),':','Color','b')
        plot(T,ones(N,1)*FI_acc_strk_mean(1),':','Color','k')
        hold off
        xlabel('t [s]')
        ylabel('F_x')
        subplot(3,1,2); hold on
        plot(T,FI_vel_strk(2,:),'r')
        plot(T,FA_strk(2,:)-F_0_strk(2),'b')
        plot(T,Fg_strk(2,:),'g')
        plot(T,FI_acc_strk(2,:),'k')
        plot(T,ones(N,1)*(FA_strk_mean(2)*F_0_strk(2)),':','Color','b')
        plot(T,ones(N,2)*FI_acc_strk_mean(2),':','Color','k')
        hold off
        xlabel('t [s]')
        ylabel('F_y')
        subplot(3,1,3); hold on
        plot(T,FI_vel_strk(3,:),'r')
        plot(T,FA_strk(3,:)-F_0_strk(3),'b')
        plot(T,Fg_strk(3,:),'g')
        plot(T,FI_acc_strk(3,:),'k')
        plot(T,ones(N,1)*(FA_strk_mean(3)-F_0_strk(3)),':','Color','b')
        plot(T,ones(N,3)*FI_acc_strk_mean(3),':','Color','k')
        hold off
        xlabel('t [s]')
        ylabel('F_z')
        legend('FI vel','FA','Fg','FI acc','mean FA','mean FI acc')
        ...
        hold on
        subplot(3,1,1); hold on
        plot(T,MI_vel_strk(1,:),'r')
        plot(T,MA_strk(1,:)-M_0_strk(1),'b')
        plot(T,MI_acc_strk(1,:),'k')
        plot(T,ones(N,1)*(MI_acc_strk_mean(1)-M_0_strk(1)),':','Color','k')
        hold off
        xlabel('t [s]')
        ylabel('M_x')
        subplot(3,1,2); hold on
        plot(T,MI_vel_strk(2,:),'r')
        plot(T,MA_strk(2,:)-M_0_strk(2),'b')
        plot(T,MI_acc_strk(2,:),'k')
        plot(T,ones(N,2)*(MI_acc_strk_mean(2)-M_0_strk(2)),':','Color','k')
        hold off
        xlabel('t [s]')
        ylabel('M_y')
        subplot(3,1,3); hold on
        plot(T,MI_vel_strk(3,:),'r')
        plot(T,MA_strk(3,:)-M_0_strk(3),'b')
        plot(T,MI_acc_strk(3,:),'k')
        plot(T,ones(N,3)*(MI_acc_strk_mean(3)-M_0_strk(3)),':','Color','k')
        hold off
        xlabel('t [s]')
        ylabel('M_z')
        legend('MI vel','MA','MI acc','mean MI acc')
