function [ kine ] = angular_velocities_polynomial3_fourier(wing_kin, R_strk )


    % Compute the wing kinematics:
    f               = wing_kin.freq;
    nr_points       = length(wing_kin.dev_L);
    dt              = (1/f)/(nr_points-1);  
    t               = 0:dt:nr_points*dt;

    theta_L         = wing_kin.dev_L;
    eta_L           = -wing_kin.rot_L;
    phi_L           = -wing_kin.stroke_L;
    
    theta_R         = -wing_kin.dev_R;
    eta_R           = -wing_kin.rot_R;
    phi_R           = wing_kin.stroke_R;

    theta_dot_L         = wing_kin.dev_dot_L;
    eta_dot_L           = -wing_kin.rot_dot_L;
    phi_dot_L           = -wing_kin.stroke_dot_L;
    
    theta_dot_R         = -wing_kin.dev_dot_R;
    eta_dot_R           = -wing_kin.rot_dot_R;
    phi_dot_R           = wing_kin.stroke_dot_R;

    theta_ddot_L         = wing_kin.dev_dot_dot_L;
    eta_ddot_L           = -wing_kin.rot_dot_dot_L;
    phi_ddot_L           = -wing_kin.stroke_dot_dot_L;
    
    theta_ddot_R         = -wing_kin.dev_dot_dot_R;
    eta_ddot_R           = -wing_kin.rot_dot_dot_R;
    phi_ddot_R           = wing_kin.stroke_dot_dot_R;
