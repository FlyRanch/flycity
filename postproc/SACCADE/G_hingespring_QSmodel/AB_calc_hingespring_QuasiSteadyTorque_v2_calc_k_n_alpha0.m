...
for i = 1:length(YawMods)
    ...
    Mwing_total_fwd_atRotds(i,1) = Mwing_total_fwd_all(n_rot_ds_L,i);
    Mwing_total_fwd_atRotus(i,1) = Mwing_total_fwd_all(n_rot_us_L,i);
    
    Mwing_total_rwd_atRotds(i,1) = Mwing_total_rwd_all(n_rot_ds_R,i);
    Mwing_total_rwd_atRotus(i,1) = Mwing_total_rwd_all(n_rot_us_R,i);
    ...
    dMwing_total_fwd = Mwing_total_fwd_atRotds - Mwing_total_fwd_atRotus;
    dMwing_total_rwd = Mwing_total_rwd_atRotds - Mwing_total_rwd_atRotus;
    ...
    % spring constants
    k_fwd_norm_deg = -dMwing_total_fwd ./ Arot_fwd_deg;
    k_rwd_norm_deg = -dMwing_total_rwd ./ Arot_rwd_deg;
    
    k_fwd_norm_rad = -dMwing_total_fwd ./ Arot_fwd_rad;
    k_rwd_norm_rad = -dMwing_total_rwd ./ Arot_rwd_rad;
    
    % spring setpoint
    rot0_fwd_norm_deg = rot_ds_fwd_all_deg + Mwing_total_fwd_atRotds./k_fwd_norm_deg;
    rot0_rwd_norm_deg = rot_ds_rwd_all_deg + Mwing_total_rwd_atRotds./k_rwd_norm_deg;

    rot0_fwd_norm_rad = rot_ds_fwd_all + Mwing_total_fwd_atRotds./k_fwd_norm_rad;
    rot0_rwd_norm_rad = rot_ds_rwd_all + Mwing_total_rwd_atRotds./k_rwd_norm_rad;
    
    %% save data & plots
    save(['hingespring_k_alpha0_Arot_dTspanwise_peakloc',num2str(loc_set),'_steps',num2str(nr_timepoints),'.mat'])
    
    mkdir('qsModel_FnM_k_n_Arot_VS_dTspanwise')
    cd('qsModel_FnM_k_n_Arot_VS_dTspanwise')
...
figure
hold on
plot(t_norm,Mwing_total_fwd_all(:,1),'-k','linewidth',2)
plot(t_norm,Mwing_total_fwd_all(:,end),'-r','linewidth',2)
plot(t_norm,Mwing_total_rwd_all(:,end),'-b','linewidth',2)

plot(t_norm(n_rot_ds_fwd_all(1)),Mwing_total_fwd_all(n_rot_ds_fwd_all(1),1),'ok','linewidth',2)
plot(t_norm(n_rot_us_fwd_all(1)),Mwing_total_fwd_all(n_rot_us_fwd_all(1),1),'ok','linewidth',2)

plot(t_norm(n_rot_ds_fwd_all(end)),Mwing_total_fwd_all(n_rot_ds_fwd_all(end),end),'or','linewidth',2)
plot(t_norm(n_rot_us_fwd_all(end)),Mwing_total_fwd_all(n_rot_us_fwd_all(end),end),'or','linewidth',2)

plot(t_norm(n_rot_ds_rwd_all(end)),Mwing_total_rwd_all(n_rot_ds_rwd_all(end),end),'ob','linewidth',2)
plot(t_norm(n_rot_us_rwd_all(end)),Mwing_total_rwd_all(n_rot_us_rwd_all(end),end),'ob','linewidth',2)
...
hold on
    ...
    for i = 1:length(YawTorques_all)
        ...
        plot(rot_ds_fwd_all_deg(i),Mwing_total_fwd_atRotds(i),'dk-','markerfacecolor',cmap_Tyaw(color_nr,:),'markersize',10)
        plot(rot_ds_rwd_all_deg(i),Mwing_total_rwd_atRotds(i),'o-','markerfacecolor',cmap_Tyaw(color_nr,:),'markersize',10,'color',[.5 .5 .5])
    end

    linfit_rotMtotal_ds_fwd_norm_deg = polyfit(rot_ds_fwd_all_deg,Mwing_total_fwd_atRotds,1);
    linfit_rotMtotal_ds_rwd_norm_deg = polyfit(rot_ds_rwd_all_deg,Mwing_total_rwd_atRotds,1);
    ...
    legend('fwd@ds','rwd@ds','location','northwest')
    axis tight
%     axis square
...
hold on
    ...
    for i = 1:length(YawTorques_all)
        ...
        plot(rot_us_fwd_all_deg(i),Mwing_total_fwd_atRotus(i),'dk-','markerfacecolor',cmap_Tyaw(color_nr,:),'markersize',10)
        plot(rot_us_rwd_all_deg(i),Mwing_total_rwd_atRotus(i),'o-','markerfacecolor',cmap_Tyaw(color_nr,:),'markersize',10,'color',[.5 .5 .5])
    end

    linfit_rotMtotal_us_fwd_norm_deg = polyfit(rot_us_fwd_all_deg,Mwing_total_fwd_atRotus,1);
    linfit_rotMtotal_us_rwd_norm_deg = polyfit(rot_us_rwd_all_deg,Mwing_total_rwd_atRotus,1);
...
hold on
    ...
    for i = 1:length(YawTorques_all)
        ...
        plot(Arot_fwd_deg(i),dMwing_total_fwd(i),'dk-','markerfacecolor',cmap_Tyaw(color_nr,:),'markersize',10)
        plot(Arot_rwd_deg(i),dMwing_total_rwd(i),'o-','markerfacecolor',cmap_Tyaw(color_nr,:),'markersize',10,'color',[.5 .5 .5])
    end

%     plot(Arot_fwd_deg,dMwing_total_fwd_deg,'-k')
%     plot(Arot_rwd_deg,dMwing_total_rwd_deg,'-','color',[.5 .5 .5])

    linfit_ArotdMtotal_fwd_norm_deg = polyfit(Arot_fwd_deg,dMwing_total_fwd,1);
    linfit_ArotdMtotal_rwd_norm_deg = polyfit(Arot_rwd_deg,dMwing_total_rwd,1);

    plot([min(Arot_fwd_deg) max(Arot_fwd_deg)],polyval(linfit_ArotdMtotal_fwd_norm_deg,[min(Arot_fwd_deg) max(Arot_fwd_deg)]),'-k','linewidth',2)
    plot([min(Arot_rwd_deg) max(Arot_rwd_deg)],polyval(linfit_ArotdMtotal_rwd_norm_deg,[min(Arot_rwd_deg) max(Arot_rwd_deg)]),'-k','linewidth',2,'color',[.5 .5 .5])

    legend('fwd','rwd','location','northwest')
    axis tight
    axis square
...
%% sep torques of Arot vs dTspanwise
% figure
% subplot(2,2,1)
% hold on
% subplot(2,2,2)
