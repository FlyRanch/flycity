function [ FM_strkpln, kine ] = quasi_steady_FnMnWingkin_atTimeNspanSections_fourier( settings, body_model, wing_model, wing_kin, rot_on )

    % Load a_glob and maneuvering wing kinematic functions:
        
    R_strk          = settings.Rstr;
    
    nr_of_points    = length(wing_kin.stroke_L);
    ...
    [ wingkin ] = angular_velocities_polynomial3_fourier(wing_kin, R_strk);
