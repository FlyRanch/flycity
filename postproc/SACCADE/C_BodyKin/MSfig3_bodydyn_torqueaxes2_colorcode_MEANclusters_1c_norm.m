...
for j=1:length(color_var)
    ...
    if isnan(color_var(i)) == 0 && color_var(i)~=0
        subplot(3,3,1)
        plot(t-t_shift(i),M_axis2_accel_norm(:,i),'-','color',grey_color,'linewidth',.25)
        subplot(3,3,4)
        plot(t-t_shift(i),M_axis2normal_accel_norm(:,i),'-','color',grey_color,'linewidth',.25)
        subplot(3,3,7)
        plot(t-t_shift(i),Maccel_axis_plot(:,i),'-','color',grey_color,'linewidth',.25)
        
        subplot(3,3,2)
        plot(t-t_shift(i),M_axis2_damp_norm(:,i),'-','color',grey_color,'linewidth',.25)
        subplot(3,3,5)
        plot(t-t_shift(i),M_axis2normal_damp_norm(:,i),'-','color',grey_color,'linewidth',.25)
        subplot(3,3,8)
        plot(t-t_shift(i),Mdamp_axis_plot(:,i),'-','color',grey_color,'linewidth',.25)
        
        subplot(3,3,3)
        plot(t-t_shift(i),M_axis2_norm(:,i),'-','color',grey_color,'linewidth',.25)
        subplot(3,3,6)
        plot(t-t_shift(i),M_axis2normal_norm(:,i),'-','color',grey_color,'linewidth',.25)
        subplot(3,3,9)
...
plot_meanclusters_bodydyn_torque_1c_rot2AxesAngle_norm
