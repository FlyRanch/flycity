...
%% Max Torque
subplot(3,3,1)
angle_post = M_axis2_norm_max_startstop;
% angle_post = M_axis2_norm_max;
% angle_post = max(M_axis2_norm)';
plot_angle_pre_post_mean_extendedsection_meanlim 
% xlabel('initial heading','fontsize',10) 
% axis equal
ylabel('Taxis2/Mgl','fontsize',10) 
...
subplot(3,3,4)
angle_post = M_axis2normal_norm_max_startstop;
% angle_post = M_axis2normal_norm_max;
% angle_post = max(M_axis2normal_norm)';
plot_angle_pre_post_mean_extendedsection_meanlim 
% xlabel('initial heading','fontsize',10) 
% axis equal
ylabel('Taxis2normal/Mgl','fontsize',10) 
set(gca,'ylim',[0 .045])
set(gca,'YTick',[-.045:.015:.09],'fontsize',8) 
set(gca,'xlim',[angle_pre_min angle_pre_max])
set(gca,'XTick',[-180:45:180],'fontsize',8) 
...
%% Min Torque
% subplot(3,3,2)
% angle_post = M_axis2_norm_min_0stop;
% % angle_post = M_axis2_norm_min;
% % angle_post = min(M_axis2_norm)';
% plot_angle_pre_post_mean_extendedsection_meanlim 
% % xlabel('initial heading','fontsize',10) 
% % axis equal
% % ylabel('Taxis2/Mgl','fontsize',10) 
...
% 
% subplot(3,3,5)
% angle_post = M_axis2normal_norm_min_0stop;
% % angle_post = M_axis2normal_norm_min;
% % angle_post = min(M_axis2normal_norm)';
% plot_angle_pre_post_mean_extendedsection_meanlim 
% % xlabel('initial heading','fontsize',10) 
% % axis equal
% % ylabel('Taxis2normal/Mgl','fontsize',10) 
...
%% mean Torque
subplot(3,3,2)
angle_post = M_axis2_norm_mean_startstop;
% angle_post = M_axis2_norm_mean_0stop;
% angle_post = M_axis2_norm_mean;
% angle_post = min(M_axis2_norm)';
plot_angle_pre_post_mean_extendedsection_meanlim 
% xlabel('initial heading','fontsize',10) 
% axis equal
...
subplot(3,3,5)
angle_post = M_axis2normal_norm_mean_startstop;
% angle_post = M_axis2normal_norm_mean_0stop;
% angle_post = M_axis2normal_norm_mean;
% angle_post = min(M_axis2normal_norm)';
plot_angle_pre_post_mean_extendedsection_meanlim 
% xlabel('initial heading','fontsize',10) 
% axis equal
