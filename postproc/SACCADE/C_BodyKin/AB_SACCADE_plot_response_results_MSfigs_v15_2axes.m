...
save('stats_saccadic_torque.mat','turn_angle_vel_mirror',...
    ...
    'M_axis1_norm_max_startstop','M_axis1normal_norm_max_startstop','Myaw_norm_max_startstop',...
    'M_axis1_norm_min_0stop','M_axis1normal_norm_min_0stop',...
    'M_axis1_norm_mean_startstop','M_axis1normal_norm_mean_startstop',...
    'M_axis2_norm_max_startstop','M_axis2normal_norm_max_startstop',...
    'M_axis2_norm_min_0stop','M_axis2normal_norm_min_0stop',...
    'M_axis2_norm_mean_startstop','M_axis2normal_norm_mean_startstop',...
    'stats_M_R_norm_max_startstop','stats_M_L_norm_max_startstop',...
    ...
    'stats_M_axis1_norm_max_startstop','stats_M_axis1normal_norm_max_startstop','stats_Myaw_norm_max_startstop',...
    'stats_M_axis1_norm_min_0stop','stats_M_axis1normal_norm_min_0stop',...
    'stats_M_axis1_norm_mean_startstop','stats_M_axis1normal_norm_mean_startstop',...
    'stats_M_axis2_norm_max_startstop','stats_M_axis2normal_norm_max_startstop',...
    'stats_M_axis2_norm_min_0stop','stats_M_axis2normal_norm_min_0stop',...
    'stats_M_axis2_norm_mean_startstop','stats_M_axis2normal_norm_mean_startstop');
