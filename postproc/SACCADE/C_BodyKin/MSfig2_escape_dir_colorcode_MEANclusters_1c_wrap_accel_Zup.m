...
% plot_meanclusters_bodydyn_2cN1c_quartiles_FdirWrap_Accel
plot_meanclusters_bodydyn_1c_quartiles_FdirWrap_Accel
...
subplot(3,3,2)
axis([t_start t_stop 0.5 1.5])
%     set(gca,'XTick',-0.06:0.03:.06) 
    set(gca,'XTick',-0.06:0.03:.06,'XTickLabel',[]) 
    set(gca,'YTick',[0:.5:2],'fontsize',8)
%     xlabel('time','fontsize',10)
...
%     set(gca,'XTick',-0.06:0.03:.06) 
    set(gca,'XTick',-0.06:0.03:.06,'XTickLabel',[]) 
    set(gca,'YTick',[-30:15:30],'fontsize',8)
%     xlabel('time','fontsize',10)
