...
angle_post_low(Y_low<-180)=-180;
% angle_post_low(Y_high>180)=-180;

% angle_post_high(Y_low<-180)=180;
angle_post_high(Y_high>180)=180;
...
% alpha(.25)
plot(angle_pre_mean,angle_post_mean,'-k.','linewidth',1,'color',plotcolor)
