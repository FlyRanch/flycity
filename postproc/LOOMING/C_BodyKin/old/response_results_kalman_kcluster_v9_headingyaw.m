...
%% SPHERE headingNyaw post vs pre TURN BASED MIRROR
figure
subplot(2,2,1)
plotcolor = 'r'
angle_pre = deg2rad(heading_pre);
angle_post = deg2rad(heading_post);


[mu ul ll] = circ_mean(angle_post(1:10), [],1)
...
%     [x_sphere(i,1) y_sphere(i,1) z_sphere(i,1)] = sph2cart(angle_pre(i),angle_post(i),1);
end
    [x_sphere y_sphere z_sphere] = sph2cart(angle_pre,angle_post,ones(size(angle_pre)));

plot3(x_sphere,y_sphere,z_sphere,'ok','MarkerFaceColor',plotcolor,'markersize',5)
axis equal
hold on
sphere

a1=fnval(pp,[-180:1:180])
[x_sphere y_sphere z_sphere] = sph2cart(deg2rad([-180:1:180]),deg2rad(a1),ones(size(a1)))
plot3(x_sphere,y_sphere,z_sphere)

%% headingNyaw post vs pre TURN BASED MIRROR CIRC MEAN
figure
subplot(2,2,1)
plotcolor = 'r'
angle_pre = heading_pre;
...
saveas(gca,'headingNyawpost_vs_headingNyawpre_circmean.fig')
saveas(gca,'headingNyawpost_vs_headingNyawpre_circmean.png')
plot2svg('headingNyawpost_vs_headingNyawpre_circmean.svg')

%% headingNyaw post vs pre TURN BASED MIRROR
figure
subplot(2,2,1)
plotcolor = 'r'
angle_pre = heading_pre;
...
% plot_angle_pre_post_csaps
plot_angle_pre_post_csaps_wrap_AnMIRROR
...
%% headingNyaw post vs pre TURN BASED MIRROR leftNright
figure
subplot(2,2,1)
...
%% headingNyaw post vs pre MIRROR
figure
subplot(2,2,1)
plotcolor = 'r'
angle_pre = heading_pre;
...
% plot_angle_pre_post_csaps
plot_angle_pre_post_csaps_wrap_MIRROR
...
saveas(gca,'headingNyawpost_vs_headingNyawpre_MIRROR.fig')
saveas(gca,'headingNyawpost_vs_headingNyawpre_MIRROR.png')
plot2svg('headingNyawpost_vs_headingNyawpre_MIRROR.svg')

%% turns vs headingNyaw pre
figure
...
%% turns vs headingNyaw pre AnMIRROR
figure
...
%% turns vs headingNyaw pre AnMIRROR leftNright
figure
subplot(2,2,1)
plot(360,1,'ok','MarkerFaceColor','r','markersize',5)
hold on
