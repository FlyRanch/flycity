...
%% plot_flightpath_timeline
t_shift = zeros(size(t_Aresp));
plot_flightpath_timeline_tshift_smooveOFF
...
t_shift = t_Aresp;
plot_flightpath_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_headingUA_shiftAresp.fig')
saveas(gca,'flightpaths_headingUA_shiftAresp.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Amax;
plot_flightpath_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_headingUA_shiftAmax.fig')
saveas(gca,'flightpaths_headingUA_shiftAmax.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Atmax;
plot_flightpath_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_headingUA_shiftAtmax.fig')
saveas(gca,'flightpaths_headingUA_shiftAtmax.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Anmax;
plot_flightpath_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_headingUA_shiftAnmax.fig')
saveas(gca,'flightpaths_headingUA_shiftAnmax.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_alpha_dot_resp;
plot_flightpath_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_headingUA_shiftturnrateresp.fig')
saveas(gca,'flightpaths_headingUA_shiftturnrateresp.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_alpha_dot_max;
plot_flightpath_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_headingUA_shiftturnratemax.fig')
saveas(gca,'flightpaths_headingUA_shiftturnratemax.jpg')
% plot2svg(flightpaths_As,gca)

%% plot_accel_timeline
t_shift = zeros(size(t_Aresp));
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_NOshift.fig')
saveas(gca,'flightpaths_accel_NOshift.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Aresp;
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_shiftAresp.fig')
saveas(gca,'flightpaths_accel_shiftAresp.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Amax;
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_shiftAmax.fig')
saveas(gca,'flightpaths_accel_shiftAmax.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Atmax;
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_shiftAtmax.fig')
saveas(gca,'flightpaths_accel_shiftAtmax.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_Anmax;
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_shiftAnmax.fig')
saveas(gca,'flightpaths_accel_shiftAnmax.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_alpha_dot_resp;
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_shiftturnrateresp.fig')
saveas(gca,'flightpaths_accel_shiftturnrateresp.jpg')
% plot2svg(flightpaths_As,gca)

t_shift = t_alpha_dot_max;
plot_accel_timeline_tshift_smooveOFF
saveas(gca,'flightpaths_accel_shiftturnratemax.fig')
saveas(gca,'flightpaths_accel_shiftturnratemax.jpg')
% plot2svg(flightpaths_As,gca)
...
errorbar(1,nanmean(V2),nanstd(V2),'dg','linewidth',2,'MarkerSize',10)
errorbar(1.5,nanmean(V3),nanstd(V3),'dgb','linewidth',2,'MarkerSize',10)

subplot(2,2,3)
errorbar(.5,nanmean(A1),nanstd(A1),'dr','linewidth',2,'MarkerSize',10)
errorbar(1,nanmean(A2),nanstd(A2),'dg','linewidth',2,'MarkerSize',10)
errorbar(1.5,nanmean(A3),nanstd(A3),'db','linewidth',2,'MarkerSize',10)

subplot(2,2,4)
errorbar(.5,nanmean(T1),nanstd(T1),'dr','linewidth',2,'MarkerSize',10)
errorbar(1,nanmean(T2),nanstd(T2),'dg','linewidth',2,'MarkerSize',10)
errorbar(1.5,nanmean(T3),nanstd(T3),'db','linewidth',2,'MarkerSize',10)

subplot(2,2,1)
ylabel('escape heading')
set(gca,'XTick',[.5:.5:1.5])
set(gca,'XTickLabel',{'165deg','64deg','64deg OFF'})
