...
mkdir('response_figs_originalangle')
cd('response_figs_originalangle')
...
stim_angle_vel = pathDB.angle_vel;
stim_angle_accel = pathDB.angle_accel;
stim_angle_F = pathDB.angle_F;
stim_angle_yaw = pathDB.angle_yaw;
stim_angle_spn = pathDB.angle_spn;
