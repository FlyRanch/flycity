...
plot(Mpitch_PitchAccel,f_wb_PitchAccel,'.b')

% plot trend
RC = freqMOD_wb_PitchAccel_meanCIstd(1)/Mpitch_norm;
x0 = 0;
...
subplot(2,2,4)
plot(Mpitch_PitchAccel,freqMOD_wb_PitchAccel,'.b')
