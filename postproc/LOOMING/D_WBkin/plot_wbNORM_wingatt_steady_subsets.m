...
% subplot(3,1,1)
% plot_WBfitting_singlevar(stroke_steady_fit_ave,'r');
% 
% subplot(3,1,2)
% plot_WBfitting_singlevar(pitch_steady_fit_ave,'r');
% 
% subplot(3,1,3)
% plot_WBfitting_singlevar(dev_steady_fit_ave,'r');
% 
% subplot(3,1,1)
% plot_WBfitting_singlevar(stroke_steady_fit_binmean,'g');
% 
% subplot(3,1,2)
% plot_WBfitting_singlevar(pitch_steady_fit_binmean,'g');
% 
% subplot(3,1,3)
% plot_WBfitting_singlevar(dev_steady_fit_binmean,'g');
% 
