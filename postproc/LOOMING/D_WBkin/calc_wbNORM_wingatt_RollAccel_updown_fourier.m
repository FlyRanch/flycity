...
for wb = 1:size(wb_nr,1)
    counter = size(wb_nr,1) -wb
        ...
        if roll_dot_dot_mean_wb(wb) > rollaccel_limit_mod
            ...
            strokeMOD_wb_up_now = (stroke_wb_up_interp - stroke_wb_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            strokeMOD_wb_down_now = (stroke_wb_down_interp - stroke_wb_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            strokeMOD_ds_up_now = (stroke_ds_up_interp - stroke_ds_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            strokeMOD_ds_down_now = (stroke_ds_down_interp - stroke_ds_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            strokeMOD_us_up_now = (stroke_us_up_interp - stroke_us_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            strokeMOD_us_down_now = (stroke_us_down_interp - stroke_us_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            
            pitchMOD_wb_up_now = (pitch_wb_up_interp - pitch_wb_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            pitchMOD_wb_down_now = (pitch_wb_down_interp - pitch_wb_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            pitchMOD_ds_up_now = (pitch_ds_up_interp - pitch_ds_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            pitchMOD_ds_down_now = (pitch_ds_down_interp - pitch_ds_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            pitchMOD_us_up_now = (pitch_us_up_interp - pitch_us_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            pitchMOD_us_down_now = (pitch_us_down_interp - pitch_us_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            
            devMOD_wb_up_now = (dev_wb_up_interp - dev_wb_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            devMOD_wb_down_now = (dev_wb_down_interp - dev_wb_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            devMOD_ds_up_now = (dev_ds_up_interp - dev_ds_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            devMOD_ds_down_now = (dev_ds_down_interp - dev_ds_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            devMOD_us_up_now = (dev_us_up_interp - dev_us_steady) / rollaccel_mean_wb_now * rollaccel_norm;
            devMOD_us_down_now = (dev_us_down_interp - dev_us_steady) / rollaccel_mean_wb_now * rollaccel_norm;
...
%% fourier series
        % wingbeats
        [stroke_up_RollAccel_fourier_fit_binmean, stroke_up_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, stroke_loc,stroke_fourier_order,plotting);
        [pitch_up_RollAccel_fourier_fit_binmean, pitch_up_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitch_loc,pitch_fourier_order,plotting);
        [dev_up_RollAccel_fourier_fit_binmean, dev_up_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, dev_loc,dev_fourier_order,plotting);

        % wingbeatMODs
        [strokeMOD_up_RollAccel_fourier_fit_binmean, strokeMOD_up_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, strokeMOD_loc,MOD_fourier_order,plotting);
        [pitchMOD_up_RollAccel_fourier_fit_binmean, pitchMOD_up_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitchMOD_loc,MOD_fourier_order,plotting);
        [devMOD_up_RollAccel_fourier_fit_binmean, devMOD_up_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, devMOD_loc,MOD_fourier_order,plotting);
...
%% fourier series
        % wingbeats
        [stroke_down_RollAccel_fourier_fit_binmean, stroke_down_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, stroke_loc,stroke_fourier_order,plotting);
        [pitch_down_RollAccel_fourier_fit_binmean, pitch_down_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitch_loc,pitch_fourier_order,plotting);
        [dev_down_RollAccel_fourier_fit_binmean, dev_down_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, dev_loc,dev_fourier_order,plotting);

        % wingbeatMODs
        [strokeMOD_down_RollAccel_fourier_fit_binmean, strokeMOD_down_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, strokeMOD_loc,MOD_fourier_order,plotting);
        [pitchMOD_down_RollAccel_fourier_fit_binmean, pitchMOD_down_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitchMOD_loc,MOD_fourier_order,plotting);
        [devMOD_down_RollAccel_fourier_fit_binmean, devMOD_down_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, devMOD_loc,MOD_fourier_order,plotting);
...
%% fourier series
        % wingbeats
        [Dstroke_RollAccel_fourier_fit_binmean, Dstroke_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, stroke_loc,stroke_fourier_order,plotting);
        [Dpitch_RollAccel_fourier_fit_binmean, Dpitch_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitch_loc,pitch_fourier_order,plotting);
        [Ddev_RollAccel_fourier_fit_binmean, Ddev_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, dev_loc,dev_fourier_order,plotting);

        % wingbeatMODs
        [DstrokeMOD_RollAccel_fourier_fit_binmean, DstrokeMOD_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, strokeMOD_loc,MOD_fourier_order,plotting);
        [DpitchMOD_RollAccel_fourier_fit_binmean, DpitchMOD_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitchMOD_loc,MOD_fourier_order,plotting);
        [DdevMOD_RollAccel_fourier_fit_binmean, DdevMOD_RollAccel_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, devMOD_loc,MOD_fourier_order,plotting);
...
'MOD_fourier_order',...
...
'stroke_up_RollAccel_fourier_fit_binmean',...
'pitch_up_RollAccel_fourier_fit_binmean',...
'dev_up_RollAccel_fourier_fit_binmean',...
...
'stroke_up_RollAccel_fourier_fit_binmean_gof',...
'pitch_up_RollAccel_fourier_fit_binmean_gof',...
'dev_up_RollAccel_fourier_fit_binmean_gof',...
...
'stroke_down_RollAccel_fourier_fit_binmean',...
'pitch_down_RollAccel_fourier_fit_binmean',...
'dev_down_RollAccel_fourier_fit_binmean',...
...
'stroke_down_RollAccel_fourier_fit_binmean_gof',...
'pitch_down_RollAccel_fourier_fit_binmean_gof',...
'dev_down_RollAccel_fourier_fit_binmean_gof',...
...
'Dstroke_RollAccel_fourier_fit_binmean',...
'Dpitch_RollAccel_fourier_fit_binmean',...
'Ddev_RollAccel_fourier_fit_binmean',...
...
'Dstroke_RollAccel_fourier_fit_binmean_gof',...
'Dpitch_RollAccel_fourier_fit_binmean_gof',...
'Ddev_RollAccel_fourier_fit_binmean_gof',...
...
