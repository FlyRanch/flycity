...
%             stroke_wb_L_now = stroke_wb_L_now-circ_mean(stroke_wb_L_now);
%             stroke_wb_R_now = stroke_wb_R_now-circ_mean(stroke_wb_R_now);
%             pitch_wb_L_now = pitch_wb_L_now-circ_mean(pitch_wb_L_now);
%             pitch_wb_R_now = pitch_wb_R_now-circ_mean(pitch_wb_R_now);
            dev_wb_L_now = dev_wb_L_now-circ_mean(dev_wb_L_now);
            dev_wb_R_now = dev_wb_R_now-circ_mean(dev_wb_R_now);
%             U_wb_L_now = U_wb_L_now-nanmean(U_wb_L_now);
%             U_wb_R_now = U_wb_R_now-nanmean(U_wb_R_now);
%             aoa_wb_L_now = aoa_wb_L_now-circ_mean(aoa_wb_L_now);
%             aoa_wb_R_now = aoa_wb_R_now-circ_mean(aoa_wb_R_now);
