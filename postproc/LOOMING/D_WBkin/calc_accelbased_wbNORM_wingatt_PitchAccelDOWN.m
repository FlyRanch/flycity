...
%         if abs(pitch_dot_dot_mean_wb(wb)) > pitchaccel_limit_mod
        if pitch_dot_dot_mean_wb(wb) < -pitchaccel_limit_mod
            ...
            Mroll_PitchAccel(n_now,1) = Mroll_mean_wb_now;
            Mpitch_PitchAccel(n_now,1) = Mpitch_mean_wb_now;
            Myaw_PitchAccel(n_now,1) = Myaw_mean_wb_now;
...
if save_on == 1
    ...
    save(['WBmod_accelbased_PitchAccelDOWN_',num2str(n_PitchAccel),'WBs.mat'],...
'n_PitchAccel',...
'seq_nr_PitchAccel',...
'wb_nr_PitchAccel',...
...
