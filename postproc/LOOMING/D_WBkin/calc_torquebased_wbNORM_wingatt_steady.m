...
Mroll_limit_steady = limit_steady*nanstd(Mroll_mean_wb(:));
Mpitch_limit_steady = limit_steady*nanstd(Mpitch_mean_wb(:));
Myaw_limit_steady = limit_steady*nanstd(Myaw_mean_wb(:));
...
for wb = 1:size(wb_nr,1)
    counter = size(wb_nr,1) -wb
        ...
        if abs(Mroll_mean_wb(wb)) < Mroll_limit_steady &&...
                abs(Mpitch_mean_wb(wb)) < Mpitch_limit_steady &&...
                abs(Myaw_mean_wb(wb)) < Myaw_limit_steady &&...
...
if save_on == 1
    save(['WBdataset_torquebased_steady_',num2str(n_steady),'WBs.mat'],...
'n_steady',...
'seq_nr_steady',...
'wb_nr_steady',...
...
...
'dev_fourier_order',...
...
'stroke_steady_fourier_gof_binmean',...
'pitch_steady_fourier_gof_binmean',...
'dev_steady_fourier_gof_binmean',...
...
'stroke_steady_fourier_coeffs_binmean',...
'pitch_steady_fourier_coeffs_binmean',...
'dev_steady_fourier_coeffs_binmean',...
...
'n_pol_stroke',...
'n_pol_pitch',...
'n_pol_dev',...
...
'stroke_steady_fit_binmean_periodic',...
'pitch_steady_fit_binmean_periodic',...
'dev_steady_fit_binmean_periodic',...
...
