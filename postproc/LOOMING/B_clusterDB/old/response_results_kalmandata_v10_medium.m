...
plot(0,0,'c')
plot(0,0,'m')
legend('stepwise slow 165deg','stepwise fast 165deg','continuous fast 165deg','continuous fast 64deg','continuous medium 64deg')
...
for i=1:size(u,2)
    ...
    elseif settings.expansion.stepwise(i) == 1 && settings.expansion.speed(i) == 1
        ...
        hold on
        plot(t,A(:,i),'g')
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 2 && settings.expansion.maxangle(i) == 165
        subplot(3,1,1)
        hold on
        ...
        hold on
        plot(t,A(:,i),'b')
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 2 && settings.expansion.maxangle(i) == 64
        subplot(3,1,1)
        hold on
...
for i=1:size(u,2)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        subplot(3,1,1)
        hold on
        plot(t-t_Aresp(i),stim_angle_plot(:,i),'m')
        subplot(3,1,2)
        hold on
        plot(t-t_Aresp(i),V(:,i),'m')
        subplot(3,1,3)
        hold on
        plot(t-t_Aresp(i),A(:,i),'m')
    end
end
...
for i=1:size(u,2)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        ...
        subplot(3,1,2)
        hold on
        plot(t-t_Aresp(i),An(:,i),'m')
        subplot(3,1,3)
        hold on
        plot(t-t_Aresp(i),At(:,i),'m')
    end
end
...
for i=1:size(u,2)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        subplot(2,2,1)
        hold on
        plot(settings.seq(i,2),V_post(i),'oy')
        subplot(2,2,2)
        hold on
        plot(settings.seq(i,2),t_Aresp(i),'oy')
        subplot(2,2,3)
        hold on
        plot(settings.seq(i,2),heading_post(i),'oy')
        subplot(2,2,4)
        hold on
        plot(settings.seq(i,2),A_max(i),'oy')
    end
end
...
for i=1:size(t_Anresp,2)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        plot(t_Atresp(i),t_Anresp(i),'.m','markersize',25)
    end
end
% grid on
axis equal
...
for i=1:size(heading_pre,1)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        plot(heading_pre(i),heading_turn(i),'.m','markersize',25)
    end
end
% grid on
axis equal
...
for i=1:size(heading_pre,1)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        plot(heading_pre(i),heading_post(i),'.m','markersize',25)
    end
end
...
for i=1:size(u,2)
    ...
    elseif settings.expansion.stepwise(i) == 0 && settings.expansion.speed(i) == 1 && settings.expansion.maxangle(i) == 64
        subplot(2,2,1)
        plot(2.5,heading_post(i),'ko','MarkerSize',5)
        subplot(2,2,2)
        plot(2.5,V_post(i),'ko','MarkerSize',5)
        subplot(2,2,3)
        plot(2.5,A_max(i),'ko','MarkerSize',5)
        subplot(2,2,4)
        plot(2.5,t_Aresp(i),'ko','MarkerSize',5)
...
errorbar(2.5,nanmean(H5),nanstd(H5),'dm','linewidth',2,'MarkerSize',10)
...
errorbar(2.5,nanmean(V5),nanstd(V5),'dm','linewidth',2,'MarkerSize',10)
...
errorbar(2.5,nanmean(A5),nanstd(A5),'dm','linewidth',2,'MarkerSize',10)
...
errorbar(2.5,nanmean(T5),nanstd(T5),'dm','linewidth',2,'MarkerSize',10)

subplot(2,2,1)
ylabel('escape heading')
set(gca,'XTick',[.5:.5:2])
set(gca,'XTickLabel',{'step slow 165deg','step fast 165deg','cont fast 165deg','cont fast 64deg','cont medium 64deg'})
