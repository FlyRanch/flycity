...
saveas(gca,['kmeanbased_manualclusters_skip',num2str(skip),'.fig'])
saveas(gca,['kmeanbased_manualclusters_skip',num2str(skip),'.png'])
plot2svg(['kmeanbased_manualclusters_skip',num2str(skip),'.svg'])
...
save(['flightpathDB_pos_qbodyEKF_9clusters_',num2str(At_hor_thresh),'n',num2str(An_hor_thresh),'.mat'],'pathDB','settings')
