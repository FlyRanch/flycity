...
%
figure
errorbar(-1,mean(ascend_post(settings.expansion.VerPos==-1)),std(ascend_post(settings.expansion.VerPos==-1)),'r')
hold on
errorbar(1,mean(ascend_post(settings.expansion.VerPos==1)),std(ascend_post(settings.expansion.VerPos==1)),'r')
errorbar(0,mean(ascend_post(settings.expansion.VerPos==0)),std(ascend_post(settings.expansion.VerPos==0)),'r')
grid on
plot(1,mean(ascend_post(settings.expansion.VerPos==1)),'xr')
plot(-1,mean(ascend_post(settings.expansion.VerPos==-1)),'xr')
plot(0,mean(ascend_post(settings.expansion.VerPos==0)),'xr')
plot(settings.expansion.VerPos,ascend_post,'o')
ylabel('ascend angle')
title('adcend angle versus vertical looming position')
set(gca,'xlim',[-1.5 1.5])
saveas(gca,'adcend angle versus vertical looming position.fig')
saveas(gca,'adcend angle versus vertical looming position.jpg')

% 
figure
hold on
errorbar(1,mean(V_post(settings.expansion.speed==1)),std(V_post(settings.expansion.speed==1)),'r')
errorbar(0,mean(V_post(settings.expansion.speed==0)),std(V_post(settings.expansion.speed==0)),'r')
grid on
plot(1,mean(V_post(settings.expansion.speed==1)),'xr')
plot(0,mean(V_post(settings.expansion.speed==0)),'xr')
plot(settings.expansion.speed,V_post,'o')
ylabel('speed post')
title('speed post versus looming speed')
set(gca,'xlim',[-.5 1.5])
saveas(gca,'speed post versus looming speed.fig')
saveas(gca,'speed post versus looming speed.jpg')
