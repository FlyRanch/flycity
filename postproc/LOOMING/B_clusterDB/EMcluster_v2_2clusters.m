...
% load('flightpathDB_pos_qbodyEKF_INCroll_9clusters_2.5n-3.3n3_strokeplane47.5deg_startframe1.mat')
...
% axis equal
set(gca,'xlim',[0 5e5],'ylim',[-6 6])
set(gca,'XTick',[0:5e5:5e5],'fontsize',12)
