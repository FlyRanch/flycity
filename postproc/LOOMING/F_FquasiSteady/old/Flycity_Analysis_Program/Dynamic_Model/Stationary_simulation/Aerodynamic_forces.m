            ...
            if i >= down_loc(1) && i <= down_loc(2)
                ...
                F_trans_R(:,:,i) = [(L_trans_R(:,i).*sind(alfa_right)-D_trans_R(:,i).*cosd(alfa_right)) ...
                    ...
                    for j = 1:nr_sect
                        ...
                        M_trans_L(j,:,i) = (cross([0; y_sect_L(j); 0],F_trans_L(j,:,i)'))';                     % [ N*mm ]
                        M_trans_R(j,:,i) = (cross([0; y_sect_R(j); 0],F_trans_R(j,:,i)'))';                     % [ N*mm ]
                ...
                if rot_lift_on == 1
                    ...
                    for j = 1:nr_sect
                        ...
                        M_rot_L(j,:,i) = (cross([0; y_sect_L(j); 0],F_rot_L(j,:,i)'))';                         % [ N*mm ]
                        M_rot_R(j,:,i) = (cross([0; y_sect_R(j); 0],F_rot_R(j,:,i)'))';                         % [ N*mm ]
