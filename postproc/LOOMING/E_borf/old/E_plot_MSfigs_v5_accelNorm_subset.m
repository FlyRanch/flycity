...
% plot(rollaccel_norm*mod_value_allNOfreq(subset_allNOfreq),(Mx_mean_sum(subset_allNOfreq)-Mx_steady)/f_wb_steady^2/Lwing^5,'--r','linewidth',1)
...
plot(rollaccel_norm*mod_value_allNOfreq(subset_allNOfreq),(Mx_mean_sum(subset_allNOfreq)-Mx_mean_sum(mod_value_allNOfreq==0))/f_wb_steady^2/Lwing^5,'--r','linewidth',1)
