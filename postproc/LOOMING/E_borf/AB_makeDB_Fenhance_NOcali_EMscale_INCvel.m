...
F_mean_vel = sqrt(Fx_mean_vel.^2+Fy_mean_vel.^2+Fz_mean_vel.^2);
...
MODmin = min([length(F_mean_freq) length(F_mean_vel) length(F_mean_stroke) length(F_mean_pitch) length(F_mean_dev)]);
F_steady = F_mean_all(mod_value_all == 0);
F_mean_sum = F_steady + (F_mean_freq(1:MODmin)-F_steady) + (F_mean_vel(1:MODmin)-F_steady) + (F_mean_stroke(1:MODmin)-F_steady) + (F_mean_pitch(1:MODmin)-F_steady) + (F_mean_dev(1:MODmin)-F_steady);
F_mean_sum_nopitch = F_steady + (F_mean_freq(1:MODmin)-F_steady) + (F_mean_vel(1:MODmin)-F_steady) + (F_mean_stroke(1:MODmin)-F_steady) + (F_mean_dev(1:MODmin)-F_steady);
...
save(['borf_db_',save_name,'_NOcali_INCvel_alldata.mat'])
...
clear Fx_all Fy_all Fz_all Mx_all My_all Mz_all...
    ...
    Fx_vel Fy_vel Fz_vel Mx_vel My_vel Mz_vel...
    ...
    stroke_L_vel stroke_R_vel pitch_L_vel pitch_R_vel dev_L_vel dev_R_vel...
    ...
    t_all t_allNOfreq t_stroke t_pitch t_dev t_freq t_vel...
    ...
    Fx_vel_right Fy_vel_right Fz_vel_right Mx_vel_right My_vel_right Mz_vel_right...
    ...
    stroke_L_vel_right stroke_R_vel_right pitch_L_vel_right pitch_R_vel_right dev_L_vel_right dev_R_vel_right...
    ...
    t_all_right t_allNOfreq_right t_stroke_right t_pitch_right t_dev_right t_freq_right t_vel_right...
    ...
    Fx_vel_left Fy_vel_left Fz_vel_left Mx_vel_left My_vel_left Mz_vel_left...
    ...
    stroke_L_vel_left stroke_R_vel_left pitch_L_vel_left pitch_R_vel_left dev_L_vel_left dev_R_vel_left...
    ...
    t_all_left t_allNOfreq_left t_stroke_left t_pitch_left t_dev_left t_freq_left t_vel_left

save(['borf_db_',save_name,'_NOcali_INCvel_means.mat'])
