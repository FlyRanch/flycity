...
figure
subplot(2,3,1)
plot(roll.t,Fx_allNOfreq_raw_sub,'b')
hold on
plot(roll.t,Fx_allNOfreq_butter_sub,'r')
    
subplot(2,3,2)
plot(roll.t,Fy_allNOfreq_raw_sub,'b')
hold on
plot(roll.t,Fy_allNOfreq_butter_sub,'r')
    
subplot(2,3,3)
plot(roll.t,Fz_allNOfreq_raw_sub,'b')
hold on
plot(roll.t,Fz_allNOfreq_butter_sub,'r')
    
subplot(2,3,4)
plot(roll.t,Mx_allNOfreq_raw_sub,'b')
hold on
plot(roll.t,Mx_allNOfreq_butter_sub,'r')
    
subplot(2,3,5)
plot(roll.t,My_allNOfreq_raw_sub,'b')
hold on
plot(roll.t,My_allNOfreq_butter_sub,'r')
    
subplot(2,3,6)
plot(roll.t,Mz_allNOfreq_raw_sub,'b')
hold on
plot(roll.t,Mz_allNOfreq_butter_sub,'r')

% figure
% subplot(2,3,1)
% plot(roll.t_INCfreq,Fx_freq_raw_sub,'b')
% hold on
% plot(roll.t_INCfreq,Fx_freq_butter_sub,'r')
%     
% subplot(2,3,2)
% plot(roll.t_INCfreq,Fy_freq_raw_sub,'b')
% hold on
% plot(roll.t_INCfreq,Fy_freq_butter_sub,'r')
%     
% subplot(2,3,3)
% plot(roll.t_INCfreq,Fz_freq_raw_sub,'b')
% hold on
% plot(roll.t_INCfreq,Fz_freq_butter_sub,'r')
%     
% subplot(2,3,4)
% plot(roll.t_INCfreq,Mx_freq_raw_sub,'b')
% hold on
% plot(roll.t_INCfreq,Mx_freq_butter_sub,'r')
%     
% subplot(2,3,5)
% plot(roll.t_INCfreq,My_freq_raw_sub,'b')
% hold on
% plot(roll.t_INCfreq,My_freq_butter_sub,'r')
%     
% subplot(2,3,6)
% plot(roll.t_INCfreq,Mz_freq_raw_sub,'b')
% hold on
% plot(roll.t_INCfreq,Mz_freq_butter_sub,'r')
% 
figure
subplot(2,3,1)
plot(roll.t,Fx_stroke_raw_sub,'b')
hold on
plot(roll.t,Fx_stroke_butter_sub,'r')
    
subplot(2,3,2)
plot(roll.t,Fy_stroke_raw_sub,'b')
hold on
plot(roll.t,Fy_stroke_butter_sub,'r')
    
subplot(2,3,3)
plot(roll.t,Fz_stroke_raw_sub,'b')
hold on
plot(roll.t,Fz_stroke_butter_sub,'r')
    
subplot(2,3,4)
plot(roll.t,Mx_stroke_raw_sub,'b')
hold on
plot(roll.t,Mx_stroke_butter_sub,'r')
    
subplot(2,3,5)
plot(roll.t,My_stroke_raw_sub,'b')
hold on
plot(roll.t,My_stroke_butter_sub,'r')
    
subplot(2,3,6)
plot(roll.t,Mz_stroke_raw_sub,'b')
hold on
plot(roll.t,Mz_stroke_butter_sub,'r')

figure
subplot(2,3,1)
plot(roll.t,Fx_dev_raw_sub,'b')
hold on
plot(roll.t,Fx_dev_butter_sub,'r')
    
subplot(2,3,2)
plot(roll.t,Fy_dev_raw_sub,'b')
hold on
plot(roll.t,Fy_dev_butter_sub,'r')
    
subplot(2,3,3)
plot(roll.t,Fz_dev_raw_sub,'b')
hold on
plot(roll.t,Fz_dev_butter_sub,'r')
    
subplot(2,3,4)
plot(roll.t,Mx_dev_raw_sub,'b')
hold on
plot(roll.t,Mx_dev_butter_sub,'r')
    
subplot(2,3,5)
plot(roll.t,My_dev_raw_sub,'b')
hold on
plot(roll.t,My_dev_butter_sub,'r')
    
subplot(2,3,6)
plot(roll.t,Mz_dev_raw_sub,'b')
hold on
plot(roll.t,Mz_dev_butter_sub,'r')

figure
subplot(2,3,1)
plot(roll.t,Fx_pitch_raw_sub,'b')
hold on
plot(roll.t,Fx_pitch_butter_sub,'r')
    
subplot(2,3,2)
plot(roll.t,Fy_pitch_raw_sub,'b')
hold on
plot(roll.t,Fy_pitch_butter_sub,'r')
    
subplot(2,3,3)
plot(roll.t,Fz_pitch_raw_sub,'b')
hold on
plot(roll.t,Fz_pitch_butter_sub,'r')
    
subplot(2,3,4)
plot(roll.t,Mx_pitch_raw_sub,'b')
hold on
plot(roll.t,Mx_pitch_butter_sub,'r')
    
subplot(2,3,5)
plot(roll.t,My_pitch_raw_sub,'b')
hold on
plot(roll.t,My_pitch_butter_sub,'r')
    
subplot(2,3,6)
plot(roll.t,Mz_pitch_raw_sub,'b')
hold on
plot(roll.t,Mz_pitch_butter_sub,'r')
    
%% add to DB
roll.Fx_norm_all = Fx_allNOfreq_raw_sub;
roll.Fy_norm_all = Fy_allNOfreq_raw_sub;
roll.Fz_norm_all = Fz_allNOfreq_raw_sub;

roll.Mx_norm_all = Mx_allNOfreq_raw_sub;
roll.My_norm_all = My_allNOfreq_raw_sub;
roll.Mz_norm_all = Mz_allNOfreq_raw_sub;

roll.Fx_norm_all_butterfilt = Fx_allNOfreq_butter_sub;
roll.Fy_norm_all_butterfilt = Fy_allNOfreq_butter_sub;
roll.Fz_norm_all_butterfilt = Fz_allNOfreq_butter_sub;

roll.Mx_norm_all_butterfilt = Mx_allNOfreq_butter_sub;
roll.My_norm_all_butterfilt = My_allNOfreq_butter_sub;
roll.Mz_norm_all_butterfilt = Mz_allNOfreq_butter_sub;

% roll.Fx_norm_freq = Fx_freq_raw_sub;
% roll.Fy_norm_freq = Fy_freq_raw_sub;
% roll.Fz_norm_freq = Fz_freq_raw_sub;
% 
% roll.Mx_norm_freq = Mx_freq_raw_sub;
% roll.My_norm_freq = My_freq_raw_sub;
% roll.Mz_norm_freq = Mz_freq_raw_sub;
% 
% roll.Fx_norm_freq_butterfilt = Fx_freq_butter_sub;
% roll.Fy_norm_freq_butterfilt = Fy_freq_butter_sub;
% roll.Fz_norm_freq_butterfilt = Fz_freq_butter_sub;
% 
% roll.Mx_norm_freq_butterfilt = Mx_freq_butter_sub;
% roll.My_norm_freq_butterfilt = My_freq_butter_sub;
% roll.Mz_norm_freq_butterfilt = Mz_freq_butter_sub;

roll.Fx_norm_stroke = Fx_stroke_raw_sub;
roll.Fy_norm_stroke = Fy_stroke_raw_sub;
roll.Fz_norm_stroke = Fz_stroke_raw_sub;

roll.Mx_norm_stroke = Mx_stroke_raw_sub;
roll.My_norm_stroke = My_stroke_raw_sub;
roll.Mz_norm_stroke = Mz_stroke_raw_sub;

roll.Fx_norm_stroke_butterfilt = Fx_stroke_butter_sub;
roll.Fy_norm_stroke_butterfilt = Fy_stroke_butter_sub;
roll.Fz_norm_stroke_butterfilt = Fz_stroke_butter_sub;

roll.Mx_norm_stroke_butterfilt = Mx_stroke_butter_sub;
roll.My_norm_stroke_butterfilt = My_stroke_butter_sub;
roll.Mz_norm_stroke_butterfilt = Mz_stroke_butter_sub;

roll.Fx_norm_rotation = Fx_pitch_raw_sub;
roll.Fy_norm_rotation = Fy_pitch_raw_sub;
roll.Fz_norm_rotation = Fz_pitch_raw_sub;

roll.Mx_norm_rotation = Mx_pitch_raw_sub;
roll.My_norm_rotation = My_pitch_raw_sub;
roll.Mz_norm_rotation = Mz_pitch_raw_sub;

roll.Fx_norm_rotation_butterfilt = Fx_pitch_butter_sub;
roll.Fy_norm_rotation_butterfilt = Fy_pitch_butter_sub;
roll.Fz_norm_rotation_butterfilt = Fz_pitch_butter_sub;

roll.Mx_norm_rotation_butterfilt = Mx_pitch_butter_sub;
roll.My_norm_rotation_butterfilt = My_pitch_butter_sub;
roll.Mz_norm_rotation_butterfilt = Mz_pitch_butter_sub;

roll.Fx_norm_deviation = Fx_dev_raw_sub;
roll.Fy_norm_deviation = Fy_dev_raw_sub;
roll.Fz_norm_deviation = Fz_dev_raw_sub;

roll.Mx_norm_deviation = Mx_dev_raw_sub;
roll.My_norm_deviation = My_dev_raw_sub;
roll.Mz_norm_deviation = Mz_dev_raw_sub;

roll.Fx_norm_deviation_butterfilt = Fx_dev_butter_sub;
roll.Fy_norm_deviation_butterfilt = Fy_dev_butter_sub;
roll.Fz_norm_deviation_butterfilt = Fz_dev_butter_sub;

roll.Mx_norm_deviation_butterfilt = Mx_dev_butter_sub;
roll.My_norm_deviation_butterfilt = My_dev_butter_sub;
roll.Mz_norm_deviation_butterfilt = Mz_dev_butter_sub;



save('DBkinematics_rolls_torques_NEWroll.mat','roll')
