...
%         ft(:,6) = filter_borf_raw(ft(:,6),butter_cut,butter_n,Nwb_total);
        ...
        t_dev(1:seq_length_max,n) = nan;
        
        stroke_L_dev(1:seq_length_max,n) = nan;
        pitch_L_dev(1:seq_length_max,n) = nan;
        dev_L_dev(1:seq_length_max,n) = nan;
        
        stroke_R_dev(1:seq_length_max,n) = nan;
        pitch_R_dev(1:seq_length_max,n) = nan;
        dev_R_dev(1:seq_length_max,n) = nan;
        
        Fx_dev(1:seq_length_max,1:Nwb,n) = nan;
        Fy_dev(1:seq_length_max,1:Nwb,n) = nan;
        Fz_dev(1:seq_length_max,1:Nwb,n) = nan;
        Mx_dev(1:seq_length_max,1:Nwb,n) = nan;
        My_dev(1:seq_length_max,1:Nwb,n) = nan;
        Mz_dev(1:seq_length_max,1:Nwb,n) = nan;
