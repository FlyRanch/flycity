...
% NO clusters
MSfig2_escape_dir_colorcode_MEANclusters_1c_wrap_accel
...
%% min&max Torque dyn
figure
% MSfig3_TorqueMAXnMIN_vs_turn_totalTorque
% MSfig3_TorqueMAXnMIN_vs_turn_allTorque
...
figure
% MSfig3_TorqueMAXnMIN_vs_turn_totalTorque_LnRaxes
% MSfig3_TorqueMAXnMIN_vs_turn_allTorque_LnRaxes
...
plot([nanmean(x_origin) du_post_mean],[nanmean(y_origin) dv_post_mean],'--','color',[1,0,0],'linewidth',2)
plot([nanmean(x_origin) 0],[nanmean(y_origin) V_pre_mean],'--','color',[0,0,1],'linewidth',2)
