...
%     color = {'g','g'};
    color = [1 0 0];
%     load('cmap_grey2darkred.mat'); % load colormap
%     color = cmap(end,:);
...
%                     plot(ax2,dorsal2Dpts(:,1),dorsal2Dpts(:,2),'r-','linewidth',1);
    %                 plot(ax2,dorsal2Dpts(:,1),dorsal2Dpts(:,2),'r-','linewidth',5);
                    plot(ax2,dorsal2Dpts(:,1),dorsal2Dpts(:,2),'color',color,'linewidth',1);
...
%                     patch(uT{i,j},vT{i,j},[1 1 1],'facecolor','none','edgecolor','w');
                    patch(u{i,j},v{i,j},[1 1 1],'facecolor','none','edgecolor',color);
                    patch(uT{i,j},vT{i,j},[1 1 1],'facecolor','none','edgecolor',color);
                end
                if plotpredict == 1 
...
% %             % save images
tic
            saveas(figure(11),[PAR.solutionpath 'Projections/cam1/flyimage_' sprintf(['%0',num2str(PAR.digits),'d'], frame) '.tif'])
            saveas(figure(12),[PAR.solutionpath 'Projections/cam2/flyimage_' sprintf(['%0',num2str(PAR.digits),'d'], frame) '.tif'])
            saveas(figure(13),[PAR.solutionpath 'Projections/cam3/flyimage_' sprintf(['%0',num2str(PAR.digits),'d'], frame) '.tif'])
toc
%             close all
%             pause(.1)
