...
n2 = find(abs(stim_angle_vel_mirror_pre)<subset_cut(3)&abs(stim_angle_vel_mirror_pre)>subset_cut(2));
n3 = find(abs(stim_angle_vel_mirror_pre)<subset_cut(5)&abs(stim_angle_vel_mirror_pre)>subset_cut(4));
n4 = find(abs(stim_angle_vel_mirror_pre)<subset_cut(7)&abs(stim_angle_vel_mirror_pre)>subset_cut(6));
n5 = find(abs(stim_angle_vel_mirror_pre)>subset_cut(8));
