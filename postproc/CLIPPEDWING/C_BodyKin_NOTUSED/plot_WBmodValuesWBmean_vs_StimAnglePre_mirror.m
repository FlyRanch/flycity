...
subplot(2,2,1)
plotcolor = 'b'
angle_post = roll_dot_dot_WBmean_norm_mirror_max;
plot_angle_pre_post_circmean_extendedsection_meanlim
plotcolor = 'r'
angle_post = roll_dot_dot_WBmean_norm_mirror_min;
plot_angle_pre_post_circmean_extendedsection_meanlim
...
subplot(2,2,2)
plotcolor = 'b'
angle_post = pitch_dot_dot_WBmean_norm_max;
plot_angle_pre_post_circmean_extendedsection_meanlim
plotcolor = 'r'
angle_post = pitch_dot_dot_WBmean_norm_min;
plot_angle_pre_post_circmean_extendedsection_meanlim
...
subplot(2,2,3)
plotcolor = 'b'
angle_post = yaw_dot_dot_WBmean_norm_mirror_max;
plot_angle_pre_post_circmean_extendedsection_meanlim
plotcolor = 'r'
angle_post = yaw_dot_dot_WBmean_norm_mirror_min;
plot_angle_pre_post_circmean_extendedsection_meanlim
