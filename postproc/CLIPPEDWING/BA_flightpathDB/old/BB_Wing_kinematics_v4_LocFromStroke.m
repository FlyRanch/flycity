...
%%
prog_loc = mfilename('fullpath');
file_seps = strfind(prog_loc,filesep);

prog_name = prog_loc(file_seps(end)+1:end);
prog_loc = prog_loc(1:file_seps(end-3));

add_paths = {...
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan']; ...
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan',filesep,'Kalman_Filter']; ...
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan',filesep,'Plot']; ...
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan',filesep,'Plot',filesep,'Smoothing_plots']; ... % };
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan',filesep,'Body_model']; ...
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan',filesep,'Body_model',filesep,'mex']; ...
             [prog_loc,'toolbox',filesep,'WBKinProg_Johan',filesep,'Type2Regression'];...
             };
...
% add_paths = {...
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan'; ...
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan/Kalman_Filter'; ...
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan/Plot'; ...
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan/Plot/Smoothing_plots'; ... % };
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan/Body_model'; ...
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan/Body_model/mex'; ...
%              '/home/florian/GitHub/flycity/postproc/SACCADE/A_flightpathDB/WBKinProg_Johan/Type2Regression';...
%              };
%          
...
% addpath('/home/florian/GitHub/flycity/postproc/SACCADE');
        ...
        if dir_now.isdir == 1
            ...
            if ~isempty(seq_dir)
                for j = 1:length(seq_dir)
                    if seq_dir(j).isdir == 1
                        temp_seqname = [cd,filesep,seq_dir(j).name];
...
if exist('pathDB5.mat')==2
    ...
    Wing_ref_frame_LocFromStroke(settings,pathDB);
    temp = load('pathDB5.mat');
