...
Lbody = 3.138e-3;
body_angle = 47.5; 
h_wing = 5.4e-4; % Non dimensional wing thickness [ t_w / L_w ]
C_mfly = 1.85e-6; % fly mass per wing length coefficient
...
% 
% 
% %% EMPIRICAL ESCAPE INERTIA (disk4yaw)
% Iyaw = Iyaw_disc;
% Iroll = 1.43 *Mg_fly * Lwing / freq_steady^2;
% Ipitch = 2.06 *Mg_fly * Lwing / freq_steady^2;
% 
% % ESCAPE inertia, -.025<tpre<-.005, .03<tpost<-.06
% rot_axis_angle = 27.9; % [deg] !!!
% 
% save('flyVars_EscapeInertia.mat')
