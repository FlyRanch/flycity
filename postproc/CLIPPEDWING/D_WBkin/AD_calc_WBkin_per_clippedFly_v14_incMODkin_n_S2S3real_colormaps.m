...
S2_Clipped_mean = S2_normClipped_mean .* Area_Clipped_mean .* (L_Clipped_mean).^2;
S3_Clipped_mean = S3_normClipped_mean .* Area_Clipped_mean .* (L_Clipped_mean).^3;
...
S2_Intact_mean = S2_normIntact_mean .* Area_Intact_mean .* (L_Intact_mean).^2;
S3_Intact_mean = S3_normIntact_mean .* Area_Intact_mean .* (L_Intact_mean).^3;

AR_Intact_mean = 1./Area_normIntact_mean;
r2_Intact_mean = S2_Intact_mean.^(1/4);
r3_Intact_mean = S3_Intact_mean.^(1/5);

%% Ellington's AR & Area & r^_2 & r^_3
L_total = L_Clipped_mean + L_Intact_mean;
L_mean = (L_Clipped_mean + L_Intact_mean)/2;

Area_total = Area_Clipped_mean + Area_Intact_mean;
AR = L_total.^2 ./Area_total;

S2_total = S2_Clipped_mean + S2_Intact_mean;
S3_total = S3_Clipped_mean + S3_Intact_mean;

S2_norm_total = S2_total ./ Area_total ./(L_mean).^2;
S3_norm_total = S3_total ./ Area_total ./(L_mean).^3;

%% plot
mkdir('clippedfly_steadyWBkin_param_figs')
cd('clippedfly_steadyWBkin_param_figs')

cmap_RdGy = cbrewer('div','RdGy',100);
cmap_GyRd = flipud(cmap_RdGy);

cmap_Blues = cbrewer('seq','Blues',100);
cmap_Greens = cbrewer('seq','Greens',100);
cmap_Reds = cbrewer('seq','Reds',100);
cmap_Hot = hot(100);
cmap_HotFlip = flipud(cmap_Hot);

cmap_freq = cmap_GyRd;
cmap_AR = cmap_Greens;
cmap_Aplus = cmap_HotFlip;
...
for i = 1:length(freqRatio_mean)
    ...
    if color_nr<1
        color_nr=1
    elseif color_nr>size(cmap_freq,1)
        color_nr=size(cmap_freq,1)
    end
    
    plot(r2_Intact_mean(i),r3_Intact_mean(i),'sk','markerfacecolor',cmap_freq(color_nr_steady,:),'markersize',7)
    if clip_type_mean(i) > 1.5
        plot(r2_Clipped_mean(i),r3_Clipped_mean(i),'dk','markerfacecolor',cmap_freq(color_nr,:),'markersize',10)
    else
        plot(r2_Clipped_mean(i),r3_Clipped_mean(i),'ok','markerfacecolor',cmap_freq(color_nr,:),'markersize',10)
    end
    hold on
end
axis equal
...
for i = 1:length(freqRatio_mean)
    ...
    plot(S2_Intact_mean(i),S3_Intact_mean(i),'sk','markerfacecolor',cmap_freq(color_nr_steady,:),'markersize',7)
    if clip_type_mean(i) > 1.5
        plot(S2_Clipped_mean(i),S3_Clipped_mean(i),'dk','markerfacecolor',cmap_freq(color_nr,:),'markersize',10)
    else
        plot(S2_Clipped_mean(i),S3_Clipped_mean(i),'ok','markerfacecolor',cmap_freq(color_nr,:),'markersize',10)
    end
    hold on
end
% axis equal
...
for i = 1:length(AR_Clipped_mean)
    ...
    plot(r2_Intact_mean(i),r3_Intact_mean(i),'sk','markerfacecolor',cmap_AR(color_nr_intact,:),'markersize',7)
    if clip_type_mean(i) > 1.5
        plot(r2_Clipped_mean(i),r3_Clipped_mean(i),'dk','markerfacecolor',cmap_AR(color_nr_clipped,:),'markersize',10)
    else
        plot(r2_Clipped_mean(i),r3_Clipped_mean(i),'ok','markerfacecolor',cmap_AR(color_nr_clipped,:),'markersize',10)
    end
    hold on
end
axis equal
...
for i = 1:length(AR_Clipped_mean)
    ...
    plot(S2_Intact_mean(i),S3_Intact_mean(i),'sk','markerfacecolor',cmap_AR(color_nr_intact,:),'markersize',7)
    if clip_type_mean(i) > 1.5
        plot(S2_Clipped_mean(i),S3_Clipped_mean(i),'dk','markerfacecolor',cmap_AR(color_nr_clipped,:),'markersize',10)
    else
        plot(S2_Clipped_mean(i),S3_Clipped_mean(i),'ok','markerfacecolor',cmap_AR(color_nr_clipped,:),'markersize',10)
    end
    hold on
end
% axis equal
...
%% S2 & S3 Normailzed (r^_2 & r^_3) VS AR
figure
subplot(2,2,3)
...
for i = 1:length(AR_Clipped_mean)
    ...
    plot(S2_normIntact_mean(i),S3_normIntact_mean(i),'sk','markerfacecolor',cmap_AR(color_nr_intact,:),'markersize',7)
    if clip_type_mean(i) > 1.5
        plot(S2_normClipped_mean(i),S3_normClipped_mean(i),'dk','markerfacecolor',cmap_AR(color_nr_clipped,:),'markersize',10)
    else
        plot(S2_normClipped_mean(i),S3_normClipped_mean(i),'ok','markerfacecolor',cmap_AR(color_nr_clipped,:),'markersize',10)
    end
    hold on
end
axis equal
% axis square
axis tight
axis([Snorm2_min,Snorm2_max,Snorm3_min,Snorm3_max])
set(gca,'xtick',Snorm2_min:(Snorm2_max-Snorm2_min):Snorm2_max)
set(gca,'ytick',Snorm3_min:(Snorm3_max-Snorm3_min):Snorm3_max)
xlabel('r^_2')
ylabel('r^_3')
colormap(cmap_AR)
caxis([AR_min AR_max])
...
%% S2 & S3 Normailzed (r^_2 & r^_3) VS wing area
subplot(2,2,4)
...
% save fig
saveas(gcf,['clippedfly_steadyWBkin_r2nr3Norm_vs_ARnArea.fig'])
saveas(gcf,['clippedfly_steadyWBkin_r2nr3Norm_vs_ARnArea.png'])
% saveas(gcf,['clippedfly_steadyWBkin_r2nr3Norm_vs_ARnArea.svg'])
plot2svg(['clippedfly_steadyWBkin_r2nr3Norm_vs_ARnArea.svg'])
...
for i = 1:length(Astroke_ratio_clip_intact_mean)
    ...
    if clip_type_mean(i) > 1.5
%         errorbar(S2S3AmpRatioFunc_all(i),Astroke_ratio_clip_intact_mean(i),Astroke_ratio_clip_intact_ste(i),'dk','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
        plot(Astroke_ratio_clip_intact_mean(i),S2S3AmpRatioFunc_all(i),'dk','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',8)
    else
%         errorbar(S2S3AmpRatioFunc_all(i),Astroke_ratio_clip_intact_mean(i),Astroke_ratio_clip_intact_ste(i),'ok','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
        plot(Astroke_ratio_clip_intact_mean(i),S2S3AmpRatioFunc_all(i),'ok','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',8)
    end
...
subplot(2,2,4)
for i = 1:length(Astroke_ratio_clip_intact_mean)
    color_nr = round(99/(Aratio_max-Aratio_min)*(S2S3AmpRatioFunc_all(i)-Aratio_min)+1);
    if color_nr<1
        color_nr=1
    elseif color_nr>size(cmap_AdAi,1)
        color_nr=size(cmap_AdAi,1)
    ...
    if clip_type_mean(i) > 1.5
%         errorbar(S2S3AmpRatioFunc_all(i),Astroke_ratio_clip_intact_mean(i),Astroke_ratio_clip_intact_ste(i),'dk','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
        plot(Astroke_ratio_clip_intact_mean(i),AstrokeRatio_S2S3AmpRatioFunc_all(i),'dk','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',8)
    else
%         errorbar(S2S3AmpRatioFunc_all(i),Astroke_ratio_clip_intact_mean(i),Astroke_ratio_clip_intact_ste(i),'ok','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
        plot(Astroke_ratio_clip_intact_mean(i),AstrokeRatio_S2S3AmpRatioFunc_all(i),'ok','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',8)
    end
...
% save fig
saveas(gcf,['clippedfly_steadyWBkin_strokeAmp.fig'])
saveas(gcf,['clippedfly_steadyWBkin_strokeAmp.png'])
% saveas(gcf,['clippedfly_steadyWBkin_strokeAmp.svg'])
plot2svg(['clippedfly_steadyWBkin_strokeAmp.svg'])
...
for i = 1:length(freqRatio_mean)
    ...
    if clip_type_mean(i) > 1.5
        plot(S2_ratio_mean(i),S3_ratio_mean(i),'dk','markerfacecolor',cmap_freq(color_nr,:),'markersize',10)
    else
        plot(S2_ratio_mean(i),S3_ratio_mean(i),'ok','markerfacecolor',cmap_freq(color_nr,:),'markersize',10)
    end
    hold on
end
axis equal
...
% save fig
saveas(gcf,['clippedfly_steadyWBkin_WBfreq.fig'])
saveas(gcf,['clippedfly_steadyWBkin_WBfreq.png'])
% saveas(gcf,['clippedfly_steadyWBkin_WBfreq.svg'])
plot2svg(['clippedfly_steadyWBkin_WBfreq.svg'])

%% stroke amplitude ratio of clipped & intact wing VS S2* & S3*
Aratio_max = 1.3;
Aratio_min = 1;

figure
subplot(2,2,3)
for i = 1:length(S2S3AmpRatioFunc_all)
    color_nr = round(99/(Aratio_max-Aratio_min)*(S2S3AmpRatioFunc_all(i)-Aratio_min)+1);
    if color_nr<1
        color_nr=1
    elseif color_nr>size(cmap_AdAi,1)
    ...
    if clip_type_mean(i) > 1.5
%         errorbar(S2S3AmpRatioFunc_all(i),Astroke_ratio_clip_intact_mean(i),Astroke_ratio_clip_intact_ste(i),'dk','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
        plot(S2_ratio_mean(i),S3_ratio_mean(i),'dk','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
    else
%         errorbar(S2S3AmpRatioFunc_all(i),Astroke_ratio_clip_intact_mean(i),Astroke_ratio_clip_intact_ste(i),'ok','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
        plot(S2_ratio_mean(i),S3_ratio_mean(i),'ok','markerfacecolor',cmap_AdAi(color_nr,:),'markersize',10)
    end
...
% save fig
saveas(gcf,['clippedfly_steadyWBkin_Aplus_vs_S2nS3.fig'])
saveas(gcf,['clippedfly_steadyWBkin_Aplus_vs_S2nS3.png'])
% saveas(gcf,['clippedfly_steadyWBkin_Aplus_vs_S2nS3.svg'])
plot2svg(['clippedfly_steadyWBkin_Aplus_vs_S2nS3.svg'])
