...
plot(abs(rollaccel_RollAccel),stroke_wb_up_RollAccel_bins(1,:),'.b')
...
% plot(abs(roll_dot_dot_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot(abs(roll_dot_dot_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot(abs(rollaccel_RollAccel),stroke_wb_down_RollAccel_bins(1,:),'.b')
...
% plot(abs(roll_dot_dot_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot(abs(roll_dot_dot_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot(abs(rollaccel_RollAccel),Dstroke_wb_RollAccel_bins(1,:),'.b')
...
% up
subplot(3,2,2)
plot(abs(rollaccel_RollAccel),strokeMOD_wb_up_RollAccel_bins(1,:),'.b')
...
% down
subplot(3,2,4)
plot(abs(rollaccel_RollAccel),strokeMOD_wb_down_RollAccel_bins(1,:),'.b')
...
% up down
subplot(3,2,6)
plot(abs(rollaccel_RollAccel),DstrokeMOD_wb_RollAccel_bins(1,:),'.b')
