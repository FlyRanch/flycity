...
%     end
    ...
    if isempty(seqc)==0
        ...
        clipDB.SecondMomentCC(seqp,1) = WingClipData.SecondMomentCC(seqc);
        clipDB.SecondMomentCI(seqp,1) = WingClipData.SecondMomentCI(seqc);
        clipDB.SecondMomentTC(seqp,1) = WingClipData.SecondMomentTC(seqc);
        clipDB.SecondMomentTI(seqp,1) = WingClipData.SecondMomentTI(seqc);
        ...
        clipDB.ThirdMomentCC(seqp,1) = WingClipData.ThirdMomentCC(seqc);
        clipDB.ThirdMomentCI(seqp,1) = WingClipData.ThirdMomentCI(seqc);
        clipDB.ThirdMomentTC(seqp,1) = WingClipData.ThirdMomentTC(seqc);
        clipDB.ThirdMomentTI(seqp,1) = WingClipData.ThirdMomentTI(seqc);
        ...
        clipDB.WingAreaC(seqp,1) = WingClipData.WingAreaC(seqc);
        clipDB.WingAreaI(seqp,1) = WingClipData.WingAreaI(seqc);
        clipDB.WingAreaRatio(seqp,1) = WingClipData.WingAreaRatio(seqc);
        
        clipDB.WingLengthC(seqp,1) = WingClipData.WingLengthC(seqc);
        clipDB.WingLengthI(seqp,1) = WingClipData.WingLengthI(seqc);
