...
FirstMomentNormClipped_all = clipDB.FirstMomentCC_norm;
FirstMomentNormIntact_all = clipDB.FirstMomentCI_norm;
FirstMomentRatio_all = clipDB.FirstMomentRatioCentroid;

SecondMomentNormClipped_all = clipDB.SecondMomentCC_norm;
SecondMomentNormIntact_all = clipDB.SecondMomentCI_norm;
SecondMomentRatio_all = clipDB.SecondMomentRatioCentroid;

ThirdMomentNormClipped_all = clipDB.ThirdMomentCC_norm;
ThirdMomentNormIntact_all = clipDB.ThirdMomentCI_norm;
ThirdMomentRatio_all = clipDB.ThirdMomentRatioCentroid;

AreaNormClipped_all = clipDB.WingAreaC_norm;
AreaNormIntact_all = clipDB.WingAreaI_norm;
AreaRatio_all = clipDB.WingAreaRatio;

LengthClipped_pixels_all = clipDB.WingLengthC_pixels;
LengthIntact_pixels_all = clipDB.WingLengthI_pixels;
...
calc_wb_data_subsets_incCLIPdataS1S2S3
