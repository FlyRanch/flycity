...
% M_L_mean_wb = Mroll_mean_wb*sind(rot_axis_angle) - Mpitch_mean_wb*cosd(rot_axis_angle);
% M_R_mean_wb = Mroll_mean_wb*cosd(rot_axis_angle) + Mpitch_mean_wb*sind(rot_axis_angle);
