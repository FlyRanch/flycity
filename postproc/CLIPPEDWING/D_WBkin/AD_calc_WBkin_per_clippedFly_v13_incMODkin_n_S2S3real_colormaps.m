...
for i = 1:length(freqRatio_mean)
    ...
    plot(r2_Intact_mean(i),r3_Intact_mean(i),'sk','markerfacecolor',cmap_freq(color_nr_steady,:),'markersize',6)
    if clip_type_mean(i) > 1.5
        plot(r2_Clipped_mean(i),r3_Clipped_mean(i),'dk','markerfacecolor',cmap_freq(color_nr,:),'markersize',8)
    else
        plot(r2_Clipped_mean(i),r3_Clipped_mean(i),'ok','markerfacecolor',cmap_freq(color_nr,:),'markersize',8)
    end
    hold on
end
axis equal
...
for i = 1:length(freqRatio_mean)
    ...
    plot(S2_Intact_mean(i),S3_Intact_mean(i),'sk','markerfacecolor',cmap_freq(color_nr_steady,:),'markersize',6)
    if clip_type_mean(i) > 1.5
        plot(S2_Clipped_mean(i),S3_Clipped_mean(i),'dk','markerfacecolor',cmap_freq(color_nr,:),'markersize',8)
    else
        plot(S2_Clipped_mean(i),S3_Clipped_mean(i),'ok','markerfacecolor',cmap_freq(color_nr,:),'markersize',8)
    end
    hold on
end
% axis equal
