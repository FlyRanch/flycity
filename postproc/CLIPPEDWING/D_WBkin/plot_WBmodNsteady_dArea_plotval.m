...
plot(binx,stroke_steady+AreaRatio_plot*strokeMOD_R,'-r','linewidth',2)
...
plot(binx,pitch_steady+AreaRatio_plot*pitchMOD_R,'-r','linewidth',2)
...
plot(binx,dev_steady+AreaRatio_plot*devMOD_R,'-r','linewidth',2)
...
plot(binx,stroke_steady+AreaRatio_plot*strokeMOD_L,'-r','linewidth',2)
...
plot(binx,pitch_steady+AreaRatio_plot*pitchMOD_L,'-r','linewidth',2)
...
plot(binx,dev_steady+AreaRatio_plot*devMOD_L,'-r','linewidth',2)
...
plot(binx,stroke_steady+AreaRatio_plot*DstrokeMOD,'-r','linewidth',2)
...
plot(binx,pitch_steady+AreaRatio_plot*DpitchMOD,'-r','linewidth',2)
...
plot(binx,dev_steady+AreaRatio_plot*DdevMOD,'-r','linewidth',2)
