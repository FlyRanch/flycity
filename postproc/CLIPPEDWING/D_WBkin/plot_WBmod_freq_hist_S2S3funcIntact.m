...
subplot(2,2,3)
plot(S2S3funcIntact,f_wb_L,'.g')
plot(S2S3funcIntact,f_wb_R,'.g')
plot(S2S3funcIntact_S2S3funcIntact,f_wb_S2S3funcIntact,'.b')

% plot trend
RC = freqMOD_wb_S2S3funcIntact_meanCIstd(1);
...
subplot(2,2,4)
plot(S2S3funcIntact_S2S3funcIntact,freqMOD_wb_S2S3funcIntact,'.b')
