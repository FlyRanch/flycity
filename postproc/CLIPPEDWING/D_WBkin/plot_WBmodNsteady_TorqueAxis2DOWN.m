...
subplot(3,3,1)
strokeMOD_R = calc_val_fourier_series_4thN8th_order(binx,strokeMOD_L_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,2)
pitchMOD_R = calc_val_fourier_series_4thN8th_order(binx,pitchMOD_L_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,3)
devMOD_R = calc_val_fourier_series_4thN8th_order(binx,devMOD_L_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,4)
strokeMOD_L = calc_val_fourier_series_4thN8th_order(binx,strokeMOD_R_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,5)
pitchMOD_L = calc_val_fourier_series_4thN8th_order(binx,pitchMOD_R_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,6)
devMOD_L = calc_val_fourier_series_4thN8th_order(binx,devMOD_R_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,7)
DstrokeMOD = calc_val_fourier_series_4thN8th_order(binx,DstrokeMOD_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,8)
DpitchMOD = calc_val_fourier_series_4thN8th_order(binx,DpitchMOD_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
...
subplot(3,3,9)
DdevMOD = calc_val_fourier_series_4thN8th_order(binx,DdevMOD_TorqueAxis2DOWN_fourier_coeffs_binmean,0);
