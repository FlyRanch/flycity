...
ciplot((AeroCenterFuncClipped_plot-AeroCenterFuncClipped_steady)*var_ll,(AeroCenterFuncClipped_plot-AeroCenterFuncClipped_steady)*var_ul,binx,color_band)
% alpha(.25)
hold on
plot(binx,(AeroCenterFuncClipped_plot-AeroCenterFuncClipped_steady)*var_mean,'k')
% ylim([y_min,y_max])
