...
% DrotAxisR
subplot(1,3,1)
DstrokeMOD = calc_val_fourier_series_4thN8th_order(binx,DstrokeMOD_TorqueAxisR_fourier_coeffs_binmean,0);
plot(binx,stroke_steady+2*DstrokeMOD,'-m','linewidth',2)

subplot(1,3,2)
DpitchMOD = calc_val_fourier_series_4thN8th_order(binx,DpitchMOD_TorqueAxisR_fourier_coeffs_binmean,0);
plot(binx,pitch_steady+2*DpitchMOD,'-m','linewidth',2)

subplot(1,3,3)
DdevMOD = calc_val_fourier_series_4thN8th_order(binx,DdevMOD_TorqueAxisR_fourier_coeffs_binmean,0);
