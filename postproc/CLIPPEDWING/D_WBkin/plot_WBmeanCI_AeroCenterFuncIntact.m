...
ciplot((AeroCenterFuncIntact_plot-AeroCenterFuncIntact_steady)*var_ll,(AeroCenterFuncIntact_plot-AeroCenterFuncIntact_steady)*var_ul,binx,color_band)
% alpha(.25)
hold on
plot(binx,(AeroCenterFuncIntact_plot-AeroCenterFuncIntact_steady)*var_mean,'k')
% ylim([y_min,y_max])
