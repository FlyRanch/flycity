...
subplot(2,2,3)
plot(S2S3funcClipped,f_wb_L,'.g')
plot(S2S3funcClipped,f_wb_R,'.g')
plot(S2S3funcClipped_S2S3funcClipped,f_wb_S2S3funcClipped,'.b')

% plot trend
RC = freqMOD_wb_S2S3funcClipped_meanCIstd(1);
...
subplot(2,2,2)
var = freqMOD_wb_S2S3funcClipped;
h=hist(var);
hist(var)
...
subplot(2,2,4)
plot(S2S3funcClipped_S2S3funcClipped,freqMOD_wb_S2S3funcClipped,'.b')
