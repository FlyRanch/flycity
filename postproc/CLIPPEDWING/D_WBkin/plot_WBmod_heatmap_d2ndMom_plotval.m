...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[strokeMOD_wb_L_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[strokeMOD_wb_R_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[DstrokeMOD_wb_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[pitchMOD_wb_L_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[pitchMOD_wb_R_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[DpitchMOD_wb_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[devMOD_wb_L_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[devMOD_wb_R_d2ndMom_bins];
...
% biny_min = -30;
% biny_max = 30;
var = SecondMomentRatio_plot*[DdevMOD_wb_d2ndMom_bins];
...
subplot(3,3,1)
val=feval(strokeMOD_L_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel([],'fontsize',10) 
ylabel('Left wing','fontsize',10) 

subplot(3,3,2)
val=feval(pitchMOD_L_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel([],'fontsize',10) 
ylabel([],'fontsize',10) 
...
subplot(3,3,3)
val=feval(devMOD_L_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel([],'fontsize',10) 
ylabel([],'fontsize',10) 
...
subplot(3,3,4)
val=feval(strokeMOD_R_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel([],'fontsize',10) 
ylabel('Right wing','fontsize',10) 
...
subplot(3,3,5)
val=feval(pitchMOD_R_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel([],'fontsize',10) 
ylabel([],'fontsize',10) 
...
subplot(3,3,6)
val=feval(devMOD_R_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel([],'fontsize',10) 
ylabel([],'fontsize',10) 
...
subplot(3,3,7)
val=feval(DstrokeMOD_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel('time','fontsize',10) 
...
subplot(3,3,8)
val=feval(DpitchMOD_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel('time','fontsize',10) 
ylabel([],'fontsize',10) 
...
subplot(3,3,9)
val=feval(DdevMOD_d2ndMom_fourier_fit_binmean,[0:.01:1]);
plot([0:.01:1],SecondMomentRatio_plot*val,'r')
legend off
xlabel('time','fontsize',10) 
ylabel([],'fontsize',10) 
