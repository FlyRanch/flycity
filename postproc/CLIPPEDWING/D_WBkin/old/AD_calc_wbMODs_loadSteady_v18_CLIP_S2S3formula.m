...
plot([S2S3funcIntact_NONclipped-S2S3funcIntact_cut S2S3funcIntact_NONclipped-S2S3funcIntact_cut],[S2S3funcClipped_NONclipped+S2S3funcClipped_cut S2S3funcClipped_NONclipped],'-g')
plot([S2S3funcIntact_NONclipped-S2S3funcIntact_cut S2S3funcIntact_NONclipped],[S2S3funcClipped_NONclipped+S2S3funcClipped_cut S2S3funcClipped_NONclipped+S2S3funcClipped_cut],'-g')
...
saveas(gca,['S2S3funcs_realfly_cutoff_n_plot_values.fig'])
saveas(gca,['S2S3funcs_realfly_cutoff_n_plot_values.png'])
plot2svg(['S2S3funcs_realfly_cutoff_n_plot_values.svg'])
...
if plot_on == 1
mkdir('WBmod_figs_S2S3funcIntact')
cd('WBmod_figs_S2S3funcIntact')
...
if plot_on == 1
mkdir('WBmod_figs_S2S3funcClipped')
cd('WBmod_figs_S2S3funcClipped')
...
%% save all
if save_on == 1
    save('WBdataset_steadyNclipMods_S2S3funcs.mat')
end
