...
% rwd wing 
stroke_Myaw_RWD0 = stroke_steady + calc_val_fourier_series_4thN8th_order(binx,strokeMOD_rwd_YawTorque_fourier_coeffs_binmean,0);
pitch_Myaw_RWD0  = pitch_steady  + calc_val_fourier_series_4thN8th_order(binx,pitchMOD_rwd_YawTorque_fourier_coeffs_binmean,0);
dev_Myaw_RWD0   = dev_steady    + calc_val_fourier_series_4thN8th_order(binx,devMOD_rwd_YawTorque_fourier_coeffs_binmean,0);

stroke_MaxisR_R0 = stroke_steady + calc_val_fourier_series_4thN8th_order(binx,strokeMOD_R_TorqueAxisR_fourier_coeffs_binmean,0);
pitch_MaxisR_R0  = pitch_steady  + calc_val_fourier_series_4thN8th_order(binx,pitchMOD_R_TorqueAxisR_fourier_coeffs_binmean,0);
dev_MaxisR_R0    = dev_steady    + calc_val_fourier_series_4thN8th_order(binx,devMOD_R_TorqueAxisR_fourier_coeffs_binmean,0);
...
stroke_MaxisR_R_MSEmin = stroke_steady_axisRdt + calc_val_fourier_series_4thN8th_order(binx-dt_stroke_MaxisR_MSEmin,strokeMOD_R_TorqueAxisR_fourier_coeffs_binmean,0);
pitch_MaxisR_R_MSEmin  = pitch_steady_axisRdt  + calc_val_fourier_series_4thN8th_order(binx-dt_pitch_MaxisR_MSEmin,pitchMOD_R_TorqueAxisR_fourier_coeffs_binmean,0);
dev_MaxisR_R_MSEmin    = dev_steady_axisRdt    + calc_val_fourier_series_4thN8th_order(binx-dt_dev_MaxisR_MSEmin,devMOD_R_TorqueAxisR_fourier_coeffs_binmean,0);
...
%% save data
save('WBkin_LnR_correlations.mat','binx',...
...
plot(binx,stroke_Myaw_FWD,'-','color',[1 .5 0],'linewidth',1)
plot(binx,stroke_Myaw_RWD0,'-','color',[0 .5 1],'linewidth',1)
plot(binx,stroke_Myaw_RWD_MSEmin,'-','color',[.5 .5 .5],'linewidth',1)

plot(binx,pitch_Myaw_FWD-90,'-','color',[1 .5 0],'linewidth',1)
plot(binx,pitch_Myaw_RWD0-90,'-','color',[0 .5 1],'linewidth',1)
plot(binx,pitch_Myaw_RWD_MSEmin-90,'-','color',[.5 .5 .5],'linewidth',1)

plot(binx,dev_Myaw_FWD,'-','color',[1 .5 0],'linewidth',1)
plot(binx,dev_Myaw_RWD0,'-','color',[0 .5 1],'linewidth',1)
plot(binx,dev_Myaw_RWD_MSEmin,'-','color',[.5 .5 .5],'linewidth',1)

% axisR original & @ MSEmin
subplot(3,3,8)
plot(binx,stroke_MaxisR_L,'-','color',[1 .5 0],'linewidth',1)
plot(binx,stroke_MaxisR_R0,'-','color',[0 .5 1],'linewidth',1)
plot(binx,stroke_MaxisR_R_MSEmin,'-','color',[.5 .5 .5],'linewidth',1)

plot(binx,pitch_MaxisR_L-90,'-','color',[1 .5 0],'linewidth',1)
plot(binx,pitch_MaxisR_R0-90,'-','color',[0 .5 1],'linewidth',1)
plot(binx,pitch_MaxisR_R_MSEmin-90,'-','color',[.5 .5 .5],'linewidth',1)

plot(binx,dev_MaxisR_L,'-','color',[1 .5 0],'linewidth',1)
plot(binx,dev_MaxisR_R0,'-','color',[0 .5 1],'linewidth',1)
plot(binx,dev_MaxisR_R_MSEmin,'-','color',[.5 .5 .5],'linewidth',1)
...
saveas(gca,['MSplot_WBkin3std_LnR_atMSEmin.fig'])
saveas(gca,['MSplot_WBkin3std_LnR_atMSEmin.png'])
plot2svg(['MSplot_WBkin3std_LnR_atMSEmin.svg'])
...
saveas(gca,['MSplot_MSE_WBkin3std_LnR_MSEmax',num2str(MSEmax),'.fig'])
saveas(gca,['MSplot_MSE_WBkin3std_LnR_MSEmax',num2str(MSEmax),'.png'])
plot2svg(['MSplot_MSE_WBkin3std_LnR_MSEmax',num2str(MSEmax),'.svg'])
...
saveas(gca,['MSplot_logMSE_WBkin3std_LnR_logMSEmax',num2str(logMSEmax),'.fig'])
saveas(gca,['MSplot_logMSE_WBkin3std_LnR_logMSEmax',num2str(logMSEmax),'.png'])
plot2svg(['MSplot_logMSE_WBkin3std_LnR_logMSEmax',num2str(logMSEmax),'.svg'])
