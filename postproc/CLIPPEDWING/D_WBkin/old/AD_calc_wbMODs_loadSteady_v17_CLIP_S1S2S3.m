...
% cut-offs
std_factor = 1;
AreaRatio_cut = 1-std_factor*nanstd(AreaRatio);
FirstMomentRatio_cut = 1-std_factor*nanstd(FirstMomentRatio);
SecondMomentRatio_cut = 1-std_factor*nanstd(SecondMomentRatio);
ThirdMomentRatio_cut = 1-std_factor*nanstd(ThirdMomentRatio);

% % manual cut-off
% AreaRatio_cut = .9;
% FirstMomentRatio_cut = .9;
% SecondMomentRatio_cut = .9;
% ThirdMomentRatio_cut = .9;

AreaRatio_plot = .5;
FirstMomentRatio_plot = .5;
...
%% CALC CLIPPED WB MODS: 1st MOMENT OF AREA DIFFERENCE for Forces
if calc_WB_d1stMom == 1
    
calc_wbNORM_wingatt_CLIPPED_S1S2S3_d1stMom_cutoff

if plot_on == 1
mkdir('WBmod_figs_d1stMom')
cd('WBmod_figs_d1stMom')

xmin = floor(10*min(FirstMomentRatio(:)))/10;
xmax = 1;

%% d1stMom distribution
figure
h=hist(FirstMomentRatio_d1stMom,10);
hist(FirstMomentRatio_d1stMom,10)
hold on
title('FirstMomentRatio of clipped and intact wings')
xlabel('FirstMomentRatio')
ylabel('# of wingbeats')
xlim([xmin xmax])
saveas(gca,['hist_FirstMomentRatio_',num2str(n_d1stMom),'WBs.fig'])
saveas(gca,['hist_FirstMomentRatio_',num2str(n_d1stMom),'WBs.png'])
plot2svg(['hist_FirstMomentRatio_',num2str(n_d1stMom),'WBs.svg'])

%% body kin MODs
    plot_BODYmod_vel_hist_d1stMom
    saveas(gca,['WBmod_vel_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_vel_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_vel_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_BODYmod_slip_hist_d1stMom
    saveas(gca,['WBmod_slip_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_slip_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_slip_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_BODYmod_pitch_hist_d1stMom
    saveas(gca,['WBmod_pitch_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_pitch_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_pitch_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_BODYmod_roll_hist_d1stMom
    saveas(gca,['WBmod_roll_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_roll_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_roll_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_BODYmod_Fsp_pitch_hist_d1stMom
    saveas(gca,['WBmod_Fsp_pitch_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_Fsp_pitch_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_Fsp_pitch_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_BODYmod_Fsp_roll_hist_d1stMom
    saveas(gca,['WBmod_Fsp_roll_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_Fsp_roll_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_Fsp_roll_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

%% WB kin MODs
    plot_WBmod_freq_hist_d1stMom
    saveas(gca,['WBmod_freq_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_freq_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_freq_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

%     plot_WBmod_heatmap_d1stMom
    plot_WBmod_heatmap_d1stMom_plotval
    saveas(gca,['WBmod_d1stMom_',num2str(n_d1stMom),'WBs_2ndMomRatio',num2str(FirstMomentRatio_plot),'.fig'])
    saveas(gca,['WBmod_d1stMom_',num2str(n_d1stMom),'WBs_2ndMomRatio',num2str(FirstMomentRatio_plot),'.png'])
    plot2svg(['WBmod_d1stMom_',num2str(n_d1stMom),'WBs_2ndMomRatio',num2str(FirstMomentRatio_plot),'.svg'])
    
%     plot_WBmodNsteady_d1stMom
    plot_WBmodNsteady_d1stMom_plotval
    saveas(gca,['WBmodNsteady_d1stMom_',num2str(n_d1stMom),'WBs_2ndMomRatio',num2str(FirstMomentRatio_plot),'.fig'])
    saveas(gca,['WBmodNsteady_d1stMom_',num2str(n_d1stMom),'WBs_2ndMomRatio',num2str(FirstMomentRatio_plot),'.png'])
    plot2svg(['WBmodNsteady_d1stMom_',num2str(n_d1stMom),'WBs_2ndMomRatio',num2str(FirstMomentRatio_plot),'.svg'])
    
    plot_WBmod_strokeMAXcoeff_d1stMom
    saveas(gca,['WBmod_strokeMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_strokeMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_strokeMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_WBmod_strokeMINcoeff_d1stMom
    saveas(gca,['WBmod_strokeMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_strokeMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_strokeMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_WBmod_pitchMIDDScoeff_d1stMom
    saveas(gca,['WBmod_pitchMIDDScoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_pitchMIDDScoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_pitchMIDDScoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_WBmod_pitchMIDUScoeff_d1stMom
    saveas(gca,['WBmod_pitchMIDUScoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_pitchMIDUScoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_pitchMIDUScoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_WBmod_devDSMAXcoeff_d1stMom
    saveas(gca,['WBmod_devDSMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_devDSMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_devDSMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_WBmod_devDSMINcoeff_d1stMom
    saveas(gca,['WBmod_devDSMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_devDSMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_devDSMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])

    plot_WBmod_devUSMAXcoeff_d1stMom
    saveas(gca,['WBmod_devUSMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_devUSMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_devUSMAXcoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])
    
    plot_WBmod_devUSMINcoeff_d1stMom
    saveas(gca,['WBmod_devUSMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.fig'])
    saveas(gca,['WBmod_devUSMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.png'])
    plot2svg(['WBmod_devUSMINcoeff_d1stMom_',num2str(n_d1stMom),'WBs.svg'])
cd ..
end
end
...
%% save all
if save_on == 1
    save('WBdataset_steadyNclipMods_S1S2S3.mat')
end
