...
%% WB kin MODs
    ...
    saveas(gca,['WBmod_dArea_',num2str(n_dArea),'WBs.fig'])
    saveas(gca,['WBmod_dArea_',num2str(n_dArea),'WBs.png'])
    plot2svg(['WBmod_dArea_',num2str(n_dArea),'WBs.svg'])
    
    plot_WBmodNsteady_dArea
    saveas(gca,['WBmodNsteady_dArea_',num2str(n_dArea),'WBs.fig'])
    saveas(gca,['WBmodNsteady_dArea_',num2str(n_dArea),'WBs.png'])
    plot2svg(['WBmodNsteady_dArea_',num2str(n_dArea),'WBs.svg'])
...
%% WB kin MODs
    ...
    saveas(gca,['WBmod_d2ndMom_',num2str(n_d2ndMom),'WBs.fig'])
    saveas(gca,['WBmod_d2ndMom_',num2str(n_d2ndMom),'WBs.png'])
    plot2svg(['WBmod_d2ndMom_',num2str(n_d2ndMom),'WBs.svg'])
    
    plot_WBmodNsteady_d2ndMom
    saveas(gca,['WBmodNsteady_d2ndMom_',num2str(n_d2ndMom),'WBs.fig'])
    saveas(gca,['WBmodNsteady_d2ndMom_',num2str(n_d2ndMom),'WBs.png'])
    plot2svg(['WBmodNsteady_d2ndMom_',num2str(n_d2ndMom),'WBs.svg'])
