...
Eqname=dir('roboflyDB_CutAndIntactWing_EqSolved*')
Eqname=Eqname.name;
load(Eqname)

MODname=dir('WBdataset_steadyNclipMods_S2S3funcs*')
...
%% plot dir
if plot_on == 1
    mkdir('steadyWBkinNwbMODkin_seqs_figs')
    cd('steadyWBkinNwbMODkin_seqs_figs')
end
...
%             end
            ...
            if plot_on == 1
                ...
                plot(stroke_S2S3funcIntact_now(:,1),'c','linewidth',2)
                plot(stroke_S2S3funcClipped_now(:,1),'m','linewidth',2)
%                 plot(stroke_steady(:,1),'g','linewidth',2)
                ...
                plot(rot_S2S3funcIntact_now(:,1)-90,'c','linewidth',2)
                plot(rot_S2S3funcClipped_now(:,1)-90,'m','linewidth',2)
%                 plot(rot_steady(:,1)-90,'g','linewidth',2)
                ...
                plot(dev_S2S3funcIntact_now(:,1),'c','linewidth',2)
                plot(dev_S2S3funcClipped_now(:,1),'m','linewidth',2)
...
%                 legend('clipped wing','intact wing','steady wingbeat','clipped MOD','intact MOD')
                legend('clipped wing','intact wing','clipped MOD','intact MOD')
                axis off
...
%                 saveas(gcf,['steadyWBkin_S2ratio=',num2str(round(100*S2_now)/100),'_S3ratio=',num2str(round(100*mean(ThirdMomentRatio_now))/100),'_Aratio=',num2str(round(100*mean(Astroke_ratio_clip_intact_now))/100),'_n=',num2str(length(seq_nr_now)),'.svg'])
                ...
                %% MEAN WBs
                subplot(2,2,1)
                plot(nanmean(stroke_clip_now,2),'r','linewidth',2)
                hold on
                plot(nanmean(stroke_intact_now,2),'b','linewidth',2)
                plot(stroke_S2S3funcIntact_now(:,1),'c','linewidth',2)
                plot(stroke_S2S3funcClipped_now(:,1),'m','linewidth',2)
%                 plot(stroke_steady(:,1),'g','linewidth',2)
                ylim([-90 90])
                ...
                subplot(2,2,2)
                plot(nanmean(pitch_wb_clip_now,2)-90,'r','linewidth',2)
                hold on
                plot(nanmean(pitch_wb_intact_now,2)-90,'b','linewidth',2)
                plot(rot_S2S3funcIntact_now(:,1)-90,'c','linewidth',2)
                plot(rot_S2S3funcClipped_now(:,1)-90,'m','linewidth',2)
%                 plot(rot_steady(:,1)-90,'g','linewidth',2)
                ylim([-90 90])
                ...
                subplot(2,2,3)
                plot(nanmean(dev_wb_clip_now,2),'r','linewidth',2)
                hold on
                plot(nanmean(dev_wb_intact_now,2),'b','linewidth',2)
                plot(dev_S2S3funcIntact_now(:,1),'c','linewidth',2)
                plot(dev_S2S3funcClipped_now(:,1),'m','linewidth',2)
%                 plot(dev_steady(:,1),'g','linewidth',2)
                ylim([-90 90])
...
%                 legend('clipped wing','intact wing','steady wingbeat','clipped MOD','intact MOD')
                ...
                saveas(gcf,['MEANsteadyWBkin_S2ratio=',num2str(round(100*S2_now)/100),'_S3ratio=',num2str(round(100*mean(ThirdMomentRatio_now))/100),'_Aratio=',num2str(round(100*mean(Astroke_ratio_clip_intact_now))/100),'_n=',num2str(length(seq_nr_now)),'.fig'])
                saveas(gcf,['MEANsteadyWBkin_S2ratio=',num2str(round(100*S2_now)/100),'_S3ratio=',num2str(round(100*mean(ThirdMomentRatio_now))/100),'_Aratio=',num2str(round(100*mean(Astroke_ratio_clip_intact_now))/100),'_n=',num2str(length(seq_nr_now)),'.png'])
%                 saveas(gcf,['MEANsteadyWBkin_S2ratio=',num2str(round(100*S2_now)/100),'_S3ratio=',num2str(round(100*mean(ThirdMomentRatio_now))/100),'_Aratio=',num2str(round(100*mean(Astroke_ratio_clip_intact_now))/100),'_n=',num2str(length(seq_nr_now)),'.svg'])
                plot2svg(['MEANsteadyWBkin_S2ratio=',num2str(round(100*S2_now)/100),'_S3ratio=',num2str(round(100*mean(ThirdMomentRatio_now))/100),'_Aratio=',num2str(round(100*mean(Astroke_ratio_clip_intact_now))/100),'_n=',num2str(length(seq_nr_now)),'.svg'])
