...
plot(Mpitch_mean_wb,pitch_wb_L_bins(n_loc,:),'.k')
plot(Mpitch_mean_wb,pitch_wb_R_bins(n_loc,:),'.k')
plot(Mpitch_PitchTorque,pitch_wb_L_PitchTorque_bins(n_loc,:),'.b')
plot(Mpitch_PitchTorque,pitch_wb_R_PitchTorque_bins(n_loc,:),'.b')

% plot trend
RC = pitchMOD_wb_PitchTorque_bins_meanCIstd(n_loc,1)/Mpitch_norm;
...
subplot(2,2,3)
plot(Mpitch_PitchTorque,pitchMOD_wb_L_PitchTorque_bins(n_loc,:),'.b')
plot(Mpitch_PitchTorque,pitchMOD_wb_R_PitchTorque_bins(n_loc,:),'.b')

% plot mean
RC = pitchMOD_wb_PitchTorque_bins_meanCIstd(n_loc,1);
