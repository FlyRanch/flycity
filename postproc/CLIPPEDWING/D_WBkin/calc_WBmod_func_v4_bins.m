...
%         counter = 100*(size(n_down_start_L,2)-seq) +size(n_down_start_L,1) -wb
        ...
        rollaccel_mean_wb_now = roll_dot_dot_mean_wb(wb,seq);
        pitchaccel_mean_wb_now = pitch_dot_dot_mean_wb(wb,seq);
        yawaccel_mean_wb_now = yaw_dot_dot_mean_wb(wb,seq);
        Fenhance_mean_wb_now = F_mean_wb(wb,seq);

        rollvel_mean_wb_now = roll_dot_mean_wb(wb,seq);
        pitchvel_mean_wb_now = pitch_dot_mean_wb(wb,seq);
        yawvel_mean_wb_now = yaw_dot_mean_wb(wb,seq);
