...
subplot(2,2,3)
plot(FirstMomentRatio,f_wb_L,'.g')
plot(FirstMomentRatio,f_wb_R,'.g')
plot(FirstMomentRatio_d1stMom,f_wb_d1stMom,'.b')

% plot trend
RC = freqMOD_wb_d1stMom_meanCIstd(1);
x0 = xmax;
...
subplot(2,2,4)
plot(FirstMomentRatio_d1stMom,freqMOD_wb_d1stMom,'.b')
