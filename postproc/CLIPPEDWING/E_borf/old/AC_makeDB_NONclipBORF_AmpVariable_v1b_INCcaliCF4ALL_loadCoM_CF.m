...
legend('Fx','Fy','Fz fix','location','SW')
xlabel('Amp ratio')
ylabel('F/mg')
axis([0.75 1.25 -1.5 .25])
...
xlabel('Amp ratio')
ylabel('T/mgl')
axis([0.75 1.25 -.25 .25])
set(gca,'xtick',0.75:.25:1.25)
set(gca,'ytick',-1.5:.25:1.5)

saveas(gcf,['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_ALL_CF.fig'])
saveas(gcf,['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_ALL_CF.png'])
plot2svg(['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_ALL_CF.svg'])

%% save data
save('roboflyDB_AmpStrokeRatio_NONcutWing_INCcali_ALL_CF',...
    'Amp_ratio',...
    'Fx_norm',...
    'Fy_norm',...
    'Fz_norm',...
