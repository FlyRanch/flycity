...
if nanmax(diff(:)) == 0
    ...
    M_R_mean_allNOfreq = Mx_mean_allNOfreq * cosd(rot_axis_angle) + My_mean_allNOfreq * sind(rot_axis_angle);
    M_L_mean_allNOfreq = Mx_mean_allNOfreq * sind(rot_axis_angle) - My_mean_allNOfreq * cosd(rot_axis_angle);
    
    M_axis1_mean_allNOfreq = Mx_mean_allNOfreq * cosd(rot1_axis_angle) + My_mean_allNOfreq * sind(rot1_axis_angle);
    M_axis1normal_mean_allNOfreq = Mx_mean_allNOfreq * sind(rot1_axis_angle) - My_mean_allNOfreq * cosd(rot1_axis_angle);
    
    M_axis2_mean_allNOfreq = Mx_mean_allNOfreq * cosd(rot2_axis_angle) + My_mean_allNOfreq * sind(rot2_axis_angle);
    M_axis2normal_mean_allNOfreq = Mx_mean_allNOfreq * sind(rot2_axis_angle) - My_mean_allNOfreq * cosd(rot2_axis_angle);
    ...
    M_R_allNOfreq = Mx_allNOfreq * cosd(rot_axis_angle) + My_allNOfreq * sind(rot_axis_angle);
    M_L_allNOfreq = Mx_allNOfreq * sind(rot_axis_angle) - My_allNOfreq * cosd(rot_axis_angle);
    
    M_axis1_allNOfreq = Mx_allNOfreq * cosd(rot1_axis_angle) + My_allNOfreq * sind(rot1_axis_angle);
    M_axis1normal_allNOfreq = Mx_allNOfreq * sind(rot1_axis_angle) - My_allNOfreq * cosd(rot1_axis_angle);
    
    M_axis2_allNOfreq = Mx_allNOfreq * cosd(rot2_axis_angle) + My_allNOfreq * sind(rot2_axis_angle);
    M_axis2normal_allNOfreq = Mx_allNOfreq * sind(rot2_axis_angle) - My_allNOfreq * cosd(rot2_axis_angle);
else
    error = 'allNOfreq'
    pause
end
...
if nanmax(diff(:)) == 0
    ...
    M_axis1_mean_stroke = Mx_mean_stroke * cosd(rot1_axis_angle) + My_mean_stroke * sind(rot1_axis_angle);
    M_axis1normal_mean_stroke = Mx_mean_stroke * sind(rot1_axis_angle) - My_mean_stroke * cosd(rot1_axis_angle);

    M_axis2_mean_stroke = Mx_mean_stroke * cosd(rot2_axis_angle) + My_mean_stroke * sind(rot2_axis_angle);
    M_axis2normal_mean_stroke = Mx_mean_stroke * sind(rot2_axis_angle) - My_mean_stroke * cosd(rot2_axis_angle);
    ...
    M_axis1_stroke = Mx_stroke * cosd(rot1_axis_angle) + My_stroke * sind(rot1_axis_angle);
    M_axis1normal_stroke = Mx_stroke * sind(rot1_axis_angle) - My_stroke * cosd(rot1_axis_angle);
    
    M_axis2_stroke = Mx_stroke * cosd(rot2_axis_angle) + My_stroke * sind(rot2_axis_angle);
    M_axis2normal_stroke = Mx_stroke * sind(rot2_axis_angle) - My_stroke * cosd(rot2_axis_angle);
else
    error = 'stroke'
    pause
end
...
if nanmax(diff(:)) == 0
    ...
    M_axis1_mean_pitch = Mx_mean_pitch * cosd(rot1_axis_angle) + My_mean_pitch * sind(rot1_axis_angle);
    M_axis1normal_mean_pitch = Mx_mean_pitch * sind(rot1_axis_angle) - My_mean_pitch * cosd(rot1_axis_angle);
    
    M_axis2_mean_pitch = Mx_mean_pitch * cosd(rot2_axis_angle) + My_mean_pitch * sind(rot2_axis_angle);
    M_axis2normal_mean_pitch = Mx_mean_pitch * sind(rot2_axis_angle) - My_mean_pitch * cosd(rot2_axis_angle);
    ...
    M_axis1_pitch = Mx_pitch * cosd(rot1_axis_angle) + My_pitch * sind(rot1_axis_angle);
    M_axis1normal_pitch = Mx_pitch * sind(rot1_axis_angle) - My_pitch * cosd(rot1_axis_angle);
    
    M_axis2_pitch = Mx_pitch * cosd(rot2_axis_angle) + My_pitch * sind(rot2_axis_angle);
    M_axis2normal_pitch = Mx_pitch * sind(rot2_axis_angle) - My_pitch * cosd(rot2_axis_angle);
else
    error = 'pitch'
    pause
end
...
if nanmax(diff(:)) == 0
    ...
    M_axis1_mean_dev = Mx_mean_dev * cosd(rot1_axis_angle) + My_mean_dev * sind(rot1_axis_angle);
    M_axis1normal_mean_dev = Mx_mean_dev * sind(rot1_axis_angle) - My_mean_dev * cosd(rot1_axis_angle);
    
    M_axis2_mean_dev = Mx_mean_dev * cosd(rot2_axis_angle) + My_mean_dev * sind(rot2_axis_angle);
    M_axis2normal_mean_dev = Mx_mean_dev * sind(rot2_axis_angle) - My_mean_dev * cosd(rot2_axis_angle);
    ...
    M_axis1_dev = Mx_dev * cosd(rot1_axis_angle) + My_dev * sind(rot1_axis_angle);
    M_axis1normal_dev = Mx_dev * sind(rot1_axis_angle) - My_dev * cosd(rot1_axis_angle);
    
    M_axis2_dev = Mx_dev * cosd(rot2_axis_angle) + My_dev * sind(rot2_axis_angle);
    M_axis2normal_dev = Mx_dev * sind(rot2_axis_angle) - My_dev * cosd(rot2_axis_angle);
else
    error = 'dev'
    pause
end
...
M_axis1_steady = M_axis1_mean_allNOfreq(mod_value_allNOfreq == 0);
M_axis1normal_steady = M_axis1normal_mean_allNOfreq(mod_value_allNOfreq == 0);
M_axis2_steady = M_axis2_mean_allNOfreq(mod_value_allNOfreq == 0);
M_axis2normal_steady = M_axis2normal_mean_allNOfreq(mod_value_allNOfreq == 0);
