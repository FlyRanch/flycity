...
%         stroke_cut = kine(n_start:n_stop,6);
%         rot_intact = kine(n_start:n_stop,1);
%         rot_cut = kine(n_start:n_stop,4);
%         dev_intact = kine(n_start:n_stop,2);
%         dev_cut = kine(n_start:n_stop,3);
...
saveas(gcf,['FvsS2_MvsS3_robofly_CutWing_NOcali.png'])
