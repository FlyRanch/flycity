...
subplot(2,2,1)
hold on
plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_sum(subset_allNOfreq)-Mz_mean_sum(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-ok','linewidth',1,'markersize',5,'markerfacecolor','k')
...
% plot(Myaw_norm*mod_value_freq(subset_freq),(Mz_mean_freq(subset_freq)-Mz_mean_freq(mod_value_freq==0))/Mg_fly/Lwing,'-oc','linewidth',1,'markersize',5,'markerfacecolor','c')
...
plot(Myaw_norm*mod_value_pitch(subset_pitch),(Mz_mean_pitch(subset_pitch)-Mz_mean_pitch(mod_value_pitch==0))/Mg_fly/Lwing,'-og','linewidth',1,'markersize',5,'markerfacecolor','g')
...
subplot(2,2,3)
hold on
plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_allNOfreq(subset_allNOfreq)-Mz_mean_allNOfreq(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-o','color',[1 .5 0],'linewidth',1,'markersize',5,'markerfacecolor',[1 .5 0])
