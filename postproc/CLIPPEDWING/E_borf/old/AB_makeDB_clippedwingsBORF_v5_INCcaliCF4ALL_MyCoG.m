...
d_norm_mean = mean(d_norm);
d_norm_steady = d_norm(cut_type==0);
...
%% plot F-S2 & Mx&Mz-S3 & My-S1 (due to not measureming at CoG)
% F-S2
figure
subplot(1,3,1)
hold on
...
% plot(S3_ratio(cut_type==0),My_norm(cut_type==0)-My_norm(cut_type==0),'sk','markerfacecolor','r')
% plot(S3_ratio(cut_type==1),My_norm(cut_type==1)-My_norm(cut_type==0),'ok','markerfacecolor','r')
% plot(S3_ratio(cut_type==2),My_norm(cut_type==2)-My_norm(cut_type==0),'dk','markerfacecolor','r')
...
% legend('Mx* Tip','Mx* TE','Mz* Tip','Mz* TE')
...
% plot(S1_ratio(cut_type==0),Mx_norm(cut_type==0)-Mx_norm(cut_type==0),'sk','markerfacecolor','b')
% plot(S1_ratio(cut_type==1),Mx_norm(cut_type==1)-Mx_norm(cut_type==0),'ok','markerfacecolor','b')
% plot(S1_ratio(cut_type==2),Mx_norm(cut_type==2)-Mx_norm(cut_type==0),'dk','markerfacecolor','b')
% 
% plot(S1_ratio(cut_type==0),My_norm(cut_type==0)-My_norm(cut_type==0),'sk','markerfacecolor','r')
% plot(S1_ratio(cut_type==1),My_norm(cut_type==1)-My_norm(cut_type==0),'ok','markerfacecolor','r')
% plot(S1_ratio(cut_type==2),My_norm(cut_type==2)-My_norm(cut_type==0),'dk','markerfacecolor','r')
% 
% plot(S1_ratio(cut_type==0),Mz_norm(cut_type==0)-Mz_norm(cut_type==0),'sk','markerfacecolor','g')
% plot(S1_ratio(cut_type==1),Mz_norm(cut_type==1)-Mz_norm(cut_type==0),'ok','markerfacecolor','g')
% plot(S1_ratio(cut_type==2),Mz_norm(cut_type==2)-Mz_norm(cut_type==0),'dk','markerfacecolor','g')


plot(S1_ratio(cut_type==0),My_norm(cut_type==0),'sk','markerfacecolor','r')
plot(S1_ratio(cut_type==1),My_norm(cut_type==1),'ok','markerfacecolor','r')
plot(S1_ratio(cut_type==2),My_norm(cut_type==2),'dk','markerfacecolor','r')
...
plot([min(S1_ratio) max(S1_ratio)],polyval(My_S1_fit,[min(S1_ratio) max(S1_ratio)]),'k')
...
saveas(gcf,['FvsS2_MxnMzvsS3_MyvsS1_robofly_CutWing_INCcali.fig'])
saveas(gcf,['FvsS2_MxnMzvsS3_MyvsS1_robofly_CutWing_INCcali.png'])
plot2svg(['FvsS2_MxnMzvsS3_MyvsS1_robofly_CutWing_INCcali.svg'])
...
saveas(gcf,['FvsS2_MvsS3_MyAtCoG_robofly_CutWing_INCcali.fig'])
saveas(gcf,['FvsS2_MvsS3_MyAtCoG_robofly_CutWing_INCcali.png'])
plot2svg(['FvsS2_MvsS3_MyAtCoG_robofly_CutWing_INCcali.svg'])
...
saveas(gcf,['FnMvsS1S2S3_robofly_CutWing_INCcali.fig'])
saveas(gcf,['FnMvsS1S2S3_robofly_CutWing_INCcali.png'])
plot2svg(['FnMvsS1S2S3_robofly_CutWing_INCcali.svg'])
