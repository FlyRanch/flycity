...
saveas(gcf,['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_ALL.fig'])
saveas(gcf,['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_ALL.png'])
plot2svg(['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_ALL.svg'])

%% save data
save('roboflyDB_AmpStrokeRatio_NONcutWing_INCcali_ALL',...
    'Amp_ratio',...
    'Fx_norm',...
    'Fy_norm',...
    'Fz_norm',...
