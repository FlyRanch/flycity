...
% plot(mod_value_allNOfreq,M_axis2_mean_allNOfreq,'-c.')
% plot(mod_value_allNOfreq,M_axis2normal_mean_allNOfreq,'-m.')
...
plot(mod_value_allNOfreq,M_axis2_mean_allNOfreq-M_axis2_steady,'-c.')
plot(mod_value_allNOfreq,M_axis2normal_mean_allNOfreq-M_axis2normal_steady,'-m.')

legend('Mroll','Mpitch','Myaw','Maxis2','Maxis2normal','location','nw')
grid on
xlabel('MOD value')
ylabel('M')
...
% plot(mod_value_stroke,M_axis2_mean_stroke,'-c.')
% plot(mod_value_stroke,M_axis2normal_mean_stroke,'-m.')
...
plot(mod_value_stroke,M_axis2_mean_stroke-M_axis2_steady,'-c.')
plot(mod_value_stroke,M_axis2normal_mean_stroke-M_axis2normal_steady,'-m.')
...
% plot(mod_value_pitch,M_axis2_mean_pitch,'-c.')
% plot(mod_value_pitch,M_axis2normal_mean_pitch,'-m.')
...
plot(mod_value_pitch,M_axis2_mean_pitch-M_axis2_steady,'-c.')
plot(mod_value_pitch,M_axis2normal_mean_pitch-M_axis2normal_steady,'-m.')
...
% plot(mod_value_dev,M_axis2_mean_dev,'-c.')
% plot(mod_value_dev,M_axis2normal_mean_dev,'-m.')
...
plot(mod_value_dev,M_axis2_mean_dev-M_axis2_steady,'-c.')
plot(mod_value_dev,M_axis2normal_mean_dev-M_axis2normal_steady,'-m.')
...
figure
hold on
plot(mod_value_allNOfreq,M_axis2_mean_allNOfreq-M_axis2_steady,'-k.')
% plot(mod_value_freq,M_axis2_mean_freq-M_axis2_steady,'-r.')
plot(mod_value_stroke,M_axis2_mean_stroke-M_axis2_steady,'-g.')
plot(mod_value_pitch,M_axis2_mean_pitch-M_axis2_steady,'-b.')
plot(mod_value_dev,M_axis2_mean_dev-M_axis2_steady,'-c.')
plot(mod_value_allNOfreq(1:MODmin),M_axis2_mean_sum-M_axis2_mean_sum_steady,'-ok')
