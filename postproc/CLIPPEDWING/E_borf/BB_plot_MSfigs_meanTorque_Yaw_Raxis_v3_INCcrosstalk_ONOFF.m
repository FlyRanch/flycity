...
subplot(2,2,1)
hold on
plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_sum(subset_allNOfreq))/Mg_fly/Lwing,'-ok','linewidth',1,'markersize',5,'markerfacecolor','k')
plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_allNOfreq(subset_allNOfreq))/Mg_fly/Lwing,'-or','linewidth',1,'markersize',5,'markerfacecolor','r')
% plot(Myaw_norm*mod_value_freq(subset_freq),(Mz_mean_freq(subset_freq))/Mg_fly/Lwing,'-oc','linewidth',1,'markersize',5,'markerfacecolor','c')
plot(Myaw_norm*mod_value_stroke(subset_stroke),(Mz_mean_stroke(subset_stroke))/Mg_fly/Lwing,'-ob','linewidth',1,'markersize',5,'markerfacecolor','b')
plot(Myaw_norm*mod_value_pitch(subset_pitch),(Mz_mean_pitch(subset_pitch))/Mg_fly/Lwing,'-og','linewidth',1,'markersize',5,'markerfacecolor','g')
plot(Myaw_norm*mod_value_dev(subset_dev),(Mz_mean_dev(subset_dev))/Mg_fly/Lwing,'-om','linewidth',1,'markersize',5,'markerfacecolor','m')
...
subplot(2,2,3)
hold on
plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_allNOfreq(subset_allNOfreq))/Mg_fly/Lwing,'-o','color',[.5 .5 .5],'linewidth',1,'markersize',5,'markerfacecolor',[.5 .5 .5])
...
% plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(M_L_mean_allNOfreq(subset_allNOfreq)-M_L_mean_allNOfreq(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-o','color',[1 .5 0],'linewidth',1,'markersize',5,'markerfacecolor',[1 .5 0])
plot(Myaw_norm*mod_value_allNOfreq(subset_allNOfreq),(Mx_mean_allNOfreq(subset_allNOfreq))/Mg_fly/Lwing,'-o','color','r','linewidth',1,'markersize',5,'markerfacecolor','r')
...
subplot(2,2,2)
hold on
plot(M_R_norm*mod_value_allNOfreq(subset_allNOfreq),(M_R_mean_sum(subset_allNOfreq)-M_R_mean_sum(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-ok','linewidth',1,'markersize',5,'markerfacecolor','k')
...
subplot(2,2,4)
hold on
% plot(M_R_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_allNOfreq(subset_allNOfreq)-Mz_mean_allNOfreq(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-o','color',[1 .5 0],'linewidth',1,'markersize',5,'markerfacecolor',[1 .5 0])
...
plot(M_R_norm*mod_value_allNOfreq(subset_allNOfreq),(Mz_mean_allNOfreq(subset_allNOfreq))/Mg_fly/Lwing,'-o','color',[.5 .5 .5],'linewidth',1,'markersize',5,'markerfacecolor',[.5 .5 .5])
plot(M_R_norm*mod_value_allNOfreq(subset_allNOfreq),(M_R_mean_allNOfreq(subset_allNOfreq)-M_R_mean_allNOfreq(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-o','color',[0 .5 1],'linewidth',1,'markersize',5,'markerfacecolor',[0 .5 1])
plot(M_R_norm*mod_value_allNOfreq(subset_allNOfreq),(M_L_mean_allNOfreq(subset_allNOfreq)-M_L_mean_allNOfreq(mod_value_allNOfreq==0))/Mg_fly/Lwing,'-o','color',[1 .5 0],'linewidth',1,'markersize',5,'markerfacecolor',[1 .5 0])
% plot(M_R_norm*mod_value_allNOfreq(subset_allNOfreq),(Mx_mean_allNOfreq(subset_allNOfreq))/Mg_fly/Lwing,'-o','color','r','linewidth',1,'markersize',5,'markerfacecolor','r')
