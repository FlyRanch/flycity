        ...
        stroke_clipped = round(radtodeg(kine(:,6)));
        
        if stroke_intact == stroke_clipped
        else
            ERROR = 1
            return
        end
        ...
        fy_series =   ft(:,3) - fy_cali_L - fy_cali_R;  % thrust, fwd pos
        fz_series =  -ft(:,2) - fz_cali_L - fz_cali_R;  % thrust, fwd pos

        mx_series =   ft(:,4) - mx_cali_L - mx_cali_R;  % thrust, fwd pos
        my_series =   ft(:,6) - my_cali_L - my_cali_R;  % thrust, fwd pos
        mz_series =  -ft(:,5) - mz_cali_L - mz_cali_R;  % thrust, fwd pos
