...
% F0 of single wing (F0 @ steady flight/2)
Fd0 = (pFd10 + pFd11 + pFd01 + pFd00)/2;
Fi0 = Fd0;
F0 = Fd0;

% M0 of single wing (damaged wing at A*=0)
Md0 = pMd01 + pMd00;
Mi0 = Md0;
M0 = Md0;
...
eqnFA =   pFd10*Ad + pFd11*Ad*S2 + pFd01*S2 + pFd00 - Fd0...
        + pFd10*Ai + pFd11*Ai    + pFd01    + pFd00 - Fi0...
        == -1;
    
% roll torque balance
eqnMA = - pMd10*Ad - pMd11*Ad*S3 - pMd01*S3 - pMd00...
        + pMd10*Ai + pMd11*Ai    + pMd01    + pMd00...
        == 0;
  
% solve Amp as function of S2 & S3 
[solAi, solAd] = solve(eqnFA,eqnMA,Ai,Ad);

solAdAiRatio = solAd/solAi;
...
% vertical force balace
solFtot = pFd10*solAd + pFd11*solAd*S2 + pFd01*S2 + pFd00 - Fd0...
        + pFd10*solAi + pFd11*solAi    + pFd01    + pFd00 - Fi0;
    
solFd   = pFd10*solAd + pFd11*solAd*S2 + pFd01*S2 + pFd00 - Fd0;
solFi   = pFd10*solAi + pFd11*solAi    + pFd01    + pFd00 - Fi0;

% roll torque balance
solMtot = - pMd10*solAd - pMd11*solAd*S3 - pMd01*S3 - pMd00...
          + pMd10*solAi + pMd11*solAi    + pMd01    + pMd00;

solMd   = - pMd10*solAd - pMd11*solAd*S3 - pMd01*S3 - pMd00;
solMi   =   pMd10*solAi + pMd11*solAi    + pMd01    + pMd00;
