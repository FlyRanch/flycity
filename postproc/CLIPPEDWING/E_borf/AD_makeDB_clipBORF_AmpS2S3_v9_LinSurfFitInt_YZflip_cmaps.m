...
if plot_on == 1
    ...
    % @ steady wb frequency
    close all
    plot_clipped_FnM_vs_StrokeAmp_vs_S2nS3_SurfFits_YnZflip
...
%     saveas(gcf,'TorqueVsStrokeAmpVsS3_LinSurfFitInterac_minSteady_MyAtCoM_freqSteadyWB.svg')
    ...
    figure(3)
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.fig')
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.png')
%     saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.svg')
    plot2svg('FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.svg')
    
    figure(4)
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.fig')
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.png')
%     saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.svg')
    plot2svg('Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB.svg')
    
    figure(5)
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.fig')
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.png')
%     saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.svg')
%     plot2svg('FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.svg')
    
    figure(6)
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.fig')
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.png')
%     saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.svg')
%     plot2svg('Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_SURF.svg')
    
    figure(7)
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.fig')
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.png')
%     saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.svg')
    plot2svg('FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.svg')
    
    figure(8)
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.fig')
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.png')
%     saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.svg')
    plot2svg('Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_freqSteadyWB_DATAPOINTS.svg')
    
    % @ clipped fly wb frequency
    close all
    plot_clipped_FnM_vs_AmpnS2nS3_SurfFits_ClipFlyWBfreq_YnZflip
...
%     saveas(gcf,'TorqueVsStrokeAmpVsS3_LinSurfFitInterac_minSteady_MyAtCoM_ClipFlyWBfreq.svg')
    ...
    figure(3)
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.fig')
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.png')
%     saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.svg')
    plot2svg('FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.svg')
    
    figure(4)
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.fig')
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.png')
%     saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.svg')
    plot2svg('Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq.svg')

    figure(5)
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.fig')
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.png')
%     saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.svg')
%     plot2svg('FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.svg')
    
    figure(6)
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.fig')
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.png')
%     saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.svg')
%     plot2svg('Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_SURF.svg')

    figure(7)
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.fig')
    saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.png')
%     saveas(gcf,'FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.svg')
    plot2svg('FzFlip_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.svg')
    
    figure(8)
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.fig')
    saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.png')
%     saveas(gcf,'Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.svg')
    plot2svg('Mx_vs_StrokeAmp_vs_S2S3_LinSurfFitInterac_MxminSteady_ClipFlyWBfreq_DATAPOINTS.svg')
