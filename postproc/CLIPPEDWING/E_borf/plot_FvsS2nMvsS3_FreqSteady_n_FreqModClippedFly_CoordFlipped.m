...
% non-cut
plot(S2_ratio(cut_type==0),Fx_norm(cut_type==0),'sk','markersize',9,'markerfacecolor','b')
plot(S2_ratio(cut_type==0),-Fy_norm(cut_type==0),'sk','markersize',9,'markerfacecolor','r')
plot(S2_ratio(cut_type==0),-Fz_norm(cut_type==0),'sk','markersize',9,'markerfacecolor','g')

plot(S2_ratio(cut_type==0),Fx_norm_freqMod(cut_type==0),'sk','markersize',9,'markerfacecolor','c')
plot(S2_ratio(cut_type==0),-Fy_norm_freqMod(cut_type==0),'sk','markersize',9,'markerfacecolor',[1 .5 0])
plot(S2_ratio(cut_type==0),-Fz_norm_freqMod(cut_type==0),'sk','markersize',9,'markerfacecolor',[0 .5 0])
...
% steady freq
plot(S3_ratio(cut_type==0),Mx_norm(cut_type==0)-Mx_norm(cut_type==0),'sk','markersize',9,'markerfacecolor','b')
...
plot(S3_ratio(cut_type==0),-My_norm_CoM(cut_type==0),'sk','markersize',9,'markerfacecolor','r')
...
plot(S3_ratio(cut_type==0),-Mz_norm(cut_type==0)+Mz_norm(cut_type==0),'sk','markersize',9,'markerfacecolor','g')
...
% clipped fly freq
plot(S3_ratio(cut_type==0),Mx_norm_freqMod(cut_type==0)-Mx_norm_freqMod(cut_type==0),'sk','markersize',9,'markerfacecolor','c')
...
plot(S3_ratio(cut_type==0),-My_norm_freqMod_CoM(cut_type==0),'sk','markersize',9,'markerfacecolor',[1 .5 0])
...
plot(S3_ratio(cut_type==0),-Mz_norm_freqMod(cut_type==0)+Mz_norm_freqMod(cut_type==0),'sk','markersize',9,'markerfacecolor',[0 .5 0])
