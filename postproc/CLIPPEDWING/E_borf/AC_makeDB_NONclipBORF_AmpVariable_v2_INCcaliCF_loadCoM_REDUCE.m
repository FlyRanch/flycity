...
saveas(gcf,['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_REDUCE.fig'])
saveas(gcf,['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_REDUCE.png'])
plot2svg(['FnMvsAmpStrokeRatio_MyAtCoG_robofly_NONcutWing_INCcali_REDUCE.svg'])
