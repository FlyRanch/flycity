...
prog_loc = prog_loc(1:file_seps(end));

add_paths = {...
             [prog_loc,'WBKinProg_Johan']; ...
             [prog_loc,'WBKinProg_Johan',filesep,'Kalman_Filter']; ...
             [prog_loc,'WBKinProg_Johan',filesep,'Plot']; ...
             [prog_loc,'WBKinProg_Johan',filesep,'Plot',filesep,'Smoothing_plots']; ... % };
             [prog_loc,'WBKinProg_Johan',filesep,'Body_model']; ...
             [prog_loc,'WBKinProg_Johan',filesep,'Body_model',filesep,'mex']; ...
             [prog_loc,'WBKinProg_Johan',filesep,'Type2Regression'];...
             };

% add_paths = {...
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan'; ...
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan/Kalman_Filter'; ...
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan/Plot'; ...
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan/Plot/Smoothing_plots'; ... % };
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan/Body_model'; ...
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan/Body_model/mex'; ...
%              '/home/florian/GitHub/flycity/postproc/AA_check_wbkin/WBKinProg_Johan/Type2Regression';...
%              };
...
if exist('pathDB5.mat')==2
    ...
    temp = Wing_ref_frame_NOsave(settings,pathDB);
%     temp = load('pathDB5.mat');
...
cd ..
seq_now = dir_now;
save([dir_now,'_KinData.mat'],'pathDB','settings','seq_now')
