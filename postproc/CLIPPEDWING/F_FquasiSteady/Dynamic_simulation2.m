...
% %     % Plot IC:
% %     
% %     Fly_plot_3D( body_IC.xyz_0, quat2mat(body_IC.qb_0), kine_avg.RL(:,:,1), kine_avg.RR(:,:,1), body_model, wing_model )
%     
...
%     n = 1;
%     
%     [n] = plot_dyn_sim( sim_data, case_nr, n );
%     
%     clear body_IC case_nr options
    
    
%     % Step 5: Test conservation of momentum
%     
%     % Body IC:
%     
%     body_IC.xyz_0   = [0; 0; 0];
%     body_IC.qb_0    = quat2mat((R_strk'*[1 0 0; 0 -1 0; 0 0 -1]))';
%     body_IC.vb_0    = sim_data.vb_0(:,1);
%     body_IC.wb_0    = sim_data.wb_0(:,1);
%     body_IC.F_0     = [0; 0; 0];
%     body_IC.M_0     = [0; 0; 0];
%     
%     clear sim_data
...
%     toc
%     
%     [n] = plot_dyn_sim( sim_data, 0, n+1 );
%     
%     clear body_IC case_nr options


    % Step 5: Average wingbeat
