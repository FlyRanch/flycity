...
%% constants
% center of pressure-center of mass distance (vertical)
h_CoP_CoM = .4/2.8 * body_model.length % mm, based on Ristroph et al, 2013
body_model.h_CoP_CoM = h_CoP_CoM;

% CoP_strokeplane = body_model.R_strk*body_model.Joint_left';
% CoM_strokeplane = body_model.R_strk*body_model.cg';
% h_CoP_CoM = CoM_strokeplane(3) - CoP_strokeplane(3) % mm
% body_model.h_CoP_CoM = h_CoP_CoM;
...
%     freq = f_clipped_fly;
    ...
    Fx_intact_freqStrokeMOD = FM_strkpln.FM_L.Fx_strkpln_L;
    Fy_intact_freqStrokeMOD = FM_strkpln.FM_L.Fy_strkpln_L;
    Fz_intact_freqStrokeMOD = FM_strkpln.FM_L.Fz_strkpln_L;
    
    Mx_intact_freqStrokeMOD = FM_strkpln.FM_L.Mx_strkpln_L;
    My_intact_freqStrokeMOD = FM_strkpln.FM_L.My_strkpln_L;
    Mz_intact_freqStrokeMOD = FM_strkpln.FM_L.Mz_strkpln_L;
    
    Fx_damaged_freqStrokeMOD = FM_strkpln.FM_R.Fx_strkpln_R;
    Fy_damaged_freqStrokeMOD = FM_strkpln.FM_R.Fy_strkpln_R;
    Fz_damaged_freqStrokeMOD = FM_strkpln.FM_R.Fz_strkpln_R;
    
    Mx_damaged_freqStrokeMOD = FM_strkpln.FM_R.Mx_strkpln_R;
    My_damaged_freqStrokeMOD = FM_strkpln.FM_R.My_strkpln_R;
    Mz_damaged_freqStrokeMOD = FM_strkpln.FM_R.Mz_strkpln_R;
    
    Fx_NONdamaged_freqStrokeMOD = FM_strkpln.FM_R.Fx_strkpln_R;
    Fy_NONdamaged_freqStrokeMOD = FM_strkpln.FM_R.Fy_strkpln_R;
    Fz_NONdamaged_freqStrokeMOD = FM_strkpln.FM_R.Fz_strkpln_R;
    
    Mx_NONdamaged_freqStrokeMOD = FM_strkpln.FM_R.Mx_strkpln_R;
    My_NONdamaged_freqStrokeMOD = FM_strkpln.FM_R.My_strkpln_R;
    Mz_NONdamaged_freqStrokeMOD = FM_strkpln.FM_R.Mz_strkpln_R;
    
    % remove forces and torques at removed part of wing (n>N_cut)
    Fx_damaged_freqStrokeMOD(N_cut+1:end,:) = nan;
    Fy_damaged_freqStrokeMOD(N_cut+1:end,:) = nan;
    Fz_damaged_freqStrokeMOD(N_cut+1:end,:) = nan;
    
    Mx_damaged_freqStrokeMOD(N_cut+1:end,:) = nan;
    My_damaged_freqStrokeMOD(N_cut+1:end,:) = nan;
    Mz_damaged_freqStrokeMOD(N_cut+1:end,:) = nan;

    % total force & torque damaged & intact wing
    Fx_damagedwing_freqStrokeMOD(:,i) = (nansum(Fx_damaged_freqStrokeMOD,1))' / Mg_fly;
    Fy_damagedwing_freqStrokeMOD(:,i) = (nansum(Fy_damaged_freqStrokeMOD,1))' / Mg_fly;
    Fz_damagedwing_freqStrokeMOD(:,i) = (nansum(Fz_damaged_freqStrokeMOD,1))' / Mg_fly;
    
    Mx_damagedwing_freqStrokeMOD(:,i) = (nansum(Mx_damaged_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    My_damagedwing_freqStrokeMOD(:,i) = (nansum(My_damaged_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_damagedwing_freqStrokeMOD(:,i) = (nansum(Mz_damaged_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    
    Fx_intactwing_freqStrokeMOD(:,i) = (nansum(Fx_intact_freqStrokeMOD,1))' / Mg_fly;
    Fy_intactwing_freqStrokeMOD(:,i) = (nansum(Fy_intact_freqStrokeMOD,1))' / Mg_fly;
    Fz_intactwing_freqStrokeMOD(:,i) = (nansum(Fz_intact_freqStrokeMOD,1))' / Mg_fly;
    
    Mx_intactwing_freqStrokeMOD(:,i) = (nansum(Mx_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    My_intactwing_freqStrokeMOD(:,i) = (nansum(My_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_intactwing_freqStrokeMOD(:,i) = (nansum(Mz_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);

    % total force & torque
    Fx_damaged_total_freqStrokeMOD(:,i) = (nansum(Fx_damaged_freqStrokeMOD,1) + nansum(Fx_intact_freqStrokeMOD,1))' / Mg_fly;
    Fy_damaged_total_freqStrokeMOD(:,i) = (nansum(Fy_damaged_freqStrokeMOD,1) + nansum(Fy_intact_freqStrokeMOD,1))' / Mg_fly;
    Fz_damaged_total_freqStrokeMOD(:,i) = (nansum(Fz_damaged_freqStrokeMOD,1) + nansum(Fz_intact_freqStrokeMOD,1))' / Mg_fly;
    
    Mx_damaged_total_freqStrokeMOD(:,i) = (nansum(Mx_damaged_freqStrokeMOD,1) + nansum(Mx_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    My_damaged_total_freqStrokeMOD(:,i) = (nansum(My_damaged_freqStrokeMOD,1) + nansum(My_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_damaged_total_freqStrokeMOD(:,i) = (nansum(Mz_damaged_freqStrokeMOD,1) + nansum(Mz_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    
    Fx_NONdamaged_total_freqStrokeMOD(:,i) = (nansum(Fx_NONdamaged_freqStrokeMOD,1) + nansum(Fx_intact_freqStrokeMOD,1))' / Mg_fly;
    Fy_NONdamaged_total_freqStrokeMOD(:,i) = (nansum(Fy_NONdamaged_freqStrokeMOD,1) + nansum(Fy_intact_freqStrokeMOD,1))' / Mg_fly;
    Fz_NONdamaged_total_freqStrokeMOD(:,i) = (nansum(Fz_NONdamaged_freqStrokeMOD,1) + nansum(Fz_intact_freqStrokeMOD,1))' / Mg_fly;
    
    Mx_NONdamaged_total_freqStrokeMOD(:,i) = (nansum(Mx_NONdamaged_freqStrokeMOD,1) + nansum(Mx_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    My_NONdamaged_total_freqStrokeMOD(:,i) = (nansum(My_NONdamaged_freqStrokeMOD,1) + nansum(My_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_NONdamaged_total_freqStrokeMOD(:,i) = (nansum(Mz_NONdamaged_freqStrokeMOD,1) + nansum(Mz_intact_freqStrokeMOD,1))' / Mg_fly / (l_wing*1000);
    
    %% WB kin freq & stroke & dev MODs
%     freq = freq_steady;
%     freq = f_clipped_fly;
    freq = freq_now;
    ...
    Fx_intact_freqStrokeDevMOD = FM_strkpln.FM_L.Fx_strkpln_L;
    Fy_intact_freqStrokeDevMOD = FM_strkpln.FM_L.Fy_strkpln_L;
    Fz_intact_freqStrokeDevMOD = FM_strkpln.FM_L.Fz_strkpln_L;
    
    Mx_intact_freqStrokeDevMOD = FM_strkpln.FM_L.Mx_strkpln_L;
    My_intact_freqStrokeDevMOD = FM_strkpln.FM_L.My_strkpln_L;
    Mz_intact_freqStrokeDevMOD = FM_strkpln.FM_L.Mz_strkpln_L;
    
    Fx_damaged_freqStrokeDevMOD = FM_strkpln.FM_R.Fx_strkpln_R;
    Fy_damaged_freqStrokeDevMOD = FM_strkpln.FM_R.Fy_strkpln_R;
    Fz_damaged_freqStrokeDevMOD = FM_strkpln.FM_R.Fz_strkpln_R;
    
    Mx_damaged_freqStrokeDevMOD = FM_strkpln.FM_R.Mx_strkpln_R;
    My_damaged_freqStrokeDevMOD = FM_strkpln.FM_R.My_strkpln_R;
    Mz_damaged_freqStrokeDevMOD = FM_strkpln.FM_R.Mz_strkpln_R;
    
    Fx_NONdamaged_freqStrokeDevMOD = FM_strkpln.FM_R.Fx_strkpln_R;
    Fy_NONdamaged_freqStrokeDevMOD = FM_strkpln.FM_R.Fy_strkpln_R;
    Fz_NONdamaged_freqStrokeDevMOD = FM_strkpln.FM_R.Fz_strkpln_R;
    
    Mx_NONdamaged_freqStrokeDevMOD = FM_strkpln.FM_R.Mx_strkpln_R;
    My_NONdamaged_freqStrokeDevMOD = FM_strkpln.FM_R.My_strkpln_R;
    Mz_NONdamaged_freqStrokeDevMOD = FM_strkpln.FM_R.Mz_strkpln_R;
    
    % remove forces and torques at removed part of wing (n>N_cut)
    Fx_damaged_freqStrokeDevMOD(N_cut+1:end,:) = nan;
    Fy_damaged_freqStrokeDevMOD(N_cut+1:end,:) = nan;
    Fz_damaged_freqStrokeDevMOD(N_cut+1:end,:) = nan;
    
    Mx_damaged_freqStrokeDevMOD(N_cut+1:end,:) = nan;
    My_damaged_freqStrokeDevMOD(N_cut+1:end,:) = nan;
    Mz_damaged_freqStrokeDevMOD(N_cut+1:end,:) = nan;

    % total force & torque damaged & intact wing
    Fx_damagedwing_freqStrokeDevMOD(:,i) = (nansum(Fx_damaged_freqStrokeDevMOD,1))' / Mg_fly;
    Fy_damagedwing_freqStrokeDevMOD(:,i) = (nansum(Fy_damaged_freqStrokeDevMOD,1))' / Mg_fly;
    Fz_damagedwing_freqStrokeDevMOD(:,i) = (nansum(Fz_damaged_freqStrokeDevMOD,1))' / Mg_fly;
    
    Mx_damagedwing_freqStrokeDevMOD(:,i) = (nansum(Mx_damaged_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    My_damagedwing_freqStrokeDevMOD(:,i) = (nansum(My_damaged_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_damagedwing_freqStrokeDevMOD(:,i) = (nansum(Mz_damaged_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    
    Fx_intactwing_freqStrokeDevMOD(:,i) = (nansum(Fx_intact_freqStrokeDevMOD,1))' / Mg_fly;
    Fy_intactwing_freqStrokeDevMOD(:,i) = (nansum(Fy_intact_freqStrokeDevMOD,1))' / Mg_fly;
    Fz_intactwing_freqStrokeDevMOD(:,i) = (nansum(Fz_intact_freqStrokeDevMOD,1))' / Mg_fly;
    
    Mx_intactwing_freqStrokeDevMOD(:,i) = (nansum(Mx_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    My_intactwing_freqStrokeDevMOD(:,i) = (nansum(My_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_intactwing_freqStrokeDevMOD(:,i) = (nansum(Mz_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);

    % total force & torque
    Fx_damaged_total_freqStrokeDevMOD(:,i) = (nansum(Fx_damaged_freqStrokeDevMOD,1) + nansum(Fx_intact_freqStrokeDevMOD,1))' / Mg_fly;
    Fy_damaged_total_freqStrokeDevMOD(:,i) = (nansum(Fy_damaged_freqStrokeDevMOD,1) + nansum(Fy_intact_freqStrokeDevMOD,1))' / Mg_fly;
    Fz_damaged_total_freqStrokeDevMOD(:,i) = (nansum(Fz_damaged_freqStrokeDevMOD,1) + nansum(Fz_intact_freqStrokeDevMOD,1))' / Mg_fly;
    
    Mx_damaged_total_freqStrokeDevMOD(:,i) = (nansum(Mx_damaged_freqStrokeDevMOD,1) + nansum(Mx_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    My_damaged_total_freqStrokeDevMOD(:,i) = (nansum(My_damaged_freqStrokeDevMOD,1) + nansum(My_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_damaged_total_freqStrokeDevMOD(:,i) = (nansum(Mz_damaged_freqStrokeDevMOD,1) + nansum(Mz_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    
    Fx_NONdamaged_total_freqStrokeDevMOD(:,i) = (nansum(Fx_NONdamaged_freqStrokeDevMOD,1) + nansum(Fx_intact_freqStrokeDevMOD,1))' / Mg_fly;
    Fy_NONdamaged_total_freqStrokeDevMOD(:,i) = (nansum(Fy_NONdamaged_freqStrokeDevMOD,1) + nansum(Fy_intact_freqStrokeDevMOD,1))' / Mg_fly;
    Fz_NONdamaged_total_freqStrokeDevMOD(:,i) = (nansum(Fz_NONdamaged_freqStrokeDevMOD,1) + nansum(Fz_intact_freqStrokeDevMOD,1))' / Mg_fly;
    
    Mx_NONdamaged_total_freqStrokeDevMOD(:,i) = (nansum(Mx_NONdamaged_freqStrokeDevMOD,1) + nansum(Mx_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    My_NONdamaged_total_freqStrokeDevMOD(:,i) = (nansum(My_NONdamaged_freqStrokeDevMOD,1) + nansum(My_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
    Mz_NONdamaged_total_freqStrokeDevMOD(:,i) = (nansum(Mz_NONdamaged_freqStrokeDevMOD,1) + nansum(Mz_intact_freqStrokeDevMOD,1))' / Mg_fly / (l_wing*1000);
...
%     freq = freq_now;
    ...
    %% wingbeat average forces & torques: freq & stroke MOD
    Fx_damaged_mean_freqStrokeMOD = nanmean(Fx_damaged_total_freqStrokeMOD);
    Fy_damaged_mean_freqStrokeMOD = nanmean(Fy_damaged_total_freqStrokeMOD);
    Fz_damaged_mean_freqStrokeMOD = nanmean(Fz_damaged_total_freqStrokeMOD);
    
    Mx_damaged_mean_freqStrokeMOD = nanmean(Mx_damaged_total_freqStrokeMOD);
    My_damaged_mean_freqStrokeMOD = nanmean(My_damaged_total_freqStrokeMOD);
    Mz_damaged_mean_freqStrokeMOD = nanmean(Mz_damaged_total_freqStrokeMOD);
    
    Fx_NONdamaged_mean_freqStrokeMOD = nanmean(Fx_NONdamaged_total_freqStrokeMOD);
    Fy_NONdamaged_mean_freqStrokeMOD = nanmean(Fy_NONdamaged_total_freqStrokeMOD);
    Fz_NONdamaged_mean_freqStrokeMOD = nanmean(Fz_NONdamaged_total_freqStrokeMOD);
    
    Mx_NONdamaged_mean_freqStrokeMOD = nanmean(Mx_NONdamaged_total_freqStrokeMOD);
    My_NONdamaged_mean_freqStrokeMOD = nanmean(My_NONdamaged_total_freqStrokeMOD);
    Mz_NONdamaged_mean_freqStrokeMOD = nanmean(Mz_NONdamaged_total_freqStrokeMOD);

    %% wingbeat average forces & torques: freq & stroke & dev MOD
    Fx_damaged_mean_freqStrokeDevMOD = nanmean(Fx_damaged_total_freqStrokeDevMOD);
    Fy_damaged_mean_freqStrokeDevMOD = nanmean(Fy_damaged_total_freqStrokeDevMOD);
    Fz_damaged_mean_freqStrokeDevMOD = nanmean(Fz_damaged_total_freqStrokeDevMOD);
    
    Mx_damaged_mean_freqStrokeDevMOD = nanmean(Mx_damaged_total_freqStrokeDevMOD);
    My_damaged_mean_freqStrokeDevMOD = nanmean(My_damaged_total_freqStrokeDevMOD);
    Mz_damaged_mean_freqStrokeDevMOD = nanmean(Mz_damaged_total_freqStrokeDevMOD);
    
    Fx_NONdamaged_mean_freqStrokeDevMOD = nanmean(Fx_NONdamaged_total_freqStrokeDevMOD);
    Fy_NONdamaged_mean_freqStrokeDevMOD = nanmean(Fy_NONdamaged_total_freqStrokeDevMOD);
    Fz_NONdamaged_mean_freqStrokeDevMOD = nanmean(Fz_NONdamaged_total_freqStrokeDevMOD);
    
    Mx_NONdamaged_mean_freqStrokeDevMOD = nanmean(Mx_NONdamaged_total_freqStrokeDevMOD);
    My_NONdamaged_mean_freqStrokeDevMOD = nanmean(My_NONdamaged_total_freqStrokeDevMOD);
    Mz_NONdamaged_mean_freqStrokeDevMOD = nanmean(Mz_NONdamaged_total_freqStrokeDevMOD);
    ...
    Mx_damaged_mean_all_rolled =  Mx_damaged_mean_all - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_NONdamaged_mean_all_rolled =  Mx_NONdamaged_mean_all - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_damaged_mean_steady_rolled =  Mx_damaged_mean_steady - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_NONdamaged_mean_steady_rolled =  Mx_NONdamaged_mean_steady - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_damaged_mean_strokeMOD_rolled =  Mx_damaged_mean_strokeMOD - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_NONdamaged_mean_strokeMOD_rolled =  Mx_NONdamaged_mean_strokeMOD - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_damaged_mean_strokeDevMOD_rolled =  Mx_damaged_mean_strokeDevMOD - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_NONdamaged_mean_strokeDevMOD_rolled =  Mx_NONdamaged_mean_strokeDevMOD - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_damaged_mean_strokeDevRotMOD_rolled =  Mx_damaged_mean_strokeDevRotMOD - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    Mx_NONdamaged_mean_strokeDevRotMOD_rolled =  Mx_NONdamaged_mean_strokeDevRotMOD - h_CoP_CoM * sind(roll_all')/(l_wing*1000);
    ...
    plot(S2ratios(1),Fx_damaged_mean_all(1),'o-k','markersize',10,'markerfacecolor',[0 0 .5])
    plot(S2ratios,Fy_damaged_mean_all_rolled,'o-k','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S2ratios,Fz_damaged_mean_all_rolled,'o-k','markersize',10,'markerfacecolor',[0 .5 0])
    ...
    legend('x-axis Mod','y-axis Mod','z-axis Mod','x-axis Mod rolled','y-axis Mod rolled','z-axis Mod rolled','x-axis steady','y-axis steady','z-axis steady','location','S')
    xlabel('S2 ratio')
    ...
    plot(S3ratios,My_damaged_mean_all-My_damaged_mean_all(S3ratios==1),'o-k','markersize',10,'markerfacecolor','r')
    plot(S3ratios,Mz_damaged_mean_all,'o-k','markersize',10,'markerfacecolor','g')

    plot(S3ratios,Mx_damaged_mean_all_rolled,'o-k','markersize',10,'markerfacecolor',[0 0 .5])
    ...
    plot(S2ratios,Fz_damaged_mean_freqRotMOD,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    ...
    legend('none','frequency','freq&rot','freq&rot&dev','freq&rot&dev&stroke','all','location','NE')
    xlabel('S2 ratio')
    ...
    plot(S3ratios,Mx_damaged_mean_freqRotMOD,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    ...
    plot(S3ratios,Mx_damaged_mean_all_rolled,'o-k','markersize',10,'markerfacecolor','k')
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TipClip.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TipClip.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqRotDevStroke_TipClip.svg'])

    % compare MODs Fz & Mx CUMULATIVE STROKE FIRST & ROLL LAST
    figure
    subplot(1,2,1)
    hold on
    plot(S2ratios,Fz_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    plot(S2ratios,Fz_damaged_mean_steady_rolled,'o-k','markersize',10,'markerfacecolor','Y')
    plot(S2ratios,Fz_damaged_mean_strokeMOD_rolled,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S2ratios,Fz_damaged_mean_strokeDevMOD_rolled,'o-k','markersize',10,'markerfacecolor','r')
    plot(S2ratios,Fz_damaged_mean_strokeDevRotMOD_rolled,'o-k','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S2ratios,Fz_damaged_mean_all_rolled,'o-k','markersize',10,'markerfacecolor','k')
    
    legend('none','roll','roll&stroke','roll&str&dev','roll&str&dev&rot','all','location','NE')
    xlabel('S2 ratio')
    ylabel('normalized vertical force Fz/mg')
    axis([0.5 1 -1.5 0])
    set(gca,'xtick',0:.5:1)
    ...
    hold on
    plot(S3ratios,Mx_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    plot(S3ratios,Mx_damaged_mean_steady_rolled,'o-k','markersize',10,'markerfacecolor','y')
    plot(S3ratios,Mx_damaged_mean_strokeMOD_rolled,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S3ratios,Mx_damaged_mean_strokeDevMOD_rolled,'o-k','markersize',10,'markerfacecolor','r')
    plot(S3ratios,Mx_damaged_mean_strokeDevRotMOD_rolled,'o-k','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S3ratios,Mx_damaged_mean_all_rolled,'o-k','markersize',10,'markerfacecolor','k')
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TipClip.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TipClip.png'])
    plot2svg(['Fz_Mx_WBmodCombi_strokeFirst_TipClip.svg'])
