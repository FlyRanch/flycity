...
%     legend('steady','modified','frequency','stroke','deviation','rotation','location','SE')
    ...
    % compare MODs Fz & Mx CUMULATIVE FREQ FIRST
    figure
    subplot(1,2,1)
    hold on
    plot(S2ratios,Fz_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqFirst_TipClip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqFirst_TipClip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqFirst_TipClip_asympFit',num2str(freq_asymFitNr),'.svg'])
