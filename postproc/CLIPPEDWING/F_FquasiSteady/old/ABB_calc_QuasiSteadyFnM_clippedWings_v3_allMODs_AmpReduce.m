...
loadname=dir('WBdataset_steadyNclipMods_S2S3AmpRatioFunc_AmpReduce.mat')
...
AmpReduceRatio = 0.89;
stroke_steady_max = max(stroke_steady);
stroke_steady = AmpReduceRatio*(stroke_steady-stroke_steady_max) + stroke_steady_max;
