...
figure
plot(Arot_intactwing_all,dMwing_total_intactwing_all,'k-s','markerfacecolor','b','markersize',10)
hold on
plot(Arot_damagedwing_all,dMwing_total_damagedwing_all,'k-o','markerfacecolor','c','markersize',10)
