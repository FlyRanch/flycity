...
%     freq = freq_now;
    ...
    %% save data
    if fit_type == 1
        save(['allMODs_TEclip_indivFreqNrollFit_Asym10_roton',num2str(rot_on),'.mat'])
        if plot_on == 1
    ...
    elseif fit_type == 2
        save(['allMODs_TEclip_indivFreqNrollFit_spline999_roton',num2str(rot_on),'.mat'])
        if plot_on == 1
    ...
    elseif fit_type == 3
        save(['allMODs_TEclip_indivFreqNrollFit_linear_roton',num2str(rot_on),'.mat'])
        if plot_on == 1
    ...
    elseif fit_type == 4
        save(['allMODs_TEclip_indivFreqNrollFit_power2_roton',num2str(rot_on),'.mat'])
        if plot_on == 1
    ...
    saveas(gca,['FnM_WBmod_TEclip.fig'])
    saveas(gca,['FnM_WBmod_TEclip.png'])
    plot2svg(['FnM_WBmod_TEclip.svg'])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TEclip.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TEclip.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqRotDevStroke_TEclip.svg'])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TEclip.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TEclip.png'])
    plot2svg(['Fz_Mx_WBmodCombi_strokeFirst_TEclip.svg'])
