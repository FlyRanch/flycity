...
%% plot TIP cut wing data
    ...
    plot(S3ratios,-My_damaged_mean_freqMOD,'ok','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S3ratios,-My_damaged_mean_freqRotMOD,'ok','markersize',10,'markerfacecolor','r')
    plot(S3ratios,-My_damaged_mean_freqRotDevMOD,'ok','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S3ratios,-My_damaged_mean_all,'ok','markersize',10,'markerfacecolor','k')
    ...
    plot(S3ratios,-Mz_damaged_mean_freqMOD,'ok','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S3ratios,-Mz_damaged_mean_freqRotMOD,'ok','markersize',10,'markerfacecolor','r')
    plot(S3ratios,-Mz_damaged_mean_freqRotDevMOD,'ok','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S3ratios,-Mz_damaged_mean_all,'ok','markersize',10,'markerfacecolor','k')
...
%     legend('Tip clip','TE clip','location','NW')
    ...
    plot(S3ratios,-My_damaged_mean_freqMOD,'dk','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S3ratios,-My_damaged_mean_freqRotMOD,'dk','markersize',10,'markerfacecolor','r')
    plot(S3ratios,-My_damaged_mean_freqRotDevMOD,'dk','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S3ratios,-My_damaged_mean_all,'dk','markersize',10,'markerfacecolor','k')
    ...
    plot(S3ratios,-Mz_damaged_mean_freqMOD,'dk','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S3ratios,-Mz_damaged_mean_freqRotMOD,'dk','markersize',10,'markerfacecolor','r')
    plot(S3ratios,-Mz_damaged_mean_freqRotDevMOD,'dk','markersize',10,'markerfacecolor',[.5 0 0])
    plot(S3ratios,-Mz_damaged_mean_all,'dk','markersize',10,'markerfacecolor','k')
...
%     plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-My_damaged_mean_steady_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color','g','linewidth',2)
    ...
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,Mx_damaged_mean_freqRotMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color','r','linewidth',2)
    ...
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-My_damaged_mean_freqMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color',[1 .5 0],'linewidth',2)
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-My_damaged_mean_freqRotMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color','r','linewidth',2)
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-My_damaged_mean_freqRotDevMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color',[.5 0 0],'linewidth',2)
    ...
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-Mz_damaged_mean_freqMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color',[1 .5 0],'linewidth',2)
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-Mz_damaged_mean_freqRotMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color','r','linewidth',2)
    plot([min(S3ratios_TEnTip) max(S3ratios_TEnTip)],polyval(polyfit(S3ratios_TEnTip,-Mz_damaged_mean_freqRotDevMOD_TEnTip',1),[min(S3ratios_TEnTip) max(S3ratios_TEnTip)]),'color',[.5 0 0],'linewidth',2)
...
% 
    ...
    My_freqRot = mean(polyval(polyfit(S3ratios_TEnTip,My_damaged_mean_freqRotMOD_TEnTip',1),[min(S2ratios_TEnTip) max(S2ratios_TEnTip)])) - My_steady;
    ...
    freq2stroke.My_rot_perc_frds     = 100 / (-My_none) * (My_freqRot-My_freq);
    freq2stroke.My_dev_perc_frds     = 100 / (-My_none) * (My_freqRotDev-My_freqRot);
    ...
    Mz_freqRot = mean(polyval(polyfit(S3ratios_TEnTip,Mz_damaged_mean_freqRotMOD_TEnTip',1),[min(S2ratios_TEnTip) max(S2ratios_TEnTip)]));
    ...
    freq2stroke.Mz_rot_perc_frds     = 100 / (-Mz_none) * (Mz_freqRot-Mz_freq);
    freq2stroke.Mz_dev_perc_frds     = 100 / (-Mz_none) * (Mz_freqRotDev-Mz_freqRot);
