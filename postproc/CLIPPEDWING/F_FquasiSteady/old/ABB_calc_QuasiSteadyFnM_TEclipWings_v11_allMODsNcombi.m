...
%     freq = freq_now;
    ...
    save(['allMODs_TEclip_freqAsym',num2str(freq_asymFitNr),'.mat'])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqFirst_TEclip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqFirst_TEclip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqFirst_TEclip_asympFit',num2str(freq_asymFitNr),'.svg'])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TEclip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TEclip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_strokeFirst_TEclip_asympFit',num2str(freq_asymFitNr),'.svg'])
