...
%     freq = freq_now;
    ...
    Mx_damaged_total_steady(:,i) = (nansum(Mx_damaged_steady,1) + nansum(Mx_intact_steady,1))' / Mg_fly / l_wing;
    My_damaged_total_steady(:,i) = (nansum(My_damaged_steady,1) + nansum(My_intact_steady,1))' / Mg_fly / l_wing;
    Mz_damaged_total_steady(:,i) = (nansum(Mz_damaged_steady,1) + nansum(Mz_intact_steady,1))' / Mg_fly / l_wing;
    ...
    Mx_NONdamaged_total_steady(:,i) = (nansum(Mx_NONdamaged_steady,1) + nansum(Mx_intact_steady,1))' / Mg_fly / l_wing;
    My_NONdamaged_total_steady(:,i) = (nansum(My_NONdamaged_steady,1) + nansum(My_intact_steady,1))' / Mg_fly / l_wing;
    Mz_NONdamaged_total_steady(:,i) = (nansum(Mz_NONdamaged_steady,1) + nansum(Mz_intact_steady,1))' / Mg_fly / l_wing;
...
%     
%     Mx_damaged_total_freqMOD(:,i) = (nansum(Mx_damaged_freqMOD,1) + nansum(Mx_intact_freqMOD,1))' / Mg_fly / l_wing;
%     My_damaged_total_freqMOD(:,i) = (nansum(My_damaged_freqMOD,1) + nansum(My_intact_freqMOD,1))' / Mg_fly / l_wing;
%     Mz_damaged_total_freqMOD(:,i) = (nansum(Mz_damaged_freqMOD,1) + nansum(Mz_intact_freqMOD,1))' / Mg_fly / l_wing;
%     
...
%     
%     Mx_NONdamaged_total_freqMOD(:,i) = (nansum(Mx_NONdamaged_freqMOD,1) + nansum(Mx_intact_freqMOD,1))' / Mg_fly / l_wing;
%     My_NONdamaged_total_freqMOD(:,i) = (nansum(My_NONdamaged_freqMOD,1) + nansum(My_intact_freqMOD,1))' / Mg_fly / l_wing;
%     Mz_NONdamaged_total_freqMOD(:,i) = (nansum(Mz_NONdamaged_freqMOD,1) + nansum(Mz_intact_freqMOD,1))' / Mg_fly / l_wing;
...
%     freq = freq_now;
    ...
    Mx_damaged_total_strokeMOD(:,i) = (nansum(Mx_damaged_strokeMOD,1) + nansum(Mx_intact_strokeMOD,1))' / Mg_fly / l_wing;
    My_damaged_total_strokeMOD(:,i) = (nansum(My_damaged_strokeMOD,1) + nansum(My_intact_strokeMOD,1))' / Mg_fly / l_wing;
    Mz_damaged_total_strokeMOD(:,i) = (nansum(Mz_damaged_strokeMOD,1) + nansum(Mz_intact_strokeMOD,1))' / Mg_fly / l_wing;
    ...
    Mx_NONdamaged_total_strokeMOD(:,i) = (nansum(Mx_NONdamaged_strokeMOD,1) + nansum(Mx_intact_strokeMOD,1))' / Mg_fly / l_wing;
    My_NONdamaged_total_strokeMOD(:,i) = (nansum(My_NONdamaged_strokeMOD,1) + nansum(My_intact_strokeMOD,1))' / Mg_fly / l_wing;
    Mz_NONdamaged_total_strokeMOD(:,i) = (nansum(Mz_NONdamaged_strokeMOD,1) + nansum(Mz_intact_strokeMOD,1))' / Mg_fly / l_wing;
...
%     freq = freq_now;
    ...
    Mx_damaged_total_devMOD(:,i) = (nansum(Mx_damaged_devMOD,1) + nansum(Mx_intact_devMOD,1))' / Mg_fly / l_wing;
    My_damaged_total_devMOD(:,i) = (nansum(My_damaged_devMOD,1) + nansum(My_intact_devMOD,1))' / Mg_fly / l_wing;
    Mz_damaged_total_devMOD(:,i) = (nansum(Mz_damaged_devMOD,1) + nansum(Mz_intact_devMOD,1))' / Mg_fly / l_wing;
    ...
    Mx_NONdamaged_total_devMOD(:,i) = (nansum(Mx_NONdamaged_devMOD,1) + nansum(Mx_intact_devMOD,1))' / Mg_fly / l_wing;
    My_NONdamaged_total_devMOD(:,i) = (nansum(My_NONdamaged_devMOD,1) + nansum(My_intact_devMOD,1))' / Mg_fly / l_wing;
    Mz_NONdamaged_total_devMOD(:,i) = (nansum(Mz_NONdamaged_devMOD,1) + nansum(Mz_intact_devMOD,1))' / Mg_fly / l_wing;
...
%     freq = freq_now;
    ...
    Mx_damaged_total_rotMOD(:,i) = (nansum(Mx_damaged_rotMOD,1) + nansum(Mx_intact_rotMOD,1))' / Mg_fly / l_wing;
    My_damaged_total_rotMOD(:,i) = (nansum(My_damaged_rotMOD,1) + nansum(My_intact_rotMOD,1))' / Mg_fly / l_wing;
    Mz_damaged_total_rotMOD(:,i) = (nansum(Mz_damaged_rotMOD,1) + nansum(Mz_intact_rotMOD,1))' / Mg_fly / l_wing;
    ...
    Mx_NONdamaged_total_rotMOD(:,i) = (nansum(Mx_NONdamaged_rotMOD,1) + nansum(Mx_intact_rotMOD,1))' / Mg_fly / l_wing;
    My_NONdamaged_total_rotMOD(:,i) = (nansum(My_NONdamaged_rotMOD,1) + nansum(My_intact_rotMOD,1))' / Mg_fly / l_wing;
    Mz_NONdamaged_total_rotMOD(:,i) = (nansum(Mz_NONdamaged_rotMOD,1) + nansum(Mz_intact_rotMOD,1))' / Mg_fly / l_wing;
...
%     Mz_NONdamaged_mean_freqMOD = nanmean(Mz_NONdamaged_total_freqMOD);
    ...
    legend('Fx Mod','Fy Mod','Fz Mod','Fx steady','Fy steady','Fz steady','location','E')
    xlabel('S2 ratio')
    ylabel('F/mg')
    axis([0.5 1 -1.5 .25])
    set(gca,'xtick',0:.5:1)
...
%     Mx_sum = Mx_NONdamaged_mean_freqMOD+Mx_NONdamaged_mean_strokeMOD+Mx_NONdamaged_mean_devMOD+Mx_NONdamaged_mean_rotMOD;
    Fz_sum = Fz_NONdamaged_mean_strokeMOD+Fz_NONdamaged_mean_devMOD+Fz_NONdamaged_mean_rotMOD;
    Mx_sum = Mx_NONdamaged_mean_strokeMOD+Mx_NONdamaged_mean_devMOD+Mx_NONdamaged_mean_rotMOD;
