...
Mx_transNrot_norm_RollAccel_sum_mean = ...
    (Mx_transNrot_norm_RollAccel_stroke_mean - Mx_transNrot_norm_RollAccel_stroke_mean(mod_value_RollAccel==0)) +...
    (Mx_transNrot_norm_RollAccel_dev_mean - Mx_transNrot_norm_RollAccel_dev_mean(mod_value_RollAccel==0)) +...
    (Mx_transNrot_norm_RollAccel_rot_mean - Mx_transNrot_norm_RollAccel_rot_mean(mod_value_RollAccel==0));

subplot(2,2,2)
hold on
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_transNrot_norm_RollAccel_allNOfreq_mean(subset)-Mx_transNrot_norm_RollAccel_allNOfreq_mean(mod_value_RollAccel==0)),'-r','linewidth',1)
% plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_transNrot_norm_RollAccel_freq_mean(subset)-Mx_transNrot_norm_RollAccel_freq_mean(mod_value_RollAccel==0)),'-g','linewidth',1)
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_transNrot_norm_RollAccel_stroke_mean(subset)-Mx_transNrot_norm_RollAccel_stroke_mean(mod_value_RollAccel==0)),'-b','linewidth',1)
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_transNrot_norm_RollAccel_dev_mean(subset)-Mx_transNrot_norm_RollAccel_dev_mean(mod_value_RollAccel==0)),'-m','linewidth',1)
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_transNrot_norm_RollAccel_rot_mean(subset)-Mx_transNrot_norm_RollAccel_rot_mean(mod_value_RollAccel==0)),'-c','linewidth',1)
plot(rollaccel_norm*mod_value_RollAccel(subset),-(Mx_transNrot_norm_RollAccel_sum_mean(subset)-Mx_transNrot_norm_RollAccel_sum_mean(mod_value_RollAccel==0)),'--','color',[.5 .5 .5],'linewidth',1)
...
Mroll_norm = -(Mx_transNrot_norm_RollAccel_allNOfreq_mean(subset)-Mx_transNrot_norm_RollAccel_allNOfreq_mean(mod_value_RollAccel==0));
...
Mz_transNrot_norm_YawAccel_sum_mean = ...
    (Mz_transNrot_norm_YawAccel_stroke_mean - Mz_transNrot_norm_YawAccel_stroke_mean(mod_value_YawAccel==0)) +...
    (Mz_transNrot_norm_YawAccel_dev_mean - Mz_transNrot_norm_YawAccel_dev_mean(mod_value_YawAccel==0)) +...
    (Mz_transNrot_norm_YawAccel_rot_mean - Mz_transNrot_norm_YawAccel_rot_mean(mod_value_YawAccel==0));

subplot(2,2,3)
hold on
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_transNrot_norm_YawAccel_allNOfreq_mean(subset)-Mz_transNrot_norm_YawAccel_allNOfreq_mean(mod_value_YawAccel==0)),'-r','linewidth',1)
% plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_transNrot_norm_YawAccel_freq_mean(subset)-Mz_transNrot_norm_YawAccel_freq_mean(mod_value_YawAccel==0)),'-g','linewidth',1)
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_transNrot_norm_YawAccel_stroke_mean(subset)-Mz_transNrot_norm_YawAccel_stroke_mean(mod_value_YawAccel==0)),'-b','linewidth',1)
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_transNrot_norm_YawAccel_dev_mean(subset)-Mz_transNrot_norm_YawAccel_dev_mean(mod_value_YawAccel==0)),'-m','linewidth',1)
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_transNrot_norm_YawAccel_rot_mean(subset)-Mz_transNrot_norm_YawAccel_rot_mean(mod_value_YawAccel==0)),'-c','linewidth',1)
plot(yawaccel_norm*mod_value_YawAccel(subset),-(Mz_transNrot_norm_YawAccel_sum_mean(subset)-Mz_transNrot_norm_YawAccel_sum_mean(mod_value_YawAccel==0)),'--','color',[.5 .5 .5],'linewidth',1)
...
Myaw_norm = -(Mz_transNrot_norm_YawAccel_allNOfreq_mean(subset)-Mz_transNrot_norm_YawAccel_allNOfreq_mean(mod_value_YawAccel==0));
...
My_transNrot_norm_PitchAccel_sum_mean = ...
    (My_transNrot_norm_PitchAccel_stroke_mean - My_transNrot_norm_PitchAccel_stroke_mean(mod_value_PitchAccel==0)) +...
    (My_transNrot_norm_PitchAccel_dev_mean - My_transNrot_norm_PitchAccel_dev_mean(mod_value_PitchAccel==0)) +...
    (My_transNrot_norm_PitchAccel_rot_mean - My_transNrot_norm_PitchAccel_rot_mean(mod_value_PitchAccel==0));

subplot(2,2,4)
hold on
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_transNrot_norm_PitchAccel_allNOfreq_mean(subset)-My_transNrot_norm_PitchAccel_allNOfreq_mean(mod_value_PitchAccel==0)),'-r','linewidth',1)
% plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_transNrot_norm_PitchAccel_freq_mean(subset)-My_transNrot_norm_PitchAccel_freq_mean(mod_value_PitchAccel==0)),'-g','linewidth',1)
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_transNrot_norm_PitchAccel_stroke_mean(subset)-My_transNrot_norm_PitchAccel_stroke_mean(mod_value_PitchAccel==0)),'-b','linewidth',1)
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_transNrot_norm_PitchAccel_dev_mean(subset)-My_transNrot_norm_PitchAccel_dev_mean(mod_value_PitchAccel==0)),'-m','linewidth',1)
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_transNrot_norm_PitchAccel_rot_mean(subset)-My_transNrot_norm_PitchAccel_rot_mean(mod_value_PitchAccel==0)),'-c','linewidth',1)
plot(pitchaccel_norm*mod_value_PitchAccel(subset),(My_transNrot_norm_PitchAccel_sum_mean(subset)-My_transNrot_norm_PitchAccel_sum_mean(mod_value_PitchAccel==0)),'--','color',[.5 .5 .5],'linewidth',1)
...
Mpitch_norm = (My_transNrot_norm_PitchAccel_allNOfreq_mean(subset)-My_transNrot_norm_PitchAccel_allNOfreq_mean(mod_value_PitchAccel==0));
...
mkdir('MSfigs')
cd('MSfigs')
saveas(gca, 'MSfig_Fenhance_Mroll_Myaw_Mpitch_QSmodel_transNrot.fig')
saveas(gca, 'MSfig_Fenhance_Mroll_Myaw_Mpitch_QSmodel_transNrot.png')
plot2svg(['MSfig_Fenhance_Mroll_Myaw_Mpitch_QSmodel_transNrot.svg'])
cd ..
