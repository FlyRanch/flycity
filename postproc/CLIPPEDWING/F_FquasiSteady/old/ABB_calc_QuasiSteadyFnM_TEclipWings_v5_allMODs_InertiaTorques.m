...
saveas(gca,['Arot_vs_DMwing_TEclip_asympFit',num2str(freq_asymFitNr),'.fig'])
saveas(gca,['Arot_vs_DMwing_TEclip_asympFit',num2str(freq_asymFitNr),'.png'])
plot2svg(['Arot_vs_DMwing_TEclip_asympFit',num2str(freq_asymFitNr),'.svg'])
