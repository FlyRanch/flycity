...
%     freq = freq_now;
    ...
    save(['allMODs_TEclip_freqAsym',num2str(freq_asymFitNr),'_roton',num2str(rot_on),'.mat'])
    
    %% plot
    if plot_on == 1
    mkdir(['qsModel_FnM_TEcut_roton',num2str(rot_on)])
    cd(['qsModel_FnM_TEcut_roton',num2str(rot_on)])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TEclip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TEclip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqRotDevStroke_TEclip_asympFit',num2str(freq_asymFitNr),'.svg'])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqStrokeDevRot_TEclip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqStrokeDevRot_TEclip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqStrokeDevRot_TEclip_asympFit',num2str(freq_asymFitNr),'.svg'])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_strokeDevRotFreq_TEclip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_strokeDevRotFreq_TEclip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_strokeDevRotFreq_TEclip_asympFit',num2str(freq_asymFitNr),'.svg'])
