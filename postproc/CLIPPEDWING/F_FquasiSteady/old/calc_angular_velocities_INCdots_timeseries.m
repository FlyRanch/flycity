function [ kine ] = calc_angular_velocities_INCdots_timeseries(phi_L,theta_L,eta_L,phi_R,theta_R,eta_R,phi_dot_L,theta_dot_L,eta_dot_L,phi_dot_R,theta_dot_R,eta_dot_R,phi_ddot_L,theta_ddot_L,eta_ddot_L,phi_ddot_R,theta_ddot_R,eta_ddot_R,t,R_strk)
