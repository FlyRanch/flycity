...
%     freq = freq_now;
    ...
    save(['allMODs_TipClip_freqAsym',num2str(freq_asymFitNr),'_roton',num2str(rot_on),'.mat'])
    
    %% plot
    if plot_on == 1
    mkdir(['qsModel_FnM_TipCut_roton',num2str(rot_on)])
    cd(['qsModel_FnM_TipCut_roton',num2str(rot_on)])
...
%     legend('steady','modified','frequency','stroke','deviation','rotation','location','SE')
    ...
    plot(S3ratios,Mx_damaged_mean_all,'o-k','markersize',10,'markerfacecolor',[.5 .5 .5])
    plot(S3ratios,Mx_damaged_mean_freqMOD,'o-k','markersize',10,'markerfacecolor','b')
    plot(S3ratios,Mx_damaged_mean_strokeMOD,'o-k','markersize',10,'markerfacecolor','g')
    plot(S3ratios,Mx_damaged_mean_devMOD,'o-k','markersize',10,'markerfacecolor','r')
    plot(S3ratios,Mx_damaged_mean_rotMOD,'o-k','markersize',10,'markerfacecolor','c')
    ...
    plot(S2ratios,Fy_damaged_mean_strokeDevMOD,'o-k','markersize',10,'markerfacecolor','y')
    plot(S2ratios,Fy_damaged_mean_strokeDevRotMOD,'o-k','markersize',10,'markerfacecolor','m')
    
    legend('steady','modified','frequency','stroke','deviation','rotation','str&dev','str&dev&rot','location','SE')
    xlabel('S2 ratio')
    ...
    subplot(1,2,2)
    hold on
    plot(S3ratios,Mz_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    plot(S3ratios,Mz_damaged_mean_all,'o-k','markersize',10,'markerfacecolor',[.5 .5 .5])
    plot(S3ratios,Mz_damaged_mean_freqMOD,'o-k','markersize',10,'markerfacecolor','b')
    plot(S3ratios,Mz_damaged_mean_strokeMOD,'o-k','markersize',10,'markerfacecolor','g')
    plot(S3ratios,Mz_damaged_mean_devMOD,'o-k','markersize',10,'markerfacecolor','r')
    plot(S3ratios,Mz_damaged_mean_rotMOD,'o-k','markersize',10,'markerfacecolor','c')
    plot(S3ratios,Mz_damaged_mean_strokeDevMOD,'o-k','markersize',10,'markerfacecolor','y')
    plot(S3ratios,Mz_damaged_mean_strokeDevRotMOD,'o-k','markersize',10,'markerfacecolor','m')
    ...
    % compare MODs Fz & Mx CUMULATIVE FREQ FIRST & STROKE LAST
    figure
    subplot(1,2,1)
    hold on
    plot(S2ratios,Fz_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TipClip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqRotDevStroke_TipClip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqRotDevStroke_TipClip_asympFit',num2str(freq_asymFitNr),'.svg'])
    
    % compare MODs Fz & Mx CUMULATIVE FREQ FIRST & ROT LAST
    figure
    subplot(1,2,1)
    hold on
    plot(S2ratios,Fz_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    plot(S2ratios,Fz_damaged_mean_freqMOD,'o-k','markersize',10,'markerfacecolor','y')
    plot(S2ratios,Fz_damaged_mean_freqStrokeMOD,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S2ratios,Fz_damaged_mean_freqStrokeDevMOD,'o-k','markersize',10,'markerfacecolor','r')
    plot(S2ratios,Fz_damaged_mean_all,'o-k','markersize',10,'markerfacecolor',[.5 0 0])
    ...
    plot(S3ratios,Mx_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    plot(S3ratios,Mx_damaged_mean_freqMOD,'o-k','markersize',10,'markerfacecolor','y')
    plot(S3ratios,Mx_damaged_mean_freqStrokeMOD,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    plot(S3ratios,Mx_damaged_mean_freqStrokeDevMOD,'o-k','markersize',10,'markerfacecolor','r')
    plot(S3ratios,Mx_damaged_mean_all,'o-k','markersize',10,'markerfacecolor',[.5 0 0])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_freqStrokeDevRot_TipClip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_freqStrokeDevRot_TipClip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_freqStrokeDevRot_TipClip_asympFit',num2str(freq_asymFitNr),'.svg'])
    
    % compare MODs Fz & Mx CUMULATIVE STROKE FIRST
    figure
    subplot(1,2,1)
    hold on
    plot(S2ratios,Fz_damaged_mean_steady,'o-k','markersize',10,'markerfacecolor','w')
    ...
    plot(S3ratios,Mx_damaged_mean_strokeDevMOD,'o-k','markersize',10,'markerfacecolor',[1 .5 0])
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TipClip_asympFit',num2str(freq_asymFitNr),'.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_strokeFirst_TipClip_asympFit',num2str(freq_asymFitNr),'.png'])
    plot2svg(['Fz_Mx_WBmodCombi_strokeFirst_TipClip_asympFit',num2str(freq_asymFitNr),'.svg'])
