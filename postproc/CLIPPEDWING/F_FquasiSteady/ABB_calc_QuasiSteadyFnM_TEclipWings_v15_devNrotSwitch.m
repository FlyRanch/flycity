...
%     plot(S2ratios,Fz_damaged_mean_all,'o-k','markersize',10,'markerfacecolor','g')
    ...
    saveas(gca,['Fz_Mx_WBmodCombi_strokeRotDevRollFreq_TEclip.fig'])
    saveas(gca,['Fz_Mx_WBmodCombi_strokeRotDevRollFreq_TEclip.png'])
    plot2svg(['Fz_Mx_WBmodCombi_strokeRotDevRollFreq_TEclip.svg'])
