...
cd('TEcut')
load('WingClipDatabase_TEclippedWingsCorrected.mat')
cd ..

seq_nr = length(WingClipData.date);
WingClipData.seq_nr_TEnTIPcut = seq_nr+1;
...
cd ..
% WingClipDataTIP = WingClipData;
% save('WingClipDatabase_TIPclippedWings.mat','WingClipDataTIP')

cd ..
save('WingClipDatabase_TEnTIP_TEclipCorrected.mat','WingClipData')
