...
% stats Amax
stats_droll_atAmax = regstats(droll_plot_Amax,turn_angle_vel_mirror,'linear');
stats_Dpitch_atAmax = regstats(Dpitch_Amax,turn_angle_vel_mirror,'linear');
stats_yaw_atAmax = regstats(yaw_plot_Amax,turn_angle_vel_mirror,'linear');
stats_rot_angle_atAmax = regstats(rot_angle_Amax,turn_angle_vel_mirror,'linear');
stats_drot_L_atAmax = regstats(drot_L_plot_Amax,turn_angle_vel_mirror,'linear');
stats_drot_R_atAmax = regstats(drot_R_plot_Amax,turn_angle_vel_mirror,'linear');
...
% stats means
stats_droll_mean = regstats(droll_plot_mean,turn_angle_vel_mirror,'linear');
stats_Dpitch_mean = regstats(Dpitch_mean,turn_angle_vel_mirror,'linear');
stats_yaw_mean = regstats(yaw_plot_mean,turn_angle_vel_mirror,'linear');
stats_rot_angle_mean = regstats(rot_angle_mean,turn_angle_vel_mirror,'linear');
stats_drot_L_mean = regstats(drot_L_plot_mean,turn_angle_vel_mirror,'linear');
stats_drot_R_mean = regstats(drot_R_plot_mean,turn_angle_vel_mirror,'linear');
...
plot(xp,yp)
plot(turn_angle_vel_mirror,droll_plot_Amax,'.')

yp = polyval([stats_droll_mean.beta(2) stats_droll_mean.beta(1)],xp);
plot(xp,yp,'r')
plot(turn_angle_vel_mirror,droll_plot_mean,'.r')
...
plot(xp,yp)
plot(turn_angle_vel_mirror,yaw_plot_Amax,'.')

yp = polyval([stats_yaw_mean.beta(2) stats_yaw_mean.beta(1)],xp);
plot(xp,yp,'r')
plot(turn_angle_vel_mirror,yaw_plot_mean,'.r')
...
plot(xp,yp)
plot(turn_angle_vel_mirror,drot_R_plot_Amax,'.')

yp = polyval([stats_drot_R_mean.beta(2) stats_drot_R_mean.beta(1)],xp);
plot(xp,yp,'r')
plot(turn_angle_vel_mirror,drot_R_plot_mean,'.r')
...
plot(xp,yp)
plot(turn_angle_vel_mirror,drot_L_plot_Amax,'.')

yp = polyval([stats_drot_L_mean.beta(2) stats_drot_L_mean.beta(1)],xp);
plot(xp,yp,'r')
plot(turn_angle_vel_mirror,drot_L_plot_mean,'.r')
