...
volatile uint8_t next_block_x = 0;
volatile uint8_t next_block_y = 0;
...
//				file2.cltbl = lktbl;                    /* Enable fast seek feature */
//				lktbl[0] = SZ_TBL;                     /* Set table size */
//				res = f_lseek(&file2, CREATE_LINKMAP);   /* Create CLMT */
