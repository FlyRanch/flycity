...
#define FUNCTION_LENGTH  BUFFER_LENGTH/2 //ringbuffer size in number of data
#define OVERFLOW_RATE 8000000/256
#define UPDATE_RATE OVERFLOW_RATE/500
...
unsigned char fun_x_EEPROM[1000] EEPROM;
//unsigned char fun_y_EEPROM[800] EEPROM;
