...
[M_L_max n_M_L_max] = calc_max_value(M_L,n_pre,n_post);
[M_L_min n_M_L_min] = calc_min_value(M_L,n_pre,n_post);

[M_R_max n_M_R_max] = calc_max_value(M_R,n_pre,n_post);
[M_R_min n_M_R_min] = calc_min_value(M_R,n_pre,n_post);

[M_axis1_max n_M_axis1_max] = calc_max_value(M_axis1,n_pre,n_post);
[M_axis1_min n_M_axis1_min] = calc_min_value(M_axis1,n_pre,n_post);

[M_axis1normal_max n_M_axis1normal_max] = calc_max_value(M_axis1normal,n_pre,n_post);
[M_axis1normal_min n_M_axis1normal_min] = calc_min_value(M_axis1normal,n_pre,n_post);

[M_axis2_max n_M_axis2_max] = calc_max_value(M_axis2,n_pre,n_post);
[M_axis2_min n_M_axis2_min] = calc_min_value(M_axis2,n_pre,n_post);

[M_axis2normal_max n_M_axis2normal_max] = calc_max_value(M_axis2normal,n_pre,n_post);
[M_axis2normal_min n_M_axis2normal_min] = calc_min_value(M_axis2normal,n_pre,n_post);
...
[M_L_norm_max n_M_L_norm_max] = calc_max_value(M_L_norm,n_pre,n_post);
[M_L_norm_min n_M_L_norm_min] = calc_min_value(M_L_norm,n_pre,n_post);

[M_R_norm_max n_M_R_norm_max] = calc_max_value(M_R_norm,n_pre,n_post);
[M_R_norm_min n_M_R_norm_min] = calc_min_value(M_R_norm,n_pre,n_post);

[M_axis1_norm_max n_M_axis1_norm_max] = calc_max_value(M_axis1_norm,n_pre,n_post);
[M_axis1_norm_min n_M_axis1_norm_min] = calc_min_value(M_axis1_norm,n_pre,n_post);

[M_axis1normal_norm_max n_M_axis1normal_norm_max] = calc_max_value(M_axis1normal_norm,n_pre,n_post);
[M_axis1normal_norm_min n_M_axis1normal_norm_min] = calc_min_value(M_axis1normal_norm,n_pre,n_post);

[M_axis2_norm_max n_M_axis2_norm_max] = calc_max_value(M_axis2_norm,n_pre,n_post);
[M_axis2_norm_min n_M_axis2_norm_min] = calc_min_value(M_axis2_norm,n_pre,n_post);

[M_axis2normal_norm_max n_M_axis2normal_norm_max] = calc_max_value(M_axis2normal_norm,n_pre,n_post);
[M_axis2normal_norm_min n_M_axis2normal_norm_min] = calc_min_value(M_axis2normal_norm,n_pre,n_post);
