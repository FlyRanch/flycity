%% cal WBmod kin data
% RollAccel
Dstroke_RollAccel_max = DstrokeMOD_RollAccel_max * Mroll_norm_max;
Dpitch_RollAccel_max = DpitchMOD_RollAccel_max * Mroll_norm_max;
Ddev_RollAccel_max = DdevMOD_RollAccel_max * Mroll_norm_max;

Dstroke_RollAccel_min = DstrokeMOD_RollAccel_max * Mroll_norm_min;
Dpitch_RollAccel_min = DpitchMOD_RollAccel_max * Mroll_norm_min;
Ddev_RollAccel_min = DdevMOD_RollAccel_max * Mroll_norm_min;

% YawAccel
Dstroke_YawAccel_max = DstrokeMOD_YawAccel_max * Myaw_norm_max;
Dpitch_YawAccel_max = DpitchMOD_YawAccel_max * Myaw_norm_max;
Ddev_YawAccel_max = DdevMOD_YawAccel_max * Myaw_norm_max;

Dstroke_YawAccel_min = DstrokeMOD_YawAccel_max * Myaw_norm_min;
Dpitch_YawAccel_min = DpitchMOD_YawAccel_max * Myaw_norm_min;
Ddev_YawAccel_min = DdevMOD_YawAccel_max * Myaw_norm_min;

% PitchAccel
stroke_PitchAccel_max = strokeMOD_PitchAccel_max * Mpitch_norm_max;
pitch_PitchAccel_max = pitchMOD_PitchAccel_max * Mpitch_norm_max;
dev_PitchAccel_max = devMOD_PitchAccel_max * Mpitch_norm_max;

stroke_PitchAccel_min = strokeMOD_PitchAccel_max * Mpitch_norm_min;
pitch_PitchAccel_min = pitchMOD_PitchAccel_max * Mpitch_norm_min;
dev_PitchAccel_min = devMOD_PitchAccel_max * Mpitch_norm_min;
