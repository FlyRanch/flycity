function [temp] = pathDB3_nosave_temp(settings,pathDB)
...
%         alldirs=dir;
        ...
        load_name = [alldirs{i}, '/flytracks/ManualFit_flytracks.mat'];
        
        if exist(load_name) == 0
            load_name = ['/home/florian/DATA/flighttracker/OPTOMOTOR/optomotor_wingsInc_GOOD/ManualFit_flytracks.mat'];
        end
