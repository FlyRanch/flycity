function Wing_ref_frame_LocFix(settings,pathDB)
    ...
    for i=1:size(pathDB.qb1_filt,2)
        ...
        % Calculate the duration of the upstroke and the downstroke:
            ...
            [ L_wingtip_path, R_wingtip_path, L_wingbeat_loc, R_wingbeat_loc] = Wingbeat_LocFix(pathDB.qL1_filt2(start:stop,i),pathDB.qL2_filt2(start:stop,i),pathDB.qL3_filt2(start:stop,i),pathDB.qL4_filt2(start:stop,i), ...
