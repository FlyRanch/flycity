function [Y,idx,IMout,Nrml] = renderflyMODShape(X,PAR,M,X1)

% [Y,IDX,IMout] = renderflyMODShape(X,PAR)
...
%
% THE MINIMUM NUMBER OF PIXELS BEFORE SUPERRESOLUTION IS USED IS LESS SINCE
