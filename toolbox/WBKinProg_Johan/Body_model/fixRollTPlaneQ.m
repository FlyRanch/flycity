...
Wingflag = (norm(Vlbar) < 0.5 || norm(Vrbar) < 0.5);
%keyboard
...
elseif Wingflag
    ...
    clear flymodQ
    [x,y,z] = flymodQ(p,PAR.params,PAR);
    ...
    function F = PtErr(pp)
        ...
        [x{1},y{1},z{1}] = xformq_surf(x{1},y{1},z{1},LJTrans,qLwing,PAR.params.wingscale);
        [x{2},y{2},z{2}] = xformq_surf(x{2},y{2},z{2},RJTrans,qRwing,PAR.params.wingscale);
