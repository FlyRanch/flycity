function [x,y,z] = flymod_WingZYX(p,params,PAR)
% function [x,y,z] = flymod_WingZYX(p,params,PAR)
%
% I CHANGED THE ORDER OF THE WING ROTATION ANGLES IN THIS VERSION!!!
%
...
G_BL = screw2homo(S(:,3))*screw2homo(S(:,2))*screw2homo(S(:,1));
G_BR = screw2homo(S(:,6))*screw2homo(S(:,5))*screw2homo(S(:,4));
