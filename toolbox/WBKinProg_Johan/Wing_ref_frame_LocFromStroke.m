function Wing_ref_frame(settings,pathDB)
...
%                                                                                 pathDB.qR1_filt2(start:stop,i),pathDB.qR2_filt2(start:stop,i),pathDB.qR3_filt2(start:stop,i),pathDB.qR4_filt2(start:stop,i), wing_l);
            ...
            [ L_wingtip_path, R_wingtip_path, L_wingbeat_loc, R_wingbeat_loc] = Wingbeat_LocFromStroke(pathDB.qL1_filt2(start:stop,i),pathDB.qL2_filt2(start:stop,i),pathDB.qL3_filt2(start:stop,i),pathDB.qL4_filt2(start:stop,i), ...
                                                                                pathDB.qR1_filt2(start:stop,i),pathDB.qR2_filt2(start:stop,i),pathDB.qR3_filt2(start:stop,i),pathDB.qR4_filt2(start:stop,i), wing_l);
                                                                            
            
%             [ L_wingtip_path, R_wingtip_path, L_wingbeat_loc, R_wingbeat_loc] = Wingbeat_LocFromStroke_direct(pathDB.qL1_filt2(start:stop,i),pathDB.qL2_filt2(start:stop,i),pathDB.qL3_filt2(start:stop,i),pathDB.qL4_filt2(start:stop,i), ...
%                                                                                 pathDB.qR1_filt2(start:stop,i),pathDB.qR2_filt2(start:stop,i),pathDB.qR3_filt2(start:stop,i),pathDB.qR4_filt2(start:stop,i), wing_l);
