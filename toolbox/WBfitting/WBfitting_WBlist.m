...
n_pol_dev = 8; % Order of used polynomials 

t_loc = t_steady;

stroke_L_loc = stroke_wb_L_steady;
pitch_L_loc = pitch_wb_L_steady;
dev_L_loc = dev_wb_L_steady;

stroke_R_loc = stroke_wb_R_steady;
pitch_R_loc = pitch_wb_R_steady;
dev_R_loc = dev_wb_R_steady;
