...
add_paths = {'W:/Sequences_14_06_2013'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Kalman_Filter'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Plot'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Plot/Smoothing_plots'; ... % };
             'W:/Plots'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Body_model'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Body_model/mex'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Type2Regression';...
             'D:/Flytracker/Wing_kin_Johan/Program10/Dynamic_model'; ...
             'D:/Flytracker/Wing_kin_Johan/Program10/Dynamic_model/Polynomial_Fitting'; ...
             };

% add_paths = {'W:/Sequences_24_05_2013'; ...
%              'D:/Flytracker/Wing_kin_Johan/Program10'; ...
%              'D:/Flytracker/Wing_kin_Johan/Program10/Kalman_Filter'; ...
%              'D:/Flytracker/Wing_kin_Johan/Program10/Plot'; ...
%              'D:/Flytracker/Wing_kin_Johan/Program10/Plot/Smoothing_plots'; ... % };
...
if exist('pathDB8.mat')==2
    ...
    pathDB.a_fit = temp.a_fit_tot;
    pathDB.a_avg = temp.a_avg_tot;
    pathDB.a_sym = temp.a_sym_tot;
    pathDB.a_dev = temp.a_dev_tot;
    pathDB.stroke_var = temp.stroke_var_tot;
    pathDB.f_avg = temp.f_avg_tot;
    pathDB.down_up_ratio = temp.down_up_ratio_tot;
    pathDB.down_up_avg = temp.down_up_avg_tot;
    pathDB.trigger_wb = temp.trigger_wb_tot;
    pathDB.maneuver = temp.maneuver_tot;
    pathDB.a_glob = temp.a_glob;
    pathDB.f_glob = temp.f_glob;
    pathDB.down_up_glob = temp.down_up_glob;
    
    'loaded'
    clear temp
else
    pathDB8(settings,pathDB);
    temp = load('pathDB8.mat');
...
if exist('pathDB9.mat')==2
    temp = load('pathDB9.mat');
        
    pathDB.all_maneuvers = temp.all_maneuvers;
    
    'loaded'
    clear temp
else
    pathDB9(settings,pathDB);
    temp = load('pathDB9.mat');
...
% Control functions wing kinematics:

% Maneuvers:

if exist('pathDB10.mat')==2
    temp = load('pathDB10.mat');
    
    pathDB.control_glob = temp.control_glob;
    pathDB.control_gen = temp.control_gen;
    
    'loaded'
    clear temp
else
    pathDB10(settings,pathDB);
    temp = load('pathDB10.mat');
...
% presentation_plots(settings, pathDB)

% Robofly_flowvis_tests( settings, pathDB )


% Robofly_man_tests( settings, pathDB )

[~,~] = control_analysis( pathDB )

%  pathDB9( settings, pathDB )
% 
% [all_maneuvers] = non_dimensional_control_analysis( settings, pathDB)

% Dynamic_model( settings, pathDB )

% Aerodynamic_damping( settings, pathDB )



% Robofly_avg_tests( settings, pathDB )

% theta_over_phi( settings, pathDB )

% wing_kinematics_florian(settings,pathDB)
...
% Maneuvers( settings, pathDB )

%Wingkinematics_Legendre(settings, pathDB)
% 
% wingkin_sphere_analysis(settings,pathDB)
