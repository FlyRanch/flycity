...
%     figure()
%     hold on
%     subplot(3,1,1); plot(t,theta_dot_L_t,'r',t,theta_dot_R_t,'b')
%     subplot(3,1,2); plot(t,eta_dot_L_t,'r',t,eta_dot_R_t,'b')
%     subplot(3,1,3); plot(t,phi_dot_L_t,'r',t,phi_dot_R_t,'b')
%     hold off
%     
%     figure()
%     hold on
%     subplot(3,1,1); plot(t,theta_ddot_L_t,'r',t,theta_ddot_R_t,'b')
%     subplot(3,1,2); plot(t,eta_ddot_L_t,'r',t,eta_ddot_R_t,'b')
%     subplot(3,1,3); plot(t,phi_ddot_L_t,'r',t,phi_ddot_R_t,'b')
%     hold off
