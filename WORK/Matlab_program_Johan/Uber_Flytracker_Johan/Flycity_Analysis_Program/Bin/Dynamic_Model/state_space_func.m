function x_dot = state_space_func(t,x,t_func,wing_kin,body_model,wing_model,body_IC,temp_file_name,case_nr)
    ...
    elseif case_nr == 1
        ...
        MA    = FMA_b(4:6);
%         
%         FA    = (1/body_IC.fg_fact)*FMA_b(1:3);
%         MA    = (1/body_IC.fg_fact)*FMA_b(4:6); 

%         FA    = FMA_b(1:3);
%         MA    = [FMA_b(4); FMA_b(5)*0.3; FMA_b(6)];
...
%         FA    = FMA_b(1:3);
%         MA    = [FMA_b(4); FMA_b(5)*0; FMA_b(6)];

%         FA    = (1/body_IC.fg_fact)*FMA_b(1:3);
%         MA    = (1/body_IC.fg_fact)*[FMA_b(4); FMA_b(5)*0.3; FMA_b(6)]; 
...
%         x_dot = 1000*(M_mat\[ FI+FA+Fg-w_b_dL_dv_b-F_0; MI+MA-v_b_dL_dv_b-w_b_dL_dw_b-M_0]);
        
        x_dot = 1000*(M_mat\[ FI+FA+Fg-F_0; MI+MA-M_0]);

%         x_dot = 1000*(M_mat\[ FA+Fg-F_0; MA-M_0]);

%         x_dot = 1000*(M_mat\[ FI+FA+Fg; MI+MA]);
