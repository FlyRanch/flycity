...
add_paths = { 'C:/Users/Johan/Desktop/Flycity_Analysis_Program'; ...
              ...
              'C:/Users/Johan/Desktop/Flycity_Analysis_Program/Polynomial_Fit'; ...
              'C:/Users/Johan/Desktop/Flycity_Analysis_Program/Dynamic_Model'; ...
              'C:/Users/Johan/Desktop/Flycity_Analysis_Program/Dynamic_Model/Conservation_test'; ...
              'C:/Users/Johan/Desktop/Flycity_Analysis_Program/Dynamic_Model/Stationary_simulation'; ...
              ...
              'C:/Users/Johan/Desktop/Flycity_Analysis_Program/Validation'; ...
             };
...
%     settings.filter_set.qW2 = [ 0 0 0 1/pathDB.dt^2 1/pathDB.dt^2 1/pathDB.dt^2 1 1 1 1 ];
    ...
    % Rotational lift on / off ( 1 / 0 )
    
    settings.rot_lift_on = 1;
...
% Perform a dynamic simulation of the maneuvering wingbeats:

if exist('pathDB8.mat')==2
    temp = load('pathDB8.mat');

        pathDB.DynSim_avg       = temp.DynSim_avg;
        pathDB.DynSim_man       = temp.DynSim_man;
        pathDB.DynSim_steady    = temp.DynSim_steady;
        
    'loaded'
    clear temp
else
    Dynamic_Model_Validation( settings, pathDB )
    temp = load('pathDB8.mat');
...
% Maneuvering_flight_model_plots( settings, pathDB )

% DynSim_chapter_plots( settings, pathDB, 5 )

% polynomial_fits_plots( settings, pathDB )

% body_and_wing_model_plots( settings, pathDB )

% Kalman_filt_plots(settings,pathDB)

% Force_Moment_evaluation( settings, pathDB )

% Flight_trajectory_plot( settings, pathDB)

% for k = 1:settings.nr_of_seq
% Flight_trajectory_plot( settings, pathDB , k)
% end


% robofly_analyzer_maneuvers( settings, pathDB )


% Maneuvering_wingkin_plots( settings, pathDB )

% dyn_sim_test_man(settings,pathDB)

% dyn_sim_test(settings,pathDB)

% Dyn_Sim_3D_plot_steady( settings, pathDB, 'wb_1679' )
% Dyn_Sim_3D_plot_steady( settings, pathDB, 'wb_1692' )
% Dyn_Sim_3D_plot_steady( settings, pathDB, 'wb_1767' )
% Dyn_Sim_3D_plot_steady( settings, pathDB, 'wb_1570' )
% Dyn_Sim_3D_plot_steady( settings, pathDB, 'wb_1587' )
% Dyn_Sim_3D_plot_steady( settings, pathDB, 'wb_1775' )
% pathDB.maneuver.ax.249
% 

% Dynamic_simulation_plot2( settings, pathDB, 'wx', 'wb_122', 1 )

% Dynamic_simulation_plot2( settings, pathDB, 'wx', 'wb_122', 1 )

% Dynamic_simulation_plot2( settings, pathDB, 'ax', 'wb_249', 1 )
% Dynamic_simulation_plot2( settings, pathDB, 'ay', 'wb_450', 1 )
% Dynamic_simulation_plot2( settings, pathDB, 'az', 'wb_404', 1)
% Dynamic_simulation_plot2( settings, pathDB, 'wx', 'wb_210', 1 )
% Dynamic_simulation_plot2( settings, pathDB, 'wy', 'wb_90', 1 )
% Dynamic_simulation_plot2( settings, pathDB, 'wz', 'wb_276', 1 )
% Dynamic_simulation_plot2( settings, pathDB, 'wx', 'wb_212', 1 )
%
%
%
% [kine_avg, kine_man, FM_avg, FM_man] = Dynamic_simulation_plot( settings, pathDB, 'wx', 'wb_212', 0 )
% pause
% 
% Dyn_Sim_3D_plot_man( settings, pathDB, 'ax_wb_39' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'ay_wb_384' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'az_wb_269' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'wx_wb_190' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'wy_wb_12' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'wz_wb_111' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'wx_wb_42' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'wy_wb_67' )
% Dyn_Sim_3D_plot_man( settings, pathDB, 'wz_wb_253' )


% Model_plots( settings, pathDB )

Aero_Inertia_damping( settings, pathDB )

% Dynamic_Model_Validation( settings, pathDB )

% [kine_avg, kine_man, FM_avg, FM_man] = Dynamic_simulation_plot( settings, pathDB, 'ax', 'wb_10', 0 )

% Dynamic_simulation( settings, pathDB, 'ax', 'wb_10' )

% Conservation_test_polynomial( settings, pathDB )

% Conservation_test_sine( settings, pathDB )

% RK_simulation(settings,pathDB)
