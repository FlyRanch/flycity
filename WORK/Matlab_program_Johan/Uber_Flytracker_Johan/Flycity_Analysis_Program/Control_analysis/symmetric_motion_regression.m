function [ c_fit ] = symmetric_motion_regression( maneuver, down_up_glob)
    ...
    b_theta_n_0    = zeros(n_pol_theta*2+2,3,6);
    b_eta_n_0      = zeros(n_pol_eta*2+2,3,6);
    b_phi_n_0      = zeros(n_pol_phi*2+2,3,6);
    b_theta_p_0    = zeros(n_pol_theta*2+2,3,6);
    b_eta_p_0      = zeros(n_pol_eta*2+2,3,6);
    b_phi_p_0      = zeros(n_pol_phi*2+2,3,6);
    ...
    for k = 1:6
        ...
        if k <= 3
            ...
            b_theta_n_0(:,:,k)   = b.theta_n_0;
            b_eta_n_0(:,:,k)     = b.eta_n_0;
            b_phi_n_0(:,:,k)     = b.phi_n_0;

            b_theta_p_0(:,:,k)   = b.theta_p_0;
            b_eta_p_0(:,:,k)     = b.eta_p_0;
            b_phi_p_0(:,:,k)     = b.phi_p_0;
    ...
    c_fit.b_theta_n_0  = b_theta_n_0;
    c_fit.b_eta_n_0    = b_eta_n_0;
    c_fit.b_phi_n_0    = b_phi_n_0;
    c_fit.b_theta_p_0  = b_theta_p_0;
    c_fit.b_eta_p_0    = b_eta_p_0;
    c_fit.b_phi_p_0    = b_phi_p_0;
