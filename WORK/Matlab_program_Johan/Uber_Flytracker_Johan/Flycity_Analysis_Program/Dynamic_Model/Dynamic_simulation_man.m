function [kine_man, sim_data] = Dynamic_simulation_man( settings, pathDB, body_IC, maneuver_type, wb_name, seq_nr, case_nr )
...
%     a_man_theta_L   = pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_avg.theta_L+pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_dev.theta_L;
%     a_man_eta_L     = pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_avg.eta_L+pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_dev.eta_L;
%     a_man_phi_L     = pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_avg.phi_L+pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_dev.phi_L;
%     a_man_theta_R   = pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_avg.theta_R+pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_dev.theta_R;
%     a_man_eta_R     = pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_avg.eta_R+pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_dev.eta_R;
%     a_man_phi_R     = pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_avg.phi_R+pathDB.maneuver.(char(maneuver_type)).(char(wb_name)).a_dev.phi_R;
