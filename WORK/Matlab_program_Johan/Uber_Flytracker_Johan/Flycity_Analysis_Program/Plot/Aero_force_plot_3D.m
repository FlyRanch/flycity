function Aero_force_plot_3D( settings, pathDB, seq_nr, wb_nr)
...
%     Rb_avg = quat2mat(qb_avg);
    ...
    hold on
    subplot(2,2,1); Aero_force_plot( [0; 0; 0], Rb_1, kine.RL, kine.RR, a_fit.down_up, FA_L, FA_R, body_model, wing_model, 1)
    ...
    view([0,1,0])
    subplot(2,2,2); Aero_force_plot( [0; 0; 0], Rb_2, kine.RL, kine.RR, a_fit.down_up, FA_L, FA_R, body_model, wing_model, 2)
    axis([minx maxx miny maxy minz maxz])
    xlabel('x [mm]','FontSize',10)
    set(gca, 'XTick', [-4,0,4],'FontSize',10);
    ylabel('y [mm]','FontSize',10)
    ...
    view([0,-1,0])
    subplot(2,2,3); Aero_force_plot( [0; 0; 0], Rb_3, kine.RL, kine.RR, a_fit.down_up, FA_L, FA_R, body_model, wing_model, 0)
    axis([minx maxx miny maxy minz maxz])
    xlabel('x [mm]','FontSize',10)
    set(gca, 'XTick', [-4,0,4],'FontSize',10);
    ylabel('y [mm]','FontSize',10)
    ...
    view([1,0,0])
    subplot(2,2,4); Aero_force_plot( [0; 0; 0], Rb_4, kine.RL, kine.RR, a_fit.down_up, FA_L, FA_R, body_model, wing_model, 0)
    axis([minx maxx miny maxy minz maxz])
    xlabel('x [mm]','FontSize',10)
    set(gca, 'XTick', [-4,0,4],'FontSize',10);
    ylabel('y [mm]','FontSize',10)
