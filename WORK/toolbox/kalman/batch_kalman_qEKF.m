...
function [q,omega,settings_EKF] = batch_kalman_qEKF(q_obs,t,settings,plotting,saving)
...
for i=1:size(q1_obs,2)
    ...
    [qsmooth1,qsmooth2,qsmooth3,qsmooth4,omega_now_1,omega_now_2,omega_now_3,settings_EKF] = filter_body(q1_raw,q2_raw,q3_raw,q4_raw,dt);
