...
% 
% MoveModelNameS = {MoveModelName1 MoveModelName2 MoveModelName3 MoveModelName4}'

%% 10 steps movement model
MoveModelName1 = 'MoveModel_IncSearch_20120724_S0002_frame1806-1932_movemodel_MDLTzup_10step.mat';
MoveModelName2 = 'MoveModel_NOsearch_20120724_S0002_frame1806-1932_movemodel_MDLTzup_10step.mat';

MoveModelNameS = {MoveModelName1 MoveModelName2}'

% MoveModelPath = '/media/FLYDATA1/DBMoveModel/';
MoveModelPath = '/home/florian/Dropbox/Projects/flytracker/DBMoveModel/';
...
numframes = floor(endframe-startframe+1)/10;
frames2skip = [];
% framesample = 1;
framesample = 10;
...
% Dh 10 steps (?)
WingSearchDist = [15 20];
BodySearchDist = [50 50];
% BodySearchDist = [80 80];
...
% srcdkf_const(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,useIC,plot_data);
% srcdkf_const_variablestep(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,useIC,plot_data);
srcdkf_const_variablestep_NOWING(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,useIC,plot_data);
% srcdkf_const_NOpredict2(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,useIC,plot_data);
% srcdkf_const_NOpredict(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,useIC);
