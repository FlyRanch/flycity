...
if getImageData
    ...
    % make move model dir
        mkdir(PAR.solutionpath,['MoveModel']);
...
%     save([PAR.solutionpath  PAR.solutiondirname '/MoveModel_' PAR.solutiondirname],'MoveModel');

%     MoveModel = auto_init_multi_nosearch(ManualFit,PAR.ICframe,'IC_mult');
%     save([PAR.solutionpath,'MoveModel/MoveModel_nosearch_' PAR.solutiondirname],'MoveModel');

    MoveModel = auto_init_multi(ManualFit,PAR.ICframe,'IC_mult');
    save([PAR.solutionpath,'MoveModel/MoveModel_IncSearch_' PAR.solutiondirname],'MoveModel');
