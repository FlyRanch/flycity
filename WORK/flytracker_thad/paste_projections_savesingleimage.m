...
function paste_projections_savesingleimage
% clear
clc;
close all
warning off
...
%         toc
        ...
        cd ..
            ...
            % save single images
            saveas(figure(11),['flyimage_cam1_' sprintf(['%0',num2str(PAR.digits),'d'], frame) '.jpg'])
            saveas(figure(12),['flyimage_cam2_' sprintf(['%0',num2str(PAR.digits),'d'], frame) '.jpg'])
            saveas(figure(13),['flyimage_cam3_' sprintf(['%0',num2str(PAR.digits),'d'], frame) '.jpg'])
