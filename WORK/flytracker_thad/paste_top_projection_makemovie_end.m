...
function paste_top_projection_makemovie_end
% clear
clc;
close all
warning off
...
fps = 7500/skip;
    ...
    if cams == 1;
        movfilename = ['side1_projection_end_',num2str(fps),'fps.avi'];
    elseif cams == 2;
        movfilename = ['side2_projection_end_',num2str(fps),'fps.avi'];
    elseif cams == 3;
        movfilename = ['top_projection_end_',num2str(fps),'fps.avi'];
    end
