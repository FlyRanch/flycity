...
% % hydei
% KineName = 'kine_20120724_S0002_fr1566_MDLT_zdown.mat';
...
if getIC == true
    ...
    %% make movement model
%     MovModel = auto_init_multi(ManualFit,PAR.ICframe,'IC_mult');
%     save([PAR.solutionpath  PAR.solutiondirname '/MovModel_' PAR.solutiondirname],'MovModel');
    MovModel = auto_init_multi_nosearch(ManualFit,PAR.ICframe,'IC_mult');
    save([PAR.solutionpath  PAR.solutiondirname '/MovModel_nosearch_' PAR.solutiondirname],'MovModel');
