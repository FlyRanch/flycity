...
%     R_JR    = body_model.Joint_right;
    ...
    I_body  = body_model.Inertia-m_body*(d^2);
    
    I_vw_L    = wing_model.virtual_Inertia;
    I_vw_R    = wing_model.virtual_Inertia;
...
%     I_vw_L    = wing_model.virtual_Inertia+m_vw*(R_cg_L*R_cg_L');
%     I_vw_R    = wing_model.virtual_Inertia+m_vw*(R_cg_R*R_cg_R');
% 
%     I_vw_L    = zeros(3);
%     I_vw_R    = zeros(3);
...
%     
    ...
    M21     = M12';
    M22     = I_body+RL'*I_vw_L*RL+RR'*I_vw_R*RR+m_vw*(-c_JL-RL'*c_cg_L*RL)'*(-c_JL-RL'*c_cg_L*RL)+m_vw*(-c_JR-RR'*c_cg_R*RR)'*(-c_JR-RR'*c_cg_R*RR);
    M23     = RL'*I_vw_L*RL+m_vw*(-c_JL-RL'*c_cg_L*RL)'*(-RL'*c_cg_L*RL);
    M24     = RR'*I_vw_R*RR+m_vw*(-c_JR-RR'*c_cg_R*RR)'*(-RR'*c_cg_R*RR);
    M31     = M13';
    M32     = M23';
    M33     = RL'*I_vw_L*RL+m_vw*(-RL'*c_cg_L*RL)'*(-RL'*c_cg_L*RL);
    M34     = zeros(3);
    M41     = M14';
    M42     = M24';
    M43     = zeros(3);
    M44     = RR'*I_vw_R*RR+m_vw*(-RR'*c_cg_R*RR)'*(-RR'*c_cg_R*RR);
