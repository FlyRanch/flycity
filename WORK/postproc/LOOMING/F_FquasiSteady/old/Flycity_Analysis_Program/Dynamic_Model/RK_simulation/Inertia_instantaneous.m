function [ FM_b, FM_strkpln ] = Inertia_instantaneous( kine, body_model, wing_model )
    ...
    F_vel_b = (-w_b_dL_dv_b-M_dot_12*wb-M_dot_13*wL_b- ...
                    M13*w_dot_L_b-M_dot_14*wR_b-M14*w_dot_R_b);

%     F_vel_b = (-M13*w_dot_L_b-M14*w_dot_R_b-M_dot_13*wL_b-M_dot_14*wR_b);

%     F_vel_b = (-M13*w_dot_L_b-M14*w_dot_R_b);

%     F_vel_b = (-M_dot_13*wL_b-M_dot_14*wR_b);

    M_acc_b = [M21 M22]*[ab; w_dot_b]; 

    M_vel_b = (-v_b_dL_dv_b-w_b_dL_dw_b-M_dot_21*vb-M_dot_22*wb- ...
                    M_dot_23*wL_b-M23*w_dot_L_b-M_dot_24*wR_b-M24*w_dot_R_b);


%     M_vel_b = (-M23*w_dot_L_b-M24*w_dot_R_b-M_dot_23*wL_b-M_dot_24*wR_b);
    
%     M_vel_b = (-M23*w_dot_L_b-M24*w_dot_R_b);

%     M_vel_b = (-M_dot_23*wL_b-M_dot_24*wR_b);
