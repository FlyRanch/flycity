...
for seq = 1:size(n_down_start_L,2)
    for wb = 2:size(n_down_start_L,1)-1
        ...
        if n_down_start_L_now > n_first(seq) && n_up_stop_L_now < n_post(seq) && ...
            ...
            subplot(3,3,4)
            plot(roll_dot_wb_interp,'color',plot_color)
            hold on
            subplot(3,3,5)
            plot(pitch_dot_wb_interp,'color',plot_color)
            hold on
            subplot(3,3,6)
            plot(yaw_dot_wb_interp,'color',plot_color)
            hold on
            subplot(3,3,7)
            plot(F_wb_interp,'color',plot_color)
            hold on
            subplot(3,3,8)
            plot(Fsp_roll_wb_interp,'color',plot_color)
            hold on
            subplot(3,3,9)
            plot(Fsp_pitch_wb_interp,'color',plot_color)
            hold on
