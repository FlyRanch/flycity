figure
subplot(3,1,1)
title('Pitch Accel wing mod','fontsize',12)
hold on
subplot(3,1,2)
% title('wing pitch')
hold on
...
t_hist = [t_wb_PitchAccel_bins t_wb_PitchAccel_bins];
t_hist = t_hist(:);
binx = 0:1/(nx-1):1;
...
%% plot polinomials
% subplot(3,1,1)
% plot_WBfitting_singlevar_updowncut(strokeMOD_PitchAccel_fit_binmean_periodic,'r','g');
% % plot_WBfitting_singlevar_updowncut(strokeMOD_PitchAccel_fit_binmean,'g');
% 
% subplot(3,1,2)
% plot_WBfitting_singlevar_updowncut(pitchMOD_PitchAccel_fit_binmean_periodic,'r','g');
% % plot_WBfitting_singlevar_updowncut(pitchMOD_PitchAccel_fit_binmean,'g');
% 
% subplot(3,1,3)
% plot_WBfitting_singlevar_updowncut(devMOD_PitchAccel_fit_binmean_periodic,'r','g');
% % plot_WBfitting_singlevar_updowncut(devMOD_PitchAccel_fit_binmean,'g');


%% polynomials
subplot(3,1,1)
calc_val_fourier_series_4thN8th_order(binx,strokeMOD_PitchAccel_fourier_coeffs_binmean,plot_fits);
...
subplot(3,1,2)
calc_val_fourier_series_4thN8th_order(binx,pitchMOD_PitchAccel_fourier_coeffs_binmean,plot_fits);
...
subplot(3,1,3)
calc_val_fourier_series_4thN8th_order(binx,devMOD_PitchAccel_fourier_coeffs_binmean,plot_fits);
