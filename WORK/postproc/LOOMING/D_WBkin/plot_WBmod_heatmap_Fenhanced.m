figure
subplot(3,1,1)
title('Fenhance wing mod','fontsize',12)
hold on
subplot(3,1,2)
% title('wing pitch')
hold on
...
% % plot_WBfitting_singlevar_updowncut(strokeMOD_Fenhance_fit_binmean,'g');
% 
% subplot(3,1,2)
% plot_WBfitting_singlevar_updowncut(pitchMOD_Fenhance_fit_binmean_periodic,'r','g');
% % plot_WBfitting_singlevar_updowncut(pitchMOD_Fenhance_fit_binmean,'g');
% 
% subplot(3,1,3)
% plot_WBfitting_singlevar_updowncut(devMOD_Fenhance_fit_binmean_periodic,'r','g');
% % plot_WBfitting_singlevar_updowncut(devMOD_Fenhance_fit_binmean,'g');

%% polynomials
subplot(3,1,1)
calc_val_fourier_series_4thN8th_order(binx,strokeMOD_Fenhance_fourier_coeffs_binmean,plot_fits);
% plot(strokeMOD_Fenhance_fourier_fit_binmean);
legend off
xlabel([],'fontsize',10) 
ylabel('wing stroke','fontsize',10) 

subplot(3,1,2)
calc_val_fourier_series_4thN8th_order(binx,pitchMOD_Fenhance_fourier_coeffs_binmean,plot_fits);
% plot(pitchMOD_Fenhance_fourier_fit_binmean);
legend off
xlabel([],'fontsize',10) 
ylabel('wing pitch','fontsize',10) 

subplot(3,1,3)
calc_val_fourier_series_4thN8th_order(binx,devMOD_Fenhance_fourier_coeffs_binmean,plot_fits);
% plot(devMOD_Fenhance_fourier_fit_binmean);
legend off
