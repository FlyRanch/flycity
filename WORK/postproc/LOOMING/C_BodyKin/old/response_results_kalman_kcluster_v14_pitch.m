...
%% heatmap hist roll vs slip NO STEADY
binx = -180:5:180;
biny = -180:5:180;
...
Apitch_hist = hist3([A_hist,pitch_hist], {biny binx});
Apitch_hist_log = log(Apitch_hist);

figure
imagesc(binx,-biny,Apitch_hist_log)
% axis equal
axis([-180 180 -20 20])
set(gca,'XTick',-180:90:180) 
set(gca,'YTick',-20:10:20,'YTicklabel',20:-10:-20,'fontsize',12)
xlabel('pitch','fontsize',18) 
ylabel('An','fontsize',18) 
colorbar

saveas(gca,'Anpitch_hist_all.fig')
saveas(gca,'Anpitch_hist_all.png')
plot2svg('Anpitch_hist_all.svg')

%% heatmap hist An vs pitch NO STEADY
binx = -180:5:180;
biny = -20:.5:20;

pitch_hist = pitch(IDX~=5);
A_hist = An_hor(IDX~=5);
...
saveas(gca,'Anpitch_hist_NOSTEADY.fig')
saveas(gca,'Anpitch_hist_NOSTEADY.png')
plot2svg('Anpitch_hist_NOSTEADY.svg')
...
saveas(gca,'Atpitch_hist_all.fig')
saveas(gca,'Atpitch_hist_all.png')
plot2svg('Atpitch_hist_all.svg')

%% heatmap hist At vs pitch NO STEADY
binx = -180:5:180;
biny = -20:.5:20;
...
saveas(gca,'Atpitch_hist_NOSTEADY.fig')
saveas(gca,'Atpitch_hist_NOSTEADY.png')
plot2svg('Atpitch_hist_NOSTEADY.svg')
...
saveas(gca,'Apitch_hist_all.fig')
saveas(gca,'Apitch_hist_all.png')
plot2svg('Apitch_hist_all.svg')

%% heatmap hist A vs pitch NO STEADY
binx = -180:5:180;
biny = 0:.5:20;
...
saveas(gca,'Apitch_hist_NOSTEADY.fig')
saveas(gca,'Apitch_hist_NOSTEADY.png')
plot2svg('Apitch_hist_NOSTEADY.svg')
