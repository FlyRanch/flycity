...
loadname=('flightpathDB_pos_qbodyEKF_INCroll_9clusters_2.5n-3.3n3_startframe2945.mat')
if exist(loadname) ~= 2
...
roll_dot_dot_pre_mirror = calc_value(roll_dot_dot,n_turn_start);
...
NwbSteady_RollAccel_max_min = dt_RollAccel_max_min*f_wb_steady_meanCIstd(1);
NwbSteady_YawAccel_max_min = dt_YawAccel_max_min*f_wb_steady_meanCIstd(1);
NwbSteady_PitchAccel_max_min = dt_PitchAccel_max_min*f_wb_steady_meanCIstd(1);
...
plot_maneuver_timing_vs_StimAnglePre_mirror

saveas(gca,'maneuver_timing_vs_StimAnglePre_mirror_LnR.fig')
saveas(gca,'maneuver_timing_vs_StimAnglePre_mirror_LnR.png')
plot2svg('maneuver_timing_vs_StimAnglePre_mirror_LnR.svg')
