...
loadname = 'kinflightpathDB_pos_qbodyEKF_INCroll_9clusters_2.5n-3.3n3_strokeplane47.5deg_startframe2945_tmp.mat';
load(loadname)
...
%% subset
% subset_seqs=[7;60;4;13;11];
subset_seqs = [59;26;48;66;30;92;22];
...
% subset
MSfig2_escape_dir_colorcode_subsetNgrey
% MSfig2_stimangle_postVSpre
MSfig2_stimangle_postVSpre_MAXatTstop
MSfig2_stimangle_postVSpre_MAXatTstop_stimspeed

saveas(gca,'MSfig2_escape_dir_colorcode_subset.fig')
saveas(gca,'MSfig2_escape_dir_colorcode_subset.png')
plot2svg('MSfig2_escape_dir_colorcode_subset.svg')
...
% subset
MSfig3_body_dyn_colorcode_subsetNgrey
saveas(gca,'MSfig3_body_dyn_colorcode_subset.fig')
saveas(gca,'MSfig3_body_dyn_colorcode_subset.png')
plot2svg('MSfig3_body_dyn_colorcode_subset.svg')
