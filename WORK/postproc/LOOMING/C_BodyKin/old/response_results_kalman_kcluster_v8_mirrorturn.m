...
%% headingNyaw post vs heading pre
figure
...
xlabel('initial heading','fontsize',18) 
ylabel('escape angle','fontsize',18) 
set(gca,'xlim',[-180 180],'ylim',[-180 180])
set(gca,'XTick',[-180 -90 0 90 180])
set(gca,'YTick',[-180 -90 0 90 180])
grid on

saveas(gca,'headingNyawpost_vs_headingpre.fig')
saveas(gca,'headingNyawpost_vs_headingpre.png')

%% headingNyaw post vs heading pre MIRROR
figure
plot(360,360,'ok','MarkerFaceColor','r','markersize',5)
hold on
plot(360,360,'ok','MarkerFaceColor','b','markersize',5)
...
saveas(gca,'headingNyawpost_vs_headingpre_MIRROR.fig')
saveas(gca,'headingNyawpost_vs_headingpre_MIRROR.png')

%% headingNyaw post vs yaw pre
figure
plot(360,360,'ok','MarkerFaceColor','r','markersize',5)
hold on
plot(360,360,'ok','MarkerFaceColor','b','markersize',5)
...
saveas(gca,'headingNyawpost_vs_yawpre.fig')
saveas(gca,'headingNyawpost_vs_yawpre.png')

%% headingNyaw post vs yaw pre MIRROR
figure
plot(360,360,'ok','MarkerFaceColor','r','markersize',5)
hold on
plot(360,360,'ok','MarkerFaceColor','b','markersize',5)
...
saveas(gca,'headingNyawpost_vs_yawpre_MIRROR.fig')
saveas(gca,'headingNyawpost_vs_yawpre_MIRROR.png')

%% heading post vs heading pre MIRRORED
...
ylabel('heading post','fontsize',18) 
set(gca,'xlim',[0 180],'ylim',[-90 90])
set(gca,'XTick',[-180 -90 0 90 180])
set(gca,'YTick',[-180 -90 0 90 180],'fontsize',12)
grid on

saveas(gca,'heading_pre_vs_post_mirrored.fig')
saveas(gca,'heading_pre_vs_post_mirrored.png')
...
saveas(gca,'yaw_pre_vs_post.fig')
saveas(gca,'yaw_pre_vs_post.png')

%% yaw post vs yaw pre MIRRORED
...
xlabel('yaw pre','fontsize',18) 
ylabel('yaw post','fontsize',18) 
set(gca,'xlim',[0 180],'ylim',[-90 90])
set(gca,'XTick',[-180 -90 0 90 180])
set(gca,'YTick',[-180 -90 0 90 180],'fontsize',12)
grid on

saveas(gca,'yaw_pre_vs_post_mirrored.fig')
saveas(gca,'yaw_pre_vs_post_mirrored.png')
