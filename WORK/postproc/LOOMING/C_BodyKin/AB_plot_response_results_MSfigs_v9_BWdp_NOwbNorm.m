...
steady_name = dir('WBdataset_steady_1*')
...
%% save attitude data for statistics & clusters
cd ..
save('clusters.mat','n1','n2','n3','n4','subset_cut','subset_mid')

calc_dhdt_abs
calc_drolldt_abs
calc_dpitchdt_abs
calc_dyawdt_abs
save('turn_speed.mat','n_seqs',...
    'dhdt','dhdt_max','dhdtMaxMean','dhdtMaxMedian','dhdtMaxMode','dhdtMaxSTE','dhdtMaxQuartiles','dhdWBMaxMean','dhdWBMaxMedian','dhdWBMaxMode','dhdWBMaxSTE','dhdWBMaxQuartiles',...
    'drolldt','drolldt_max','drolldtMaxMean','drolldtMaxMedian','drolldtMaxMode','drolldtMaxSTE','drolldWBMaxMean','drolldWBMaxMedian','drolldWBMaxMode','drolldWBMaxSTE',...
    'dpitchdt','dpitchdt_max','dpitchdtMaxMean','dpitchdtMaxMedian','dpitchdtMaxMode','dpitchdtMaxSTE','dpitchdWBMaxMean','dpitchdWBMaxMedian','dpitchdWBMaxMode','dpitchdWBMaxSTE',...
    'dyawdt','dyawdt_max','dyawdtMaxMean','dyawdtMaxMedian','dyawdtMaxMode','dyawdtMaxSTE','dyawdWBMaxMean','dyawdWBMaxMedian','dyawdWBMaxMode','dyawdWBMaxSTE')

attitudes_atAmaxNmean_4statistics
mkdir('MSfigs_BodyDyn')
cd('MSfigs_BodyDyn')
...
MSfig2_stimangle_postVSpre_MAXatTstop_stimspeedBW
...
%% Suppl Figs: FnVheading

% cluster1
MSfigS1_FnVheading_cluster1
saveas(gca,'MSfigS1_FnVheading_cluster1.fig')
saveas(gca,'MSfigS1_FnVheading_cluster1.png')
plot2svg('MSfigS1_FnVheading_cluster1.svg')

% cluster2
MSfigS2_FnVheading_cluster2
saveas(gca,'MSfigS2_FnVheading_cluster2.fig')
saveas(gca,'MSfigS2_FnVheading_cluster2.png')
plot2svg('MSfigS2_FnVheading_cluster2.svg')

% cluster3
MSfigS3_FnVheading_cluster3
saveas(gca,'MSfigS3_FnVheading_cluster3.fig')
saveas(gca,'MSfigS3_FnVheading_cluster3.png')
plot2svg('MSfigS3_FnVheading_cluster3.svg')

% cluster4
MSfigS4_FnVheading_cluster4
saveas(gca,'MSfigS4_FnVheading_cluster4.fig')
saveas(gca,'MSfigS4_FnVheading_cluster4.png')
plot2svg('MSfigS4_FnVheading_cluster4.svg')

%% Suppl Figs: body dyn clusters
% cluster1
MSfigS1_bodydyn_cluster1
saveas(gca,'MSfigS1_body_dyn_cluster1.fig')
saveas(gca,'MSfigS1_body_dyn_cluster1.png')
plot2svg('MSfigS1_body_dyn_cluster1.svg')

% cluster2
MSfigS1_bodydyn_cluster2
saveas(gca,'MSfigS2_body_dyn_cluster2.fig')
saveas(gca,'MSfigS2_body_dyn_cluster2.png')
plot2svg('MSfigS2_body_dyn_cluster2.svg')

% cluster3
MSfigS1_bodydyn_cluster3
saveas(gca,'MSfigS3_body_dyn_cluster3.fig')
saveas(gca,'MSfigS3_body_dyn_cluster3.png')
plot2svg('MSfigS3_body_dyn_cluster3.svg')

% cluster4
MSfigS1_bodydyn_cluster4
saveas(gca,'MSfigS4_body_dyn_cluster4.fig')
saveas(gca,'MSfigS4_body_dyn_cluster4.png')
plot2svg('MSfigS4_body_dyn_cluster4.svg')
...
% clusters
MSfig3_body_dyn_colorcode_MEANclusters_droll
...
figure
MSfig3_attitudesMEAN_vs_stimanglePRE_droll
MSfig3_attitudesAtAmax_vs_stimanglePRE_droll
MSfig3_rotaxisangle_vs_stimangleNturnangle_atAmax_droll
MSfig3_rotaxisangle_vs_stimNturnangle_atAmax_stimspeedBW_droll
...
% title('heading histogram','fontsize',10) 
saveas(gca,'MSfig2_heading_vector_mirror_rose_pre_colorpre_small.fig')
saveas(gca,'MSfig2_heading_vector_mirror_rose_pre_colorpre_small.png')
plot2svg('MSfig2_heading_vector_mirror_rose_pre_colorpre_small.svg')
