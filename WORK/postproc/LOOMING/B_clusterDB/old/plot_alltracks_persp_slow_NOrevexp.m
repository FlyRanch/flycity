...
%% make persp view movie

if perspview == true
    movie_step = 15;
    fps = 7500/15;
    movfilename = ['3Dflightpaths_perspview_slow_NOrevexp_obs_',num2str(fps),'fps.avi'];
%     movfilename = ['3Dflightpaths_perspview_slow_NOrevexp_',num2str(fps),'fps.avi'];
