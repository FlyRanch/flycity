...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mrollaccel_dMODvalue_allNOfreqMOD.png')
...
% xlabel('MOD value')
% ylabel('M')
% saveas(gca, 'Mrollaccel_dMODvalue_freqMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mrollaccel_dMODvalue_strokeMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mrollaccel_dMODvalue_pitchMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mrollaccel_dMODvalue_devMOD.png')
...
xlabel('MOD value')
ylabel('Mroll')
saveas(gca, 'Mrollaccel_dMODvalue_compare.png')
