...
% file_name = [save_name,'_allleft_altSteady_mirror0_'];
...
file_name = [save_name,'_allright_altStill_mirror1_'];
makeDB_allNOfreqMODs_cali_interp
...
%     Mz_mean_allNOfreq = (Mz_mean_allNOfreq_right + Mz_mean_allNOfreq_left)/2;
    ...
    Fx_mean_allNOfreq = (Fx_mean_allNOfreq_right + Fx_mean_allNOfreq_left)/2;
    Fy_mean_allNOfreq = (Fy_mean_allNOfreq_right - Fy_mean_allNOfreq_left);
    Fz_mean_allNOfreq = (Fz_mean_allNOfreq_right + Fz_mean_allNOfreq_left)/2;

    Mx_mean_allNOfreq = (Mx_mean_allNOfreq_right - Mx_mean_allNOfreq_left);
    My_mean_allNOfreq = (My_mean_allNOfreq_right - My_mean_allNOfreq_left);
    Mz_mean_allNOfreq = (Mz_mean_allNOfreq_right + Mz_mean_allNOfreq_left)/2;
else
    error = 'allNOfreq'
    pause
...
save(['borf_db_',save_name,'_cali_alldata_LnRseparate.mat'])
...
save(['borf_db_',save_name,'_cali_means_LnRseparate.mat'])
