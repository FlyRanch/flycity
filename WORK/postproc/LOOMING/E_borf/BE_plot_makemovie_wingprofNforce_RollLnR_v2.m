...
mkdir(['RollAccel_mov_figs2'])
cd(['RollAccel_mov_figs2'])
...
for j = 1:length(steps)
    ...
    hold off
        ...
        h=quiver(x_wing,y_wing,Fx_tip,Fy_tip,'linewidth',3,'color',F_map(1,:));
        adjust_quiver_arrowhead_size(h, 5);
        hold on
        plot([x_LE x_TE],[y_LE y_TE],'-','linewidth',5,'color',cord_map(1,:))
        plot([x_LE],[y_LE],'o','markersize',10,'markerfacecolor',cord_map(1,:),'color',cord_map(1,:))
        ...
        h=quiver(x_wing,y_wing,Fx_tip,Fy_tip,'linewidth',3,'color',F_map(2,:));
        adjust_quiver_arrowhead_size(h, 5);
        hold on
        plot([x_LE x_TE],[y_LE y_TE],'-','linewidth',5,'color',cord_map(2,:))
        plot([x_LE],[y_LE],'o','markersize',10,'markerfacecolor',cord_map(2,:),'color',cord_map(2,:))
