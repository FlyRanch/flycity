...
savename = ([loadname(1:end-4),'_9clusters_',num2str(At_hor_thresh),'n',num2str(At_hor_thresh_min),'n',num2str(An_hor_thresh),'_startframe',num2str(start_frame),'_strokeplane',strokeplane_angle,'deg.mat']);
