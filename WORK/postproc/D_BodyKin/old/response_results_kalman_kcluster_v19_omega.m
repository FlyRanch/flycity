...
dyaw = pathDB.dyaw;
dpitch = pathDB.dpitch;
droll = pathDB.droll;

yaw_dot = pathDB.yaw_dot;
pitch_dot = pathDB.pitch_dot;
roll_dot = pathDB.roll_dot;
...
%% MIRROR ATTITUDES based on yaw_max
yaw_max_mirror = calc_max_abs_value(yaw,n_pre,n_post);
...
for i=1:length(yaw_max_mirror)
    if yaw_max_mirror(i) < 0
...
%% YawNpitchDOTmax vs headingPre CIRC MEAN MIRROR
figure

plot_YawNpitchDOTmax_vs_headingPre

saveas(gca,'rollN_Dpitch_mean_vs_headingPre_AnMIRROR.fig')
saveas(gca,'rollN_Dpitch_mean_vs_headingPre_AnMIRROR.png')
plot2svg('rollN_Dpitch_mean_vs_headingPre_AnMIRROR.svg')

%% YawNpitchDOTmean vs headingPre CIRC MEAN MIRROR
figure

plot_YawNpitchDOTmean_vs_headingPre

saveas(gca,'rollN_Dpitch_mean_vs_headingPre_AnMIRROR.fig')
saveas(gca,'rollN_Dpitch_mean_vs_headingPre_AnMIRROR.png')
plot2svg('rollN_Dpitch_mean_vs_headingPre_AnMIRROR.svg')

%% rollYawDpitch mean vs heading pre CIRC MEAN AnMIRROR CIRC MEAN
figure

% plot_rollNpitch_Amax_vs_headingPre_MIRROR
plot_rollYawDpitch_mean_vs_headingPre_MIRROR

saveas(gca,'rollN_Dpitch_mean_vs_headingPre_AnMIRROR.fig')
saveas(gca,'rollN_Dpitch_mean_vs_headingPre_AnMIRROR.png')
plot2svg('rollN_Dpitch_mean_vs_headingPre_AnMIRROR.svg')

%% rollYawDpitch mean&Amax vs heading pre CIRC MEAN AnMIRROR CIRC MEAN
figure

% plot_rollNpitch_Amax_vs_headingPre_MIRROR
plot_rollYawDpitch_meanAmax_vs_headingPre_MIRROR

saveas(gca,'rollN_Dpitch_meanAmax_vs_headingPre_AnMIRROR.fig')
saveas(gca,'rollN_Dpitch_meanAmax_vs_headingPre_AnMIRROR.png')
plot2svg('rollN_Dpitch_meanAmax_vs_headingPre_AnMIRROR.svg')

%% rollYawDpitch Amax vs heading pre CIRC MEAN AnMIRROR CIRC MEAN
figure

% plot_rollNpitch_Amax_vs_headingPre_MIRROR
plot_rollYawDpitch_Amax_vs_headingPre_MIRROR

saveas(gca,'rollN_Dpitch_Amax_vs_headingPre_AnMIRROR.fig')
saveas(gca,'rollN_Dpitch_Amax_vs_headingPre_AnMIRROR.png')
plot2svg('rollN_Dpitch_Amax_vs_headingPre_AnMIRROR.svg')
