...
%             Mz_now(j,:) = Mz_robo(j,:) - Mz_cali_L(j) - Mz_cali_R(j);
        ...
        Fx_all(1:length(t_now),:,n) = Fx_now;
        Fy_all(1:length(t_now),:,n) = Fy_now;
        Fz_all(1:length(t_now),:,n) = Fz_now;

        Mx_all(1:length(t_now),:,n) = Mx_now;
        My_all(1:length(t_now),:,n) = My_now;
        Mz_all(1:length(t_now),:,n) = Mz_now;
    end
end
