...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mpitchaccel_MODvalue_allMOD.png')
...
xlabel('freq')
ylabel('M')
saveas(gca, 'Mpitchaccel_freq_freqMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mpitchaccel_MODvalue_freqMOD.png')
...
xlabel('Astroke')
ylabel('M')
saveas(gca, 'Mpitchaccel_Astroke_strokeMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mpitchaccel_MODvalue_strokeMOD.png')
...
xlabel('Apitch')
ylabel('M')
saveas(gca, 'Mpitchaccel_Apitch_pitchMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mpitchaccel_MODvalue_pitchMOD.png')
...
xlabel('Adev')
ylabel('M')
saveas(gca, 'Mpitchaccel_Adev_devMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Mpitchaccel_MODvalue_devMOD.png')

% compare MODs
figure
hold on
plot(mod_value_all,My_mean_all,'.k')
plot(mod_value_freq,My_mean_freq,'.r')
plot(mod_value_stroke,My_mean_stroke,'.g')
plot(mod_value_pitch,My_mean_pitch,'.b')
plot(mod_value_dev,My_mean_dev,'.c')
plot(mod_value_all(1:MODmin),My_mean_sum,'ok')

legend('all','freq','stroke','pitch','dev','sum','location','nw')
grid on
xlabel('MOD value')
ylabel('Mpitch')
saveas(gca, 'Mpitchaccel_MODvalue_compare.png')
