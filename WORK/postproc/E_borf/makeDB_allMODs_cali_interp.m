...
for i = 1:length(list)
    ...
    if exist(file_now) == 2
        ...
        Fx_all(1:seq_length_max,1:Nwb,end+1) = nan;
        Fy_all(1:seq_length_max,1:Nwb,end+1) = nan;
        Fz_all(1:seq_length_max,1:Nwb,end+1) = nan;
        Mx_all(1:seq_length_max,1:Nwb,end+1) = nan;
        My_all(1:seq_length_max,1:Nwb,end+1) = nan;
        Mz_all(1:seq_length_max,1:Nwb,end+1) = nan;
