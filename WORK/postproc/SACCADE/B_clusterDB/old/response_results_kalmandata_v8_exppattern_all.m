...
%% plot response vs time (COMPENSATED)
figure
plot(0,0,'r')
hold on
plot(0,0,'g')
...
colormap(cmap)
saveas(gca,['temporal_stim_angle_compensated',num2str(A_resp),'.fig'])
saveas(gca,['temporal_stim_angle_compensated',num2str(A_resp),'.jpg'])
...
colormap(cmap)
saveas(gca,['temporal_flightspeed_compensated',num2str(A_resp),'.fig'])
saveas(gca,['temporal_flightspeed_compensated',num2str(A_resp),'.jpg'])
...
colormap(cmap)
saveas(gca,['temporal_acceleration_compensated',num2str(A_resp),'.fig'])
saveas(gca,['temporal_acceleration_compensated',num2str(A_resp),'.jpg'])
...
xlabel('t comp')
ylabel('A')
axis([t_start-nanmean(t_Aresp) t_stop-nanmean(t_Aresp) -30 30])
colormap(cmap)
saveas(gca,['temporal_acceleration_linear_compensated',num2str(A_resp),'.fig'])
saveas(gca,['temporal_acceleration_linear_compensated',num2str(A_resp),'.jpg'])
...
axis([t_start-nanmean(t_Aresp) t_stop-nanmean(t_Aresp) 0 30])
colormap(cmap)
saveas(gca,['temporal_acceleration_turn_compensated',num2str(A_resp),'.fig'])
saveas(gca,['temporal_acceleration_turn_compensated',num2str(A_resp),'.jpg'])

%% plot resonse vs time
