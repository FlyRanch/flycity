...
Mroll_mean_wb_accel  = Iroll  .* roll_dot_dot_mean_wb;
Mpitch_mean_wb_accel = Ipitch .* pitch_dot_dot_mean_wb;
Myaw_mean_wb_accel   = Iyaw   .* yaw_dot_dot_mean_wb;

Mroll_mean_wb_damp  = Croll  .* roll_dot_mean_wb;
Mpitch_mean_wb_damp = Cpitch .* pitch_dot_mean_wb;
Myaw_mean_wb_damp   = Cyaw   .* yaw_dot_mean_wb;
