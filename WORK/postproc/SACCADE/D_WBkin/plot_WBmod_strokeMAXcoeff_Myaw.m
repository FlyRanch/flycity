...
plot(abs(Myaw_YawAccel),stroke_wb_fwd_YawAccel_bins(1,:),'.b')

% plot trend
RC = strokeMOD_wb_fwd_YawAccel_bins_meanCIstd(1,1)/Myaw_norm;
x0 = 0;
...
% plot(abs(Myaw_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot(abs(Myaw_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot(abs(Myaw_YawAccel),stroke_wb_rwd_YawAccel_bins(1,:),'.b')

% plot trend
RC = strokeMOD_wb_rwd_YawAccel_bins_meanCIstd(1,1)/Myaw_norm;
x0 = 0;
var0 = stroke_wb_steady_bins_meanCIstd(1,1);
x1 = max(abs(Myaw_YawAccel));
var1 = var0 + RC * (x1-x0);
...
% plot(abs(Myaw_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot(abs(Myaw_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot(abs(Myaw_YawAccel),Dstroke_wb_YawAccel_bins(1,:),'.b')

% plot trend
RC = DstrokeMOD_wb_YawAccel_bins_meanCIstd(1,1)/Myaw_norm;
x0 = 0;
var0 = 0;
x1 = max(abs(Myaw_YawAccel));
var1 = var0 + RC * (x1-x0);
...
% for
subplot(3,2,2)
plot(abs(Myaw_YawAccel),strokeMOD_wb_fwd_YawAccel_bins(1,:),'.b')
...
% rear
subplot(3,2,4)
plot(abs(Myaw_YawAccel),strokeMOD_wb_rwd_YawAccel_bins(1,:),'.b')
...
% for rear
subplot(3,2,6)
plot(abs(Myaw_YawAccel),DstrokeMOD_wb_YawAccel_bins(1,:),'.b')
