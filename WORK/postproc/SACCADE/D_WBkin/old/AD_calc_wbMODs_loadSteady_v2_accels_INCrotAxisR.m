...
rotRaccel_limit_mod = limit_mod*nanstd(rot_dot_dot_R_mean_wb(:));
...
rotRaccel_norm = norm*nanstd(rot_dot_dot_R_mean_wb(:));
...
%% save norm_data
save('norm_data.mat','rollaccel_norm','pitchaccel_norm','yawaccel_norm','Fenhance_norm','rotRaccel_norm','f_wb_steady')
...
plot([-pitchaccel_limit_mod -pitchaccel_limit_mod],[0 max(h)],'-r')
title('pitch accel')
saveas(gca,['hist_pitchAccel',num2str(n_PitchAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
saveas(gca,['hist_pitchAccel',num2str(n_PitchAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
plot2svg(['hist_pitchAccel',num2str(n_PitchAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
...
plot([-rollaccel_limit_mod -rollaccel_limit_mod],[0 max(h)],'-r')
title('roll accel')
saveas(gca,['hist_rollAccel',num2str(n_RollAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
saveas(gca,['hist_rollAccel',num2str(n_RollAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
plot2svg(['hist_rollAccel',num2str(n_RollAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
...
plot([-yawaccel_limit_mod -yawaccel_limit_mod],[0 max(h)],'-r')
title('yaw accel')
saveas(gca,['hist_yawAccel',num2str(n_YawAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
saveas(gca,['hist_yawAccel',num2str(n_YawAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
plot2svg(['hist_yawAccel',num2str(n_YawAccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
...
%% Acceleration around right rotation axis
if calc_WB_rotAxisR == 1
...
xmin = -ceil(max(abs(rot_dot_dot_R_mean_wb)));
% xmin = -1.5;
xmax = -xmin;


figure
h=hist(rot_dot_dot_R_mean_wb,50);
hist(rot_dot_dot_R_mean_wb,50)
hold on
plot([rotRaccel_limit_mod rotRaccel_limit_mod],[0 max(h)],'-r')
plot([-rotRaccel_limit_mod -rotRaccel_limit_mod],[0 max(h)],'-r')
title('rotation axis R accel')
saveas(gca,['hist_rotAxisRaccel',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
saveas(gca,['hist_rotAxisRaccel',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
plot2svg(['hist_rotAxisRaccel',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_heatmap_rotAxisRaccel
    saveas(gca,['WBmod_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmodNsteady_rotAxisRaccel
    saveas(gca,['WBmodNsteady_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmodNsteady_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmodNsteady_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmod_strokeMAXcoeff_rotAxisRaccel
    saveas(gca,['WBmod_strokeMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_strokeMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_strokeMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_strokeMINcoeff_rotAxisRaccel
    saveas(gca,['WBmod_strokeMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_strokeMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_strokeMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_pitchMIDDScoeff_rotAxisRaccel
    saveas(gca,['WBmod_pitchMIDDScoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_pitchMIDDScoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_pitchMIDDScoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_pitchMIDUScoeff_rotAxisRaccel
    saveas(gca,['WBmod_pitchMIDUScoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_pitchMIDUScoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_pitchMIDUScoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devDSMAXcoeff_rotAxisRaccel
    saveas(gca,['WBmod_devDSMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devDSMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devDSMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devDSMINcoeff_rotAxisRaccel
    saveas(gca,['WBmod_devDSMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devDSMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devDSMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])

    plot_WBmod_devUSMAXcoeff_rotAxisRaccel
    saveas(gca,['WBmod_devUSMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devUSMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devUSMAXcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
    
    plot_WBmod_devUSMINcoeff_rotAxisRaccel
    saveas(gca,['WBmod_devUSMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.fig'])
    saveas(gca,['WBmod_devUSMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.png'])
    plot2svg(['WBmod_devUSMINcoeff_rotAxisRaccel_',num2str(n_rotAxisRaccel),'WBs_limit',num2str(limit_mod),'_norm',num2str(norm),'xSTD.svg'])
...
MSplot_WBsteady2mod2xNorm_rotAxisRaccel
    saveas(gca,['MSplot_WBsteady2mod2xNorm_rotAxisRaccel.fig'])
    saveas(gca,['MSplot_WBsteady2mod2xNorm_rotAxisRaccel.png'])
    plot2svg(['MSplot_WBsteady2mod2xNorm_rotAxisRaccel.svg'])
...
MSplot_WBsteady2mod2xNorm_1fig_incRotAxisRaccel
