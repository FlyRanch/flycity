...
for i = 1:length(list)
    ...
    if exist(file_now) == 2
        ...
        Fx_dev(1:seq_length_max,end+1) = nan;
        Fy_dev(1:seq_length_max,end+1) = nan;
        Fz_dev(1:seq_length_max,end+1) = nan;
        Mx_dev(1:seq_length_max,end+1) = nan;
        My_dev(1:seq_length_max,end+1) = nan;
        Mz_dev(1:seq_length_max,end+1) = nan;
