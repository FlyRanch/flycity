...
%         ft(:,6) = filter_borf_raw(ft(:,6),butter_cut,butter_n,Nwb_total);
        ...
        t_pitch(1:seq_length_max,n) = nan;
        
        stroke_L_pitch(1:seq_length_max,n) = nan;
        pitch_L_pitch(1:seq_length_max,n) = nan;
        dev_L_pitch(1:seq_length_max,n) = nan;
        
        stroke_R_pitch(1:seq_length_max,n) = nan;
        pitch_R_pitch(1:seq_length_max,n) = nan;
        dev_R_pitch(1:seq_length_max,n) = nan;
        
        Fx_pitch(1:seq_length_max,1:Nwb,n) = nan;
        Fy_pitch(1:seq_length_max,1:Nwb,n) = nan;
        Fz_pitch(1:seq_length_max,1:Nwb,n) = nan;
        Mx_pitch(1:seq_length_max,1:Nwb,n) = nan;
        My_pitch(1:seq_length_max,1:Nwb,n) = nan;
        Mz_pitch(1:seq_length_max,1:Nwb,n) = nan;
