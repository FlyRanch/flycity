...
plot(Fenhance_norm*mod_value_all(1:MODmin)+1,F_mean_sum/Mg_fly,'--r','linewidth',1)
...
plot(rollaccel_norm*mod_value_allNOfreq(1:MODmin),(Mx_mean_sum-Mx_steady)/f_wb_steady^2/Lwing^5,'--r','linewidth',1)
...
plot(pitchaccel_norm*mod_value_allNOfreq(1:MODmin),(My_mean_sum-My_steady)/f_wb_steady^2/Lwing^5,'--r','linewidth',1)
