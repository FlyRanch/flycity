...
%         ft(:,6) = filter_borf_raw(ft(:,6),butter_cut,butter_n,Nwb_total);
        ...
        t_stroke(1:seq_length_max,n) = nan;
        
        stroke_L_stroke(1:seq_length_max,n) = nan;
        pitch_L_stroke(1:seq_length_max,n) = nan;
        dev_L_stroke(1:seq_length_max,n) = nan;
        
        stroke_R_stroke(1:seq_length_max,n) = nan;
        pitch_R_stroke(1:seq_length_max,n) = nan;
        dev_R_stroke(1:seq_length_max,n) = nan;
        
        Fx_stroke(1:seq_length_max,1:Nwb,n) = nan;
        Fy_stroke(1:seq_length_max,1:Nwb,n) = nan;
        Fz_stroke(1:seq_length_max,1:Nwb,n) = nan;
        Mx_stroke(1:seq_length_max,1:Nwb,n) = nan;
        My_stroke(1:seq_length_max,1:Nwb,n) = nan;
        Mz_stroke(1:seq_length_max,1:Nwb,n) = nan;
...
% %             Mz_now(j,:) = Mz_robo(j,:) - Mz_cali_L(j) - Mz_cali_R(j);
        ...
        Fx_stroke(1:length(t_now),:,n) = Fx_fly;
        Fy_stroke(1:length(t_now),:,n) = Fy_fly;
        Fz_stroke(1:length(t_now),:,n) = Fz_fly;

        Mx_stroke(1:length(t_now),:,n) = Mx_fly;
        My_stroke(1:length(t_now),:,n) = My_fly;
        Mz_stroke(1:length(t_now),:,n) = Mz_fly;
    end
end
