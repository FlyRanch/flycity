...
%         ft(:,6) = filter_borf_raw(ft(:,6),butter_cut,butter_n,Nwb_total);
        ...
        t_allNOfreq(1:seq_length_max,n) = nan;
        
        stroke_L_allNOfreq(1:seq_length_max,n) = nan;
        pitch_L_allNOfreq(1:seq_length_max,n) = nan;
        dev_L_allNOfreq(1:seq_length_max,n) = nan;
        
        stroke_R_allNOfreq(1:seq_length_max,n) = nan;
        pitch_R_allNOfreq(1:seq_length_max,n) = nan;
        dev_R_allNOfreq(1:seq_length_max,n) = nan;
        
        Fx_allNOfreq(1:seq_length_max,1:Nwb,n) = nan;
        Fy_allNOfreq(1:seq_length_max,1:Nwb,n) = nan;
        Fz_allNOfreq(1:seq_length_max,1:Nwb,n) = nan;
        Mx_allNOfreq(1:seq_length_max,1:Nwb,n) = nan;
        My_allNOfreq(1:seq_length_max,1:Nwb,n) = nan;
        Mz_allNOfreq(1:seq_length_max,1:Nwb,n) = nan;
