...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Myawaccel_MODvalue_allMOD.png')
...
xlabel('freq')
ylabel('M')
saveas(gca, 'Myawaccel_freq_freqMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Myawaccel_MODvalue_freqMOD.png')
...
xlabel('Astroke')
ylabel('M')
saveas(gca, 'Myawaccel_Astroke_strokeMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Myawaccel_MODvalue_strokeMOD.png')
...
xlabel('Apitch')
ylabel('M')
saveas(gca, 'Myawaccel_Apitch_pitchMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Myawaccel_MODvalue_pitchMOD.png')
...
xlabel('Adev')
ylabel('M')
saveas(gca, 'Myawaccel_Adev_devMOD.png')
...
xlabel('MOD value')
ylabel('M')
saveas(gca, 'Myawaccel_MODvalue_devMOD.png')

% compare MODs
figure
hold on
plot(mod_value_all,Mz_mean_all,'.k')
plot(mod_value_freq,Mz_mean_freq,'.r')
plot(mod_value_stroke,Mz_mean_stroke,'.g')
plot(mod_value_pitch,Mz_mean_pitch,'.b')
plot(mod_value_dev,Mz_mean_dev,'.c')
plot(mod_value_all(1:MODmin),Mz_mean_sum,'ok')

legend('all','freq','stroke','pitch','dev','sum','location','nw')
grid on
xlabel('MOD value')
ylabel('Myaw')
saveas(gca, 'Myawaccel_MODvalue_compare.png')
