...
angle_post_low(isnan(angle_post_high)==1)=-90;
angle_post_high(isnan(angle_post_high)==1)=270;

angle_post_mean(angle_post_mean<-90) = angle_post_mean(angle_post_mean<-90) +360;
angle_post_high(angle_post_low<-90) = angle_post_high(angle_post_low<-90) +360;
angle_post_low(angle_post_low<-90) = angle_post_low(angle_post_low<-90) +360;
