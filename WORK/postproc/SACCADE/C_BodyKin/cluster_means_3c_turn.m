...
n2 = find(abs(turn_angle_vel_mirror)<subset_cut(2)&abs(turn_angle_vel_mirror)>subset_cut(1));
n3 = find(abs(turn_angle_vel_mirror)>subset_cut(2));
...
turn_angle_vel_mirror_c1 = turn_angle_vel_mirror(n1);
turn_angle_vel_mirror_c2 = turn_angle_vel_mirror(n2);
turn_angle_vel_mirror_c3 = turn_angle_vel_mirror(n3);
