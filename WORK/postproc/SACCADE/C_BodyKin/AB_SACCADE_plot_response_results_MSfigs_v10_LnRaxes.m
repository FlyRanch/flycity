...
% MSfig2_escape_dir_colorcode_MEANclusters_quartiles_2c_wrap
MSfig2_escape_dir_colorcode_MEANclusters_2c_wrap_accel
% MSfig2_escape_dir_colorcode_MEANclusters_3c_wrap_accel
...
saveas(gca,'MSfig2_escape_dir_colorcode_clusters_quartiles_Fmean.fig')
saveas(gca,'MSfig2_escape_dir_colorcode_clusters_quartiles_Fmean.png')
plot2svg('MSfig2_escape_dir_colorcode_clusters_quartiles_Fmean.svg')
...
% MSfig3_rotaxisangle_vs_stimangleNturnangle_atAmax_stimspeedBW

% MSfig3_attitudesMEAN_vs_turn
% MSfig3_attitudesAtAmax_vs_turn
% MSfig3_rotaxisangle_vs_turnangle_atAmax
% MSfig3_rotaxisangle_vs_turnangle_MEAN
% % MSfig3_rotaxisangle_vs_stimangleNturnangle_atAmax_stimspeedBW
...
saveas(gca,'MSfig3_rotationaxis_mirror_rose_initialNcounterRotation.fig')
saveas(gca,'MSfig3_rotationaxis_mirror_rose_initialNcounterRotation.png')
plot2svg('MSfig3_rotationaxis_mirror_rose_initialNcounterRotation.svg')
...
for i=1:length(v_pre)
    plot([x_origin(i) u_pre(i)],[y_origin(i) v_pre(i)],'color',[0,.5,1],'linewidth',2)
end
...
for i=1:length(v_post)
    plot([x_origin(i) du_post(i)],[y_origin(i) dv_post(i)],'color',[1,.5,0],'linewidth',2)
end
