...
mkdir('response_figs_subseqs')
cd('response_figs_subseqs')
...
% % SUBSET seqs KINDATA
%  seqs=[8;74;22;4;14;12]
 
% SUBSET seqs INCROLL
 seqs=[7;65;21;4;13;11]
 
 
% plot_flightpath_timeline_tshift_headingstart_AnormNdir_subsets
% plot_flightpath_timeline_tshift_headingstart_ATTnDOTs_subsets
...
plot_flightpath_timeline_tshift_headingstart_FnSP_subsets
...
plot_flightpath_timeline_tshift_headingstart_WBmodValues_sub
...
plot_flightpath_timeline_tshift_headingstart_dATTnDOTs_subsets
...
plot_flightpath_timeline_histograms_norm_dATTnDOTs

subplot(3,3,1)
axis([t_start t_stop -90 45])
subplot(3,3,4)
axis([t_start t_stop -90 45])
subplot(3,3,7)
axis([t_start t_stop -90 45])
...
subplot(3,2,4)
axis([t_start t_stop -15 5])
set(gca,'YTick',[-15;0;5],'YTicklabel',[15;0;-5],'fontsize',8) 
subplot(3,2,6)
axis([t_start t_stop -15 5])
set(gca,'YTick',[-15;0;5],'YTicklabel',[15;0;-5],'fontsize',8) 
...
%% plot pre&post velocity vectors INC heading pre color
