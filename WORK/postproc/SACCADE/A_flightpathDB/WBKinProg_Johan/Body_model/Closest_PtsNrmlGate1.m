...
WingSearchDist = PAR.WingSearchDist;
BodySearchDist = PAR.BodySearchDist;
numfeatpts = PAR.numfeatpts;
...
% 
%             axis([centr(1)-50 centr(1)+50 centr(2)-50 centr(2)+50]);
%             pause(.01)
%             pause
% end
%%
