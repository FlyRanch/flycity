...
seq_now = settings.seq(seq,:)
    saveas(gca,['wingkin_',num2str(seq_now(1)),'seq',num2str(seq_now(2)),'.fig'])
    saveas(gca,['wingkin_',num2str(seq_now(1)),'seq',num2str(seq_now(2)),'.png'])
    plot2svg(['wingkin_',num2str(seq_now(1)),'seq',num2str(seq_now(2)),'.svg'])
