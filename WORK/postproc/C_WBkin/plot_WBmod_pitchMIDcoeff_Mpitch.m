...
plot(Mpitch_PitchAccel,pitch_wb_L_PitchAccel_bins(n_loc,:),'.b')
plot(Mpitch_PitchAccel,pitch_wb_R_PitchAccel_bins(n_loc,:),'.b')

% plot trend
RC = pitchMOD_wb_PitchAccel_bins_meanCIstd(n_loc,1)/Mpitch_norm;
...
subplot(2,2,3)
plot(Mpitch_PitchAccel,pitchMOD_wb_L_PitchAccel_bins(n_loc,:),'.b')
plot(Mpitch_PitchAccel,pitchMOD_wb_R_PitchAccel_bins(n_loc,:),'.b')
