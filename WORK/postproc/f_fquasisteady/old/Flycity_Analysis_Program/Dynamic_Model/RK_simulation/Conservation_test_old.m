...
%     
    ...
    LM_t_mean = mean(FM_b.LM,2)
    AM_t_mean = mean(FM_b.AM,2)
...
%     vb      = zeros(3,2*nr_points*nr_wb+1);
%     wb      = zeros(3,2*nr_points*nr_wb+1);
%     ab      = zeros(3,2*nr_points*nr_wb+1);
%     w_dot_b = zeros(3,2*nr_points*nr_wb+1);
%     vb_0    = zeros(3,2*nr_points*nr_wb+1);
%     wb_0    = zeros(3,2*nr_points*nr_wb+1);
%     FI_acc  = zeros(3,2*nr_points*nr_wb+1);
%     FI_vel  = zeros(3,2*nr_points*nr_wb+1);
%     MI_acc  = zeros(3,2*nr_points*nr_wb+1);
%     MI_vel  = zeros(3,2*nr_points*nr_wb+1);
%     LM      = zeros(3,2*nr_points*nr_wb+1);
%     AM      = zeros(3,2*nr_points*nr_wb+1);
%        
%     for j = 1:(2*nr_points*nr_wb+1)
%         
%     kine.RL          = RL(:,:,j);
%     kine.RR          = RR(:,:,j);
%     kine.vb          = vb(:,j);
...
%     % Compute the location of the c.g.
%     
