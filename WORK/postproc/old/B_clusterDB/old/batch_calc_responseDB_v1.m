...
outputfile = 'flightpathDB_2flies_9clusters_Atmin_2.5n-3n2.5_response.mat';
...
for i = 1:size(pathDB.pos,2)
    ...
    V_post_resp,V_postresp2end,V_post_accel] = calc_response_data_hVA(pathDB,settings,i,toplot,skip);    
...
cd(figdir)
saveas(gcf,['flightpath_',num2str(i),'.fig'])
