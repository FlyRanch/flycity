...
for i = 1:length(t_shift)
    t_hist = [t_hist;t_wb_L(:,i)-t_shift(i)];
end
% for i=1:size(V,2)    
...
%% HEATMAP BODY ROLL&PITCH&YAW INC ACCEL headingstart
plot_WingKin_timeline_tshift_bodyrollNpitchNyaw_headingstart
saveas(gca,'WBtimelines_rollNpitchNyaw_headingstart.fig')
saveas(gca,'WBtimelines_rollNpitchNyaw_headingstart.png')
plot2svg('WBtimelines_rollNpitchNyaw_headingstart.svg')

%% timelines ROLL&YAWvsDEV headingstart
plot_WingKin_timeline_tshift_rollNyawNdev_headingstart_uds
saveas(gca,'WBtimelines_rollNyawVSdev_headingstart.fig')
saveas(gca,'WBtimelines_rollNyawVSdev_headingstart.png')
plot2svg('WBtimelines_rollNyawVSdev_headingstart.svg')

% %% timelines ROLL&DEV headingstart
% plot_WingKin_timeline_tshift_rollNdev_headingstart_uds
% saveas(gca,'WBtimelines_rollVSdev_headingstart.fig')
% saveas(gca,'WBtimelines_rollVSdev_headingstart.png')
% plot2svg('WBtimelines_rollVSdev_headingstart.svg')
% 
% %% timelines YAW&DEV headingstart
% plot_WingKin_timeline_tshift_yawNdev_headingstart_uds
% saveas(gca,'WBtimelines_yawVSdev_headingstart.fig')
% saveas(gca,'WBtimelines_yawVSdev_headingstart.png')
% plot2svg('WBtimelines_yawVSdev_headingstart.svg')


%% timelines ROLL&YAWvsPITCH&STROKE headingstart
plot_WingKin_timeline_tshift_rollNyawVSwingpitchNstroke
saveas(gca,'WBtimelines_rollNyawVSwingpitchNstroke_headingstart.fig')
saveas(gca,'WBtimelines_rollNyawVSwingpitchNstroke_headingstart.png')
plot2svg('WBtimelines_rollNyawVSwingpitchNstroke_headingstart.svg')

% plot_WingKin_timeline_tshift_rollNwingpitchNstroke
% saveas(gca,'WBtimelines_rollVSdev_headingstart.fig')
% saveas(gca,'WBtimelines_rollVSdev_headingstart.png')
% plot2svg('WBtimelines_rollVSdev_headingstart.svg')

%% timelines PITCHnFvsDEV headingstart
plot_WingKin_timeline_tshift_pitchNfVSdev_headingstart_uds
saveas(gca,'WBtimelines_pitchNforceVSdev_headingstart.fig')
saveas(gca,'WBtimelines_pitchNforceVSdev_headingstart.png')
plot2svg('WBtimelines_pitchNforceVSdev_headingstart.svg')


% plot_WingKin_timeline_tshift_pitchVSdev_headingstart
% saveas(gca,'WBtimelines_pitchVSdev_headingstart.fig')
% saveas(gca,'WBtimelines_pitchVSdev_headingstart.png')
% plot2svg('WBtimelines_pitchVSdev_headingstart.svg')
