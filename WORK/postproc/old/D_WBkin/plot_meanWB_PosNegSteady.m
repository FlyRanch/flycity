...
if plot_WB_SUBSETS == 1
    ...
    subset_max = 1.5*subset_std;
    subset_min = -2*subset_std;
    h_max = max(hist(subset(:),100));
    figure
    plot([subset_mid subset_mid],[0 h_max],'color',color_mid,'linewidth',5)
    hold on
    plot([-subset_mid -subset_mid],[0 h_max],'color',color_mid,'linewidth',5)
    plot([subset_max subset_max],[0 h_max],'color',color_max,'linewidth',5)
    plot([subset_min subset_min],[0 h_max],'color',color_min,'linewidth',5)
    hist(subset(:),100)
    ...
    subset_max = 1.5*subset_std;
    subset_min = -2*subset_std;
    subset_OFF_mid = 10*subset_OFF_std;
    plot_wbNORM_wingatt_3subsetsINCoff_INCmirror_posneg
