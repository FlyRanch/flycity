function [Features,IMBW] = feat_detect_NOWING(n,Features,PAR)
...
% figure, imagesc((IMbody + data)/2), colormap gray
...
% close all
    ...
    %% FTMmod NOWING!
%     Features(n).IMfull{mm} = IMbody.*255;
    Features(n).IMfull{mm} = IMbody.*0;
