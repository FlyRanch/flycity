...
if file_pos4.name(19)>64
    strOpos4 = file_pos3.name(17:18);
else
    strOpos4 = file_pos3.name(17:19);
end
...
% plate translation
N_turns = input('Number of turns between positions [default: 0.5 turns]: ');
if isempty(N_turns)
    N_turns = 0.5;
end
...
%% position 4 (front position, z=3*dz)
load(file_pos4.name)

% add initial offset
% ofset from corner of checkerboard
X_1(1,:) = X_1(1,:) + dX*Opos4(1);
X_1(2,:) = X_1(2,:) + dX*Opos4(2);
X_1(3,:) = X_1(3,:) + dX*Opos4(3);

% translational ofset
X_1(1,:) = X_1(1,:) + 3*d_transl(1);
X_1(2,:) = X_1(2,:) + 3*d_transl(2);
X_1(3,:) = X_1(3,:) + 3*d_transl(3);
