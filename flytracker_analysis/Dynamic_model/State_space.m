...
%                   -w_bR(2) w_bR(1) 0];         
    ...
    M12_dot = m_v_w*(-R_L_dot'*C_cross_jwL*R_L) + m_v_w*(-R_L'*C_cross_jwL*R_L_dot) + m_v_w*(-R_R_dot'*C_cross_jwR*R_R) + m_v_w*(-R_R'*C_cross_jwR*R_R_dot);  % [kg*mm]
        
    M13_dot = m_v_w*(-R_L_dot'*C_cross_jwL*R_L) + m_v_w*(-R_L'*C_cross_jwL*R_L_dot); % [kg*mm]
        
    M14_dot = m_v_w*(-R_R_dot'*C_cross_jwR*R_R) + m_v_w*(-R_R'*C_cross_jwR*R_R_dot); % [kg*mm]
    ...
    M22_dot = R_L_dot'*I_wing*R_L + R_L'*I_wing*R_L_dot + R_R_dot'*I_wing*R_R + R_R'*I_wing*R_R_dot + m_v_w*(-R_L_dot'*C_cross_jwL*R_L)'*(-C_cross_bjL - R_L'*C_cross_jwL*R_L) ...
                   ...
                   m_v_w*(-R_R'*C_cross_jwR*R_R)'*(-R_R'*C_cross_jwR*R_R_dot); % [kg*mm^2]
    ...
    M23_dot = R_L_dot'*I_wing*R_L + R_L'*I_wing*R_L_dot + m_v_w*(-R_L_dot'*C_cross_jwL*R_L)'*(-R_L'*C_cross_jwL*R_L) + m_v_w*(-R_L'*C_cross_jwL*R_L_dot)'*(-R_L'*C_cross_jwL*R_L) ...
                  + m_v_w*(-C_cross_bjL - R_L'*C_cross_jwL*R_L)'*(-R_L_dot'*C_cross_jwL*R_L) + m_v_w*(-C_cross_bjL - R_L'*C_cross_jwL*R_L)'*(-R_L'*C_cross_jwL*R_L_dot); % [kg*mm^2]
    ...
    M24_dot = R_R_dot'*I_wing*R_R + R_R'*I_wing*R_R_dot + m_v_w*(-R_R_dot'*C_cross_jwR*R_R)'*(-R_R'*C_cross_jwR*R_R) + m_v_w*(-R_R'*C_cross_jwR*R_R_dot)'*(-R_R'*C_cross_jwR*R_R) ...
                  + m_v_w*(-C_cross_bjR - R_R'*C_cross_jwR*R_R)'*(-R_R_dot'*C_cross_jwR*R_R) + m_v_w*(-C_cross_bjR - R_R'*C_cross_jwR*R_R)'*(-R_R'*C_cross_jwR*R_R_dot); % [kg*mm^2]
    ...
    F1 = 1e-3*M11*a_b; %[kg*mm/s^2]
        
    F2 = 1e-3*M12*w_dot_b; %[kg*mm/s^2]
        
    F3 = 1e-3*M12_dot*w_b; %[kg*mm/s^2]
        
    F4 = 1e-3*M13_dot*w_bL; %[kg*mm/s^2]
        
    F5 = 1e-3*M14_dot*w_bR; %[kg*mm/s^2]
        
    F6 = 1e-3*M13*w_dot_bL; %[kg*mm/s^2]
        
    F7 = 1e-3*M14*w_dot_bR; %[kg*mm/s^2]
        
    F8 = 1e-3*cross(w_b,dL_dub); %[kg*mm/s^2]
    ...
    M1 = 1e-3*M21*a_b; %[kg*mm/s^2*mm]
        
    M2 = 1e-3*M22*w_dot_b; %[kg*mm/s^2*mm]
        
    M3 = 1e-3*cross(u_b,dL_dub); %[kg*mm/s^2*mm]
        
    M4 = 1e-3*cross(w_b,dL_wub); %[kg*mm/s^2*mm]
        
    M5 = 1e-3*M21_dot*u_b; % [kg*mm/s^2 *mm]
        
    M6 = 1e-3*M22_dot*w_b; % [kg*mm/s^2 *mm]
        
    M7 = 1e-3*M23_dot*w_bL; % [kg*mm/s^2 *mm]
        
    M8 = 1e-3*M24_dot*w_bR; % [kg*mm/s^2 *mm]
        
    M9 = 1e-3*M23*w_dot_bL; %[kg*mm/s^2 *mm]
        
    M10 = 1e-3*M24*w_dot_bR; %[kg*mm/s^2 *mm]
    ...
    [ F_aero_L, F_aero_R, c_pres_L, c_pres_R ] = Aerodynamic_Model(y_sect,chords,joint_L,joint_R,u_b,w_b,w_L,w_R,R_b,R_L,R_R,up,down);
