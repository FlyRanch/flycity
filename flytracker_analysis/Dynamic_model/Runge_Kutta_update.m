function [ State_update ] = Runge_Kutta_update(Pattern,Body,State,t,dt)
    ...
    State_update(1:3) = State(1:3)+dt*State(4:6)+(dt^2/6)*(k1(7:9)+k2(7:9)+k3(7:9));
    
    State_update(4:6) = State(4:6)+(dt/6)*(k1(7:9)+2*k2(7:9)+2*k3(7:9)+k4(7:9));
    
    State_update(7:9) = State(7:9);
    ...
    State_update(10:13) = q_t/norm(q_t);
