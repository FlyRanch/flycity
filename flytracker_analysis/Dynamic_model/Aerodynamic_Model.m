function [ F_L, F_R, c_pres_L, c_pres_R ] = Aerodynamic_Model(y_sect, chords, joint_L, joint_R, u_b, w_b, w_L, w_R, R_b, R_L, R_R,up,down)
    ...
    for i = 1:nr_sect
        ...
        u_L(:,i) = 1e-3*(R_L'*(u_b + cross(w_b,joint_L + R_L*y_sect_L(:,i)))+cross(w_L,y_sect_L(:,i)));
    
        u_R(:,i) = 1e-3*(R_R'*(u_b + cross(w_b,joint_R + R_R*y_sect_R(:,i)))+cross(w_R,y_sect_R(:,i)));
