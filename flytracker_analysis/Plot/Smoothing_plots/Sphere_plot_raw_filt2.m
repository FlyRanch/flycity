...
%     hold on
    ...
    figure(fig_nr1)
    plot3(Lwingtip_f2(:,1),Lwingtip_f2(:,2),Lwingtip_f2(:,3),'color',1/255*[107,145,250],'linewidth',1.5)
    axis equal
    hold on
    
    figure(fig_nr1)
    plot3(Rwingtip_f2(:,1),Rwingtip_f2(:,2),Rwingtip_f2(:,3),'color',1/255*[250,107,107],'linewidth',1.5)
    axis equal
