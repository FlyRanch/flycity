...
% skip = 1
inputfile = 'flightpathDB_pos_qbodyEKF_9clusters_absAn_minAt_2.5n-3n2.5.mat';
skip = 10
nstart = 200;

outputfile = 'flightpathDB_pos_qbodyEKF_9clusters_absAn_minAt_2.5n-3n2.5_response.mat';
...
for i = 1:size(pathDB.pos,2)
    ...
    if toplot == 1
        cd(figdir)
        figure(1)
        saveas(gcf,['flightpath_angles_',num2str(i),'.fig'])
        saveas(gcf,['flightpath_angles_',num2str(i),'.png'])
        figure(2)
        saveas(gcf,['flightpath_vel_accel_',num2str(i),'.fig'])
        saveas(gcf,['flightpath_vel_accel_',num2str(i),'.png'])
        cd ..
        % pause
    end
end
