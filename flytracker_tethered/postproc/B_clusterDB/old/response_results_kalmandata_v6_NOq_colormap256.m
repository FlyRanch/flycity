...
figure
hold on
errorbar(.5,nanmean(t_Aresp),nanstd(t_Aresp),'db','linewidth',2,'MarkerSize',20,'Color',cmap(end,:))
plot(.5,t_Aresp,'ko','MarkerSize',10)
...
set(gca,'xlim',[0 1])
set(gca,'ylim',[0 .2]) 
saveas(gca,'acceleration based response time.fig')
saveas(gca,'acceleration based response time.jpg')
plot2svg
