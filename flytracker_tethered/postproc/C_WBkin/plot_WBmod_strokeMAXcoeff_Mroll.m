...
plot(abs(Mroll_RollAccel),stroke_wb_up_RollAccel_bins(1,:),'.b')

% plot trend
RC = strokeMOD_wb_up_RollAccel_bins_meanCIstd(1,1)/Mroll_norm;
x0 = 0;
...
% plot(abs(Mroll_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot(abs(Mroll_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot(abs(Mroll_RollAccel),stroke_wb_down_RollAccel_bins(1,:),'.b')

% plot trend
RC = strokeMOD_wb_down_RollAccel_bins_meanCIstd(1,1)/Mroll_norm;
x0 = 0;
var0 = stroke_wb_steady_bins_meanCIstd(1,1);
x1 = max(abs(Mroll_RollAccel));
var1 = var0 + RC * (x1-x0);
...
% plot(abs(Mroll_mean_wb),stroke_wb_L_bins(1,:),'.k')
% plot(abs(Mroll_mean_wb),stroke_wb_R_bins(1,:),'.k')
plot(abs(Mroll_RollAccel),Dstroke_wb_RollAccel_bins(1,:),'.b')

% plot trend
RC = DstrokeMOD_wb_RollAccel_bins_meanCIstd(1,1)/Mroll_norm;
x0 = 0;
var0 = 0;
x1 = max(abs(Mroll_RollAccel));
var1 = var0 + RC * (x1-x0);
...
% up
subplot(3,2,2)
plot(abs(Mroll_RollAccel),strokeMOD_wb_up_RollAccel_bins(1,:),'.b')
...
% down
subplot(3,2,4)
plot(abs(Mroll_RollAccel),strokeMOD_wb_down_RollAccel_bins(1,:),'.b')
...
% up down
subplot(3,2,6)
plot(abs(Mroll_RollAccel),DstrokeMOD_wb_RollAccel_bins(1,:),'.b')
