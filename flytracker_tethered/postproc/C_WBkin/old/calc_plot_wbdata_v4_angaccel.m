...
roll_dot_dot_mean_dus = nan(size(n_down_start_L));
roll_dot_dot_mean_udsPREV = nan(size(n_down_start_L));
roll_dot_dot_mean_udsNEXT = nan(size(n_down_start_L));
...
pitch_dot_dot_mean_dus = nan(size(n_down_start_L));
pitch_dot_dot_mean_udsPREV = nan(size(n_down_start_L));
pitch_dot_dot_mean_udsNEXT = nan(size(n_down_start_L));
...
yaw_dot_dot_mean_dus = nan(size(n_down_start_L));
yaw_dot_dot_mean_udsPREV = nan(size(n_down_start_L));
yaw_dot_dot_mean_udsNEXT = nan(size(n_down_start_L));
...
for seq = 1:size(n_down_start_L,2)
    for wb = 2:size(n_down_start_L,1)-1
        ...
        if n_down_start_L_now > n_first(seq) && n_up_stop_L_now < n_post(seq) && ...
            ...
            roll_dot_dot_wb_interp = interp1(roll_dot_dot_wb_now,xi);
            pitch_dot_dot_wb_interp = interp1(pitch_dot_dot_wb_now,xi);
            yaw_dot_dot_wb_interp = interp1(yaw_dot_dot_wb_now,xi);
...
%             roll_dot_dot_mean_dus(wb,seq) = nanmean(roll_dot_dot_dus_now);
%             roll_dot_dot_mean_udsPREV(wb,seq) = nanmean(roll_dot_dot_uds_prev);
%             roll_dot_dot_mean_udsNEXT(wb,seq) = nanmean(roll_dot_dot_uds_next);
...
%             pitch_dot_dot_mean_dus(wb,seq) = nanmean(pitch_dot_dot_dus_now);
%             pitch_dot_dot_mean_udsPREV(wb,seq) = nanmean(pitch_dot_dot_uds_prev);
%             pitch_dot_dot_mean_udsNEXT(wb,seq) = nanmean(pitch_dot_dot_uds_next);
...
%             yaw_dot_dot_mean_dus(wb,seq) = nanmean(yaw_dot_dot_dus_now);
%             yaw_dot_dot_mean_udsPREV(wb,seq) = nanmean(yaw_dot_dot_uds_prev);
%             yaw_dot_dot_mean_udsNEXT(wb,seq) = nanmean(yaw_dot_dot_uds_next);
...
% ROLL acceleration VS PITCH L-R
figure
subplot(2,2,1)
plot(roll_dot_dot_mean_wb(:),rad2deg(dpitch_max_ds(:)),'.')
% xlabel('roll acceleration')
title('Dpitchmax downstroke L-R')
axis([-300000 100000      -50 50])            

subplot(2,2,2)
plot(roll_dot_dot_mean_wb(:),rad2deg(dpitch_min_us(:)),'.')
% xlabel('roll acceleration')
title('Dpitchmin upstroke L-R')
axis([-300000 100000      -50 50])            

subplot(2,2,3)
plot(roll_dot_dot_mean_wb(:),rad2deg(dApitch_ds(:)),'.k')
xlabel('roll acceleration')
title('dApitch downstroke L-R')
axis([-300000 100000      -50 50])            

subplot(2,2,4)
plot(roll_dot_dot_mean_wb(:),rad2deg(dApitch_us(:)),'.k')
xlabel('roll acceleration')
...
figure
subplot(2,2,1)
plot(roll_dot_dot_mean_wb(:),rad2deg(dstroke_max_wb(:)),'.')
% xlabel('roll acceleration')
title('Dstrokemax L-R')
axis([-300000 100000      -30 30])            

subplot(2,2,2)
plot(roll_dot_dot_mean_wb(:),rad2deg(dstroke_min_wb(:)),'.')
% xlabel('roll acceleration')
title('Dstrokemin L-R')
axis([-300000 100000      -30 30])            

subplot(2,2,3)
plot(roll_dot_dot_mean_wb(:),rad2deg(dAstroke_ds(:)),'.k')
xlabel('roll acceleration')
title('dAstroke downstroke L-R')
axis([-300000 100000      -30 30])            

subplot(2,2,4)
plot(roll_dot_dot_mean_wb(:),rad2deg(dAstroke_us(:)),'.k')
xlabel('roll acceleration')
