...
savename = ([loadname(1:end-4),'_9clusters_',num2str(At_hor_thresh),'n',num2str(At_hor_thresh_min),'n',num2str(An_hor_thresh),'.mat']);
...
%% responseDB info
% start at 175 frames after trigger
nstart = 175;
...
% start at frame 1
start_frame = 1;
savename = ([loadname(1:end-4),'_9clusters_',num2str(At_hor_thresh),'n',num2str(At_hor_thresh_min),'n',num2str(An_hor_thresh),'_allframes.mat']);
