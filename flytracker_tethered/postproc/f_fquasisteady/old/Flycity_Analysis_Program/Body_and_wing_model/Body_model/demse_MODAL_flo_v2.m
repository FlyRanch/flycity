...
% 
% PathName = '/home/florian/DATA/flighttracker/flighttracks/120312_tether_test/C001H001S0002/';
% FileName = 'C001H001S0002_000.bmp';
% 
...
% 
% startpath = '/home/florian/DATA/flighttracks/test/solutions/';
% startpath = '/home/florian/DATA/flighttracker/flighttracks/Takeoff/solutions/';
% startpath = '/home/florian/DATA/flighttracker/flighttracks/120312_tether_test/solutions/';
...
cd ..
cd calibration
[CalibFileName,CalibPathName] = uigetfile({'*.mat'},'Select calibration point file','cali_points_rotated.mat');
CalibFile = [CalibPathName,CalibFileName];
% CalibFile = 'kine/Calibrations for Kine/cal_for_20031217_done_20040205';

% manual fit file
FileFromKine = 'KineManualFit_exp095f430';
...
if getImageData
    PAR = LoadVideo(PathName,FileName);
