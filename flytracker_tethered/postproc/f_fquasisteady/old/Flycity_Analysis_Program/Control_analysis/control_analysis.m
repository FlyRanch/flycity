...
%     'man_ax'
%     man_ax = FM_aero_maneuver(maneuver.ax,R_strk,wb_names_ax,nr_wb_ax,n_pol_theta,n_pol_eta,n_pol_phi);
%     'man_ay'
%     man_ay= FM_aero_maneuver(maneuver.ay,R_strk,wb_names_ay,nr_wb_ay,n_pol_theta,n_pol_eta,n_pol_phi);
%     'man_az'
%     man_az = FM_aero_maneuver(maneuver.az,R_strk,wb_names_az,nr_wb_az,n_pol_theta,n_pol_eta,n_pol_phi);
%     'man_wx'
%     man_wx = FM_aero_maneuver(maneuver.wx,R_strk,wb_names_wx,nr_wb_wx,n_pol_theta,n_pol_eta,n_pol_phi);
%     'man_wy'
%     man_wy = FM_aero_maneuver(maneuver.wy,R_strk,wb_names_wy,nr_wb_wy,n_pol_theta,n_pol_eta,n_pol_phi);
%     'man_wz'
%     man_wz = FM_aero_maneuver(maneuver.wz,R_strk,wb_names_wz,nr_wb_wz,n_pol_theta,n_pol_eta,n_pol_phi);
% 
