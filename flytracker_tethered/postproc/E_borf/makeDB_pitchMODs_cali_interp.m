...
% %             Mz_now(j,:) = Mz_robo(j,:) - Mz_cali_L(j) - Mz_cali_R(j);
        ...
        Fx_pitch(1:length(t_now),:,n) = Fx_fly;
        Fy_pitch(1:length(t_now),:,n) = Fy_fly;
        Fz_pitch(1:length(t_now),:,n) = Fz_fly;

        Mx_pitch(1:length(t_now),:,n) = Mx_fly;
        My_pitch(1:length(t_now),:,n) = My_fly;
        Mz_pitch(1:length(t_now),:,n) = Mz_fly;
    end
end
