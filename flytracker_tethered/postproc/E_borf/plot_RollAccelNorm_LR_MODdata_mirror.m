...
xlabel('MOD value')
ylabel('M')
saveas(gca, [save_name,'_MODvalue_allNOfreqMOD_mirror',num2str(mirror_nr),'.png'])
...
% xlabel('freq')
% ylabel('M')
% saveas(gca, [save_name,'_freq_freqMOD_mirror',num2str(mirror_nr),'.png'])
% 
% figure
% hold on
...
% xlabel('MOD value')
% ylabel('M')
% saveas(gca, [save_name,'_MODvalue_freqMOD_mirror',num2str(mirror_nr),'.png'])
...
% xlabel('Astroke')
% ylabel('M')
% saveas(gca, [save_name,'_Astroke_strokeMOD_mirror',num2str(mirror_nr),'.png'])
...
xlabel('MOD value')
ylabel('M')
saveas(gca, [save_name,'_MODvalue_strokeMOD_mirror',num2str(mirror_nr),'.png'])
...
% xlabel('Apitch')
% ylabel('M')
% saveas(gca, [save_name,'_Apitch_pitchMOD_mirror',num2str(mirror_nr),'.png'])
...
xlabel('MOD value')
ylabel('M')
saveas(gca, [save_name,'_MODvalue_pitchMOD_mirror',num2str(mirror_nr),'.png'])
...
% xlabel('Adev')
% ylabel('M')
% saveas(gca, [save_name,'_Adev_devMOD_mirror',num2str(mirror_nr),'.png'])
...
xlabel('MOD value')
ylabel('M')
saveas(gca, [save_name,'_MODvalue_devMOD_mirror',num2str(mirror_nr),'.png'])
...
xlabel('MOD value')
ylabel('Mroll')
saveas(gca, [save_name,'_MODvalue_compare_mirror',num2str(mirror_nr),'.png'])
