function ManualFit = auto_init_multi(ManualFit,frame,mode)
...
% 
                %================================================
                %
                %Now, update this state that is given from the manual
                %fitting of kine
                %
                %================================================
...
%                 New_body = srcdkf_const(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,1);
                ...
                %Update the body transformation
                New_body = srcdkf_const_NOpredict(Xh(:,1),Sx,pNoise,oNoise,InfDS,frames,1);
                
                solnQ_manual(:,i) = Xh(:,1);
                solnQ(:,i) = New_body;
            end
            
            ManualFit.solnQ = solnQ;
            ManualFit.solnQ_manual = solnQ_manual;
