...
%dir_now = cd;
%kine_dir = '/home/matt/Dropbox/WORK/flytracker/kine';
%setup_dir = '/home/matt/Dropbox/WORK/flytracker/kine/setup';
addpath(kine_dir)
addpath(setup_path)
...
if isfield(data.setup,'mfile_path') == 0
    %setup_wrong = setup_wrong + 1;
    data.setup.mfile_path = kine_mfile_path;
end

if exist(data.setup.mfile_path) == 0
