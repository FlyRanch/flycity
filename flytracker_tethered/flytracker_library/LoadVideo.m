function PAR = LoadVideo(PathName,FileName,solutionpath)
...
PAR.imagedirname = PathName(dir_str(end-1):end);
...
% stub based on photron name structure
PAR.stub = PAR.imagedirname(2:end-1);
% solution dir is date&seq
PAR.solutiondirname = 'flytracks';
