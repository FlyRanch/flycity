function [xh, Sx, pNoise, oNoise, InternalVariablesDS,Features] = srcdkf_const_NOpredict2(state, Sstate, pNoise, oNoise, InferenceDS,frames,useIC,plot_data)
