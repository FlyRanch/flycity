...
[stroke_steady_fourier_fit_binmean, stroke_steady_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, stroke_loc,stroke_fourier_order,plotting);
[pitch_steady_fourier_fit_binmean, pitch_steady_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, pitch_loc,pitch_fourier_order,plotting);
[dev_steady_fourier_fit_binmean, dev_steady_fourier_fit_binmean_gof] = create_fourier_series_4thN8th_order(t_loc, dev_loc,dev_fourier_order,plotting);

    
% save steady wb data
n_steady = n_now   

    save(['WBdataset_steady_',num2str(n_steady),'WBs.mat'],...
'n_steady',...
'seq_nr_steady',...
'wb_nr_steady',...
...
'limit_steady',...
'rollaccel_limit_steady',...
'pitchaccel_limit_steady',...
'yawaccel_limit_steady',...
'Fenhance_limit_steady',...
...
'stroke_fourier_order',...
'pitch_fourier_order',...
'dev_fourier_order',...
...
'stroke_steady_fourier_fit_binmean',...
'pitch_steady_fourier_fit_binmean',...
'dev_steady_fourier_fit_binmean',...
...
'stroke_steady_fourier_fit_binmean_gof',...
'pitch_steady_fourier_fit_binmean_gof',...
'dev_steady_fourier_fit_binmean_gof',...
...
'stroke_wb_steady_bins_meanCIstd',...
'stroke_ds_steady_bins_meanCIstd',...
'stroke_us_steady_bins_meanCIstd',...
...
'pitch_wb_steady_bins_meanCIstd',...
'pitch_ds_steady_bins_meanCIstd',...
'pitch_us_steady_bins_meanCIstd',...
...
'dev_wb_steady_bins_meanCIstd',...
'dev_ds_steady_bins_meanCIstd',...
'dev_us_steady_bins_meanCIstd',...
...
'V_steady',...
'pitch_global_steady',...
'dt_ds_steady',...
...
...
'V_steady_meanCIstd',...
'pitch_global_steady_meanCIstd',...
'dt_ds_steady_meanCIstd',...
'dt_us_steady_meanCIstd',...
'f_wb_steady_meanCIstd',...
'Rds_steady_meanCIstd',...
...
't_wb_L_steady',...
't_wb_R_steady',...
'stroke_wb_L_steady',...
