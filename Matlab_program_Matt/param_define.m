...
stroke_wb_R_MATT = rad2deg(trim2wingbeat_wb(phi_R,seqs));
stroke_wb_L_MATT = rad2deg(trim2wingbeat_wb(phi_L,seqs));
dev_wb_R_MATT = rad2deg(trim2wingbeat_wb(theta_R,seqs));
dev_wb_L_MATT = rad2deg(trim2wingbeat_wb(theta_L,seqs));
pitch_wb_R_MATT = rad2deg(trim2wingbeat_wb(eta_R,seqs));
pitch_wb_L_MATT = rad2deg(trim2wingbeat_wb(eta_L,seqs));
